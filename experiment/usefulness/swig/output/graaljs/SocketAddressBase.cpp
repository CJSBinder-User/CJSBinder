...
#define SWIGTYPE_p_MaybeLocalT_Object_t swig_types[1]
#define SWIGTYPE_p_SocketAddressBase swig_types[2]
...
SWIGV8_ClientData _exports_SocketAddressBase_clientData;


static SwigV8ReturnValue _wrap_SocketAddressBase_flow_label(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  SocketAddressBase *arg1 = (SocketAddressBase *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  unsigned int result;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_SocketAddressBase_flow_label.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_SocketAddressBase, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SocketAddressBase_flow_label" "', argument " "1"" of type '" "SocketAddressBase *""'"); 
  }
  arg1 = reinterpret_cast< SocketAddressBase * >(argp1);
  result = (unsigned int)(arg1)->flow_label();
...
static SwigV8ReturnValue _wrap_SocketAddressBase_ToJS(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  void *argp2 = 0 ;
  int res2 = 0 ;
  SwigValueWrapper< MaybeLocal< Object > > result;
  
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_SocketAddressBase_ToJS.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_SocketAddressBase, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SocketAddressBase_ToJS" "', argument " "1"" of type '" "SocketAddressBase *""'"); 
  }
  arg1 = reinterpret_cast< SocketAddressBase * >(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "SocketAddressBase_ToJS" "', argument " "2"" of type '" "Environment *""'"); 
  }
  arg2 = reinterpret_cast< Environment * >(argp2);
  result = (arg1)->ToJS(arg2);
  jsresult = SWIG_NewPointerObj((new MaybeLocal< Object >(result)), SWIGTYPE_p_MaybeLocalT_Object_t, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_new_SocketAddressBase(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  SocketAddressBase *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_SocketAddressBase.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_SocketAddressBase.");
  result = (SocketAddressBase *)new SocketAddressBase();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_SocketAddressBase, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_SocketAddressBase(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    SocketAddressBase * arg1 = (SocketAddressBase *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_MaybeLocalT_Object_t = {"_p_MaybeLocalT_Object_t", "MaybeLocal< Object > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_SocketAddressBase = {"_p_SocketAddressBase", "p_SocketAddressBase|SocketAddressBase *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_Environment,
  &_swigt__p_MaybeLocalT_Object_t,
  &_swigt__p_SocketAddressBase,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_Environment[] = {  {&_swigt__p_Environment, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_MaybeLocalT_Object_t[] = {  {&_swigt__p_MaybeLocalT_Object_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_SocketAddressBase[] = {  {&_swigt__p_SocketAddressBase, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_Environment,
  _swigc__p_MaybeLocalT_Object_t,
  _swigc__p_SocketAddressBase,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_SocketAddressBase, Type: p_SocketAddressBase, Dtor: _wrap_delete_SocketAddressBase */
SWIGV8_FUNCTION_TEMPLATE _exports_SocketAddressBase_class = SWIGV8_CreateClassTemplate("_exports_SocketAddressBase");
SWIGV8_SET_CLASS_TEMPL(_exports_SocketAddressBase_clientData.class_templ, _exports_SocketAddressBase_class);
_exports_SocketAddressBase_clientData.dtor = _wrap_delete_SocketAddressBase;
if (SWIGTYPE_p_SocketAddressBase->clientdata == 0) {
  SWIGTYPE_p_SocketAddressBase->clientdata = &_exports_SocketAddressBase_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_SocketAddressBase_class, "flow_label", _wrap_SocketAddressBase_flow_label);
SWIGV8_AddMemberFunction(_exports_SocketAddressBase_class, "ToJS", _wrap_SocketAddressBase_ToJS);
  ...
  /* class instances */
  /* Class: SocketAddressBase (_exports_SocketAddressBase) */
SWIGV8_FUNCTION_TEMPLATE _exports_SocketAddressBase_class_0 = SWIGV8_CreateClassTemplate("SocketAddressBase");
_exports_SocketAddressBase_class_0->SetCallHandler(_wrap_new_SocketAddressBase);
_exports_SocketAddressBase_class_0->Inherit(_exports_SocketAddressBase_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_SocketAddressBase_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_SocketAddressBase_obj = _exports_SocketAddressBase_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_SocketAddressBase_obj = _exports_SocketAddressBase_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("SocketAddressBase"), _exports_SocketAddressBase_obj));
