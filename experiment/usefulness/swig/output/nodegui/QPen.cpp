...
#define SWIGTYPE_p_QColor swig_types[0]
#define SWIGTYPE_p_QPen swig_types[1]
#define SWIGTYPE_p_Qt__GlobalColor swig_types[2]
#define SWIGTYPE_p_Qt__PenCapStyle swig_types[3]
#define SWIGTYPE_p_Qt__PenStyle swig_types[4]
...
SWIGV8_ClientData _exports_QPen_clientData;


static SwigV8ReturnValue _wrap_QPen_setGlobalColor(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPen_setGlobalColor.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPen, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPen_setGlobalColor" "', argument " "1"" of type '" "QPen *""'"); 
  }
  arg1 = reinterpret_cast< QPen * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_Qt__GlobalColor,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "QPen_setGlobalColor" "', argument " "2"" of type '" "Qt::GlobalColor""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "QPen_setGlobalColor" "', argument " "2"" of type '" "Qt::GlobalColor""'");
    } else {
      arg2 = *(reinterpret_cast< Qt::GlobalColor * >(argp2));
    }
  }
  (arg1)->setGlobalColor(arg2);
...
static SwigV8ReturnValue _wrap_QPen_setColort(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPen_setColort.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPen, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPen_setColort" "', argument " "1"" of type '" "QPen *""'"); 
  }
  arg1 = reinterpret_cast< QPen * >(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_QColor,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "QPen_setColort" "', argument " "2"" of type '" "QColor const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "QPen_setColort" "', argument " "2"" of type '" "QColor const &""'"); 
  }
  arg2 = reinterpret_cast< QColor * >(argp2);
  (arg1)->setColort((QColor const &)*arg2);
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_QPen_setScaledSize(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPen_setScaledSize.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPen, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPen_setScaledSize" "', argument " "1"" of type '" "QPen *""'"); 
  }
  arg1 = reinterpret_cast< QPen * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_Qt__PenStyle,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "QPen_setScaledSize" "', argument " "2"" of type '" "Qt::PenStyle""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "QPen_setScaledSize" "', argument " "2"" of type '" "Qt::PenStyle""'");
    } else {
      arg2 = *(reinterpret_cast< Qt::PenStyle * >(argp2));
    }
  }
  (arg1)->setScaledSize(arg2);
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_QPen_style(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPen_style.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPen, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPen_style" "', argument " "1"" of type '" "QPen *""'"); 
  }
  arg1 = reinterpret_cast< QPen * >(argp1);
  result = (arg1)->style();
  jsresult = SWIG_NewPointerObj((new Qt::PenStyle(result)), SWIGTYPE_p_Qt__PenStyle, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_QPen_setCapStyle(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPen_setCapStyle.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPen, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPen_setCapStyle" "', argument " "1"" of type '" "QPen *""'"); 
  }
  arg1 = reinterpret_cast< QPen * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_Qt__PenCapStyle,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "QPen_setCapStyle" "', argument " "2"" of type '" "Qt::PenCapStyle""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "QPen_setCapStyle" "', argument " "2"" of type '" "Qt::PenCapStyle""'");
    } else {
      arg2 = *(reinterpret_cast< Qt::PenCapStyle * >(argp2));
    }
  }
...
static SwigV8ReturnValue _wrap_QPen_setWidth(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPen_setWidth.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPen, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPen_setWidth" "', argument " "1"" of type '" "QPen *""'"); 
  }
  arg1 = reinterpret_cast< QPen * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "QPen_setWidth" "', argument " "2"" of type '" "int""'");
  } 
...
static SwigV8ReturnValue _wrap_new_QPen(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  QPen *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_QPen.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_QPen.");
  result = (QPen *)new QPen();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_QPen, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_QPen(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    QPen * arg1 = (QPen *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_QColor = {"_p_QColor", "QColor *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_QPen = {"_p_QPen", "p_QPen|QPen *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Qt__GlobalColor = {"_p_Qt__GlobalColor", "Qt::GlobalColor *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Qt__PenCapStyle = {"_p_Qt__PenCapStyle", "Qt::PenCapStyle *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Qt__PenStyle = {"_p_Qt__PenStyle", "Qt::PenStyle *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_QColor,
  &_swigt__p_QPen,
  &_swigt__p_Qt__GlobalColor,
  &_swigt__p_Qt__PenCapStyle,
  &_swigt__p_Qt__PenStyle,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_QColor[] = {  {&_swigt__p_QColor, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_QPen[] = {  {&_swigt__p_QPen, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Qt__GlobalColor[] = {  {&_swigt__p_Qt__GlobalColor, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Qt__PenCapStyle[] = {  {&_swigt__p_Qt__PenCapStyle, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Qt__PenStyle[] = {  {&_swigt__p_Qt__PenStyle, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_QColor,
  _swigc__p_QPen,
  _swigc__p_Qt__GlobalColor,
  _swigc__p_Qt__PenCapStyle,
  _swigc__p_Qt__PenStyle,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_QPen, Type: p_QPen, Dtor: _wrap_delete_QPen */
SWIGV8_FUNCTION_TEMPLATE _exports_QPen_class = SWIGV8_CreateClassTemplate("_exports_QPen");
SWIGV8_SET_CLASS_TEMPL(_exports_QPen_clientData.class_templ, _exports_QPen_class);
_exports_QPen_clientData.dtor = _wrap_delete_QPen;
if (SWIGTYPE_p_QPen->clientdata == 0) {
  SWIGTYPE_p_QPen->clientdata = &_exports_QPen_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_QPen_class, "setGlobalColor", _wrap_QPen_setGlobalColor);
SWIGV8_AddMemberFunction(_exports_QPen_class, "setColort", _wrap_QPen_setColort);
SWIGV8_AddMemberFunction(_exports_QPen_class, "setScaledSize", _wrap_QPen_setScaledSize);
SWIGV8_AddMemberFunction(_exports_QPen_class, "style", _wrap_QPen_style);
SWIGV8_AddMemberFunction(_exports_QPen_class, "setCapStyle", _wrap_QPen_setCapStyle);
SWIGV8_AddMemberFunction(_exports_QPen_class, "setWidth", _wrap_QPen_setWidth);
  ...
  /* class instances */
  /* Class: QPen (_exports_QPen) */
SWIGV8_FUNCTION_TEMPLATE _exports_QPen_class_0 = SWIGV8_CreateClassTemplate("QPen");
_exports_QPen_class_0->SetCallHandler(_wrap_new_QPen);
_exports_QPen_class_0->Inherit(_exports_QPen_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_QPen_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_QPen_obj = _exports_QPen_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_QPen_obj = _exports_QPen_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("QPen"), _exports_QPen_obj));
