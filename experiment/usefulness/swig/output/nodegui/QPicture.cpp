...
#define SWIGTYPE_p_QPicture swig_types[0]
#define SWIGTYPE_p_QRect swig_types[1]
...
SWIGV8_ClientData _exports_QPicture_clientData;


static SwigV8ReturnValue _wrap_QPicture_setBoundingRect(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPicture_setBoundingRect.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPicture, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPicture_setBoundingRect" "', argument " "1"" of type '" "QPicture *""'"); 
  }
  arg1 = reinterpret_cast< QPicture * >(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_QRect,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "QPicture_setBoundingRect" "', argument " "2"" of type '" "QRect const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "QPicture_setBoundingRect" "', argument " "2"" of type '" "QRect const &""'"); 
  }
  arg2 = reinterpret_cast< QRect * >(argp2);
...
static SwigV8ReturnValue _wrap_QPicture_boundingRect(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPicture_boundingRect.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPicture, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPicture_boundingRect" "', argument " "1"" of type '" "QPicture *""'"); 
  }
  arg1 = reinterpret_cast< QPicture * >(argp1);
  result = (arg1)->boundingRect();
  jsresult = SWIG_NewPointerObj((new QRect(result)), SWIGTYPE_p_QRect, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_QPicture_isNull(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPicture_isNull.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPicture, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPicture_isNull" "', argument " "1"" of type '" "QPicture *""'"); 
  }
  arg1 = reinterpret_cast< QPicture * >(argp1);
...
static SwigV8ReturnValue _wrap_QPicture_load(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPicture_load.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPicture, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPicture_load" "', argument " "1"" of type '" "QPicture *""'"); 
  }
  arg1 = reinterpret_cast< QPicture * >(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_QString,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "QPicture_load" "', argument " "2"" of type '" "QString const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "QPicture_load" "', argument " "2"" of type '" "QString const &""'"); 
  }
...
static SwigV8ReturnValue _wrap_QPicture_save(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPicture_save.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPicture, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPicture_save" "', argument " "1"" of type '" "QPicture *""'"); 
  }
  arg1 = reinterpret_cast< QPicture * >(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_QString,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "QPicture_save" "', argument " "2"" of type '" "QString const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "QPicture_save" "', argument " "2"" of type '" "QString const &""'"); 
  }
  arg2 = reinterpret_cast< QString * >(argp2);
...
static SwigV8ReturnValue _wrap_QPicture_size(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_QPicture_size.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_QPicture, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "QPicture_size" "', argument " "1"" of type '" "QPicture *""'"); 
  }
  arg1 = reinterpret_cast< QPicture * >(argp1);
...
static SwigV8ReturnValue _wrap_new_QPicture(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  QPicture *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_QPicture.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_QPicture.");
  result = (QPicture *)new QPicture();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_QPicture, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_QPicture(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    QPicture * arg1 = (QPicture *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_QPicture = {"_p_QPicture", "p_QPicture|QPicture *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_QRect = {"_p_QRect", "QRect *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_QPicture[] = {  {&_swigt__p_QPicture, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_QRect[] = {  {&_swigt__p_QRect, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_QPicture, Type: p_QPicture, Dtor: _wrap_delete_QPicture */
SWIGV8_FUNCTION_TEMPLATE _exports_QPicture_class = SWIGV8_CreateClassTemplate("_exports_QPicture");
SWIGV8_SET_CLASS_TEMPL(_exports_QPicture_clientData.class_templ, _exports_QPicture_class);
_exports_QPicture_clientData.dtor = _wrap_delete_QPicture;
if (SWIGTYPE_p_QPicture->clientdata == 0) {
  SWIGTYPE_p_QPicture->clientdata = &_exports_QPicture_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_QPicture_class, "setBoundingRect", _wrap_QPicture_setBoundingRect);
SWIGV8_AddMemberFunction(_exports_QPicture_class, "boundingRect", _wrap_QPicture_boundingRect);
SWIGV8_AddMemberFunction(_exports_QPicture_class, "isNull", _wrap_QPicture_isNull);
SWIGV8_AddMemberFunction(_exports_QPicture_class, "load", _wrap_QPicture_load);
SWIGV8_AddMemberFunction(_exports_QPicture_class, "save", _wrap_QPicture_save);
SWIGV8_AddMemberFunction(_exports_QPicture_class, "size", _wrap_QPicture_size);
  ...
  /* class instances */
  /* Class: QPicture (_exports_QPicture) */
SWIGV8_FUNCTION_TEMPLATE _exports_QPicture_class_0 = SWIGV8_CreateClassTemplate("QPicture");
_exports_QPicture_class_0->SetCallHandler(_wrap_new_QPicture);
_exports_QPicture_class_0->Inherit(_exports_QPicture_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_QPicture_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_QPicture_obj = _exports_QPicture_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_QPicture_obj = _exports_QPicture_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("QPicture"), _exports_QPicture_obj));
