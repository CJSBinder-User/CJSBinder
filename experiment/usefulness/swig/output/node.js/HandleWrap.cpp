...
#define SWIGTYPE_p_HandleWrap swig_types[0]
...
SWIGV8_ClientData _exports_HandleWrap_clientData;


static SwigV8ReturnValue _wrap_HandleWrap_uv_ref(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  HandleWrap *arg1 = (HandleWrap *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_HandleWrap_uv_ref.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_HandleWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "HandleWrap_uv_ref" "', argument " "1"" of type '" "HandleWrap *""'"); 
  }
  arg1 = reinterpret_cast< HandleWrap * >(argp1);
  (arg1)->uv_ref();
...
static SwigV8ReturnValue _wrap_HandleWrap_uv_unref(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_HandleWrap_uv_unref.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_HandleWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "HandleWrap_uv_unref" "', argument " "1"" of type '" "HandleWrap *""'"); 
  }
  arg1 = reinterpret_cast< HandleWrap * >(argp1);
  (arg1)->uv_unref();
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_HandleWrap_HasRef(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_HandleWrap_HasRef.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_HandleWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "HandleWrap_HasRef" "', argument " "1"" of type '" "HandleWrap *""'"); 
  }
  arg1 = reinterpret_cast< HandleWrap * >(argp1);
...
static SwigV8ReturnValue _wrap_HandleWrap_Close(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  HandleWrap *arg1 = (HandleWrap *) 0 ;
  SwigValueWrapper< Local< Value > > arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  int res2 = 0 ;
  
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_HandleWrap_Close.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_HandleWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "HandleWrap_Close" "', argument " "1"" of type '" "HandleWrap *""'"); 
  }
  arg1 = reinterpret_cast< HandleWrap * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_LocalT_Value_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "HandleWrap_Close" "', argument " "2"" of type '" "Local< Value >""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "HandleWrap_Close" "', argument " "2"" of type '" "Local< Value >""'");
    } else {
      arg2 = *(reinterpret_cast< Local< Value > * >(argp2));
    }
  }
  (arg1)->Close(arg2);
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_new_HandleWrap(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  HandleWrap *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_HandleWrap.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_HandleWrap.");
  result = (HandleWrap *)new HandleWrap();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_HandleWrap, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_HandleWrap(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    HandleWrap * arg1 = (HandleWrap *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
#endif
{
  ...
  /* Name: _exports_HandleWrap, Type: p_HandleWrap, Dtor: _wrap_delete_HandleWrap */
SWIGV8_FUNCTION_TEMPLATE _exports_HandleWrap_class = SWIGV8_CreateClassTemplate("_exports_HandleWrap");
SWIGV8_SET_CLASS_TEMPL(_exports_HandleWrap_clientData.class_templ, _exports_HandleWrap_class);
_exports_HandleWrap_clientData.dtor = _wrap_delete_HandleWrap;
if (SWIGTYPE_p_HandleWrap->clientdata == 0) {
  SWIGTYPE_p_HandleWrap->clientdata = &_exports_HandleWrap_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_HandleWrap_class, "uv_ref", _wrap_HandleWrap_uv_ref);
SWIGV8_AddMemberFunction(_exports_HandleWrap_class, "uv_unref", _wrap_HandleWrap_uv_unref);
SWIGV8_AddMemberFunction(_exports_HandleWrap_class, "HasRef", _wrap_HandleWrap_HasRef);
SWIGV8_AddMemberFunction(_exports_HandleWrap_class, "Close", _wrap_HandleWrap_Close);
  ...
  /* class instances */
  /* Class: HandleWrap (_exports_HandleWrap) */
SWIGV8_FUNCTION_TEMPLATE _exports_HandleWrap_class_0 = SWIGV8_CreateClassTemplate("HandleWrap");
_exports_HandleWrap_class_0->SetCallHandler(_wrap_new_HandleWrap);
_exports_HandleWrap_class_0->Inherit(_exports_HandleWrap_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_HandleWrap_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_HandleWrap_obj = _exports_HandleWrap_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_HandleWrap_obj = _exports_HandleWrap_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("HandleWrap"), _exports_HandleWrap_obj));
