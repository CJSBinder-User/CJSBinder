...
#define SWIGTYPE_p_OnSignal swig_types[2]
#define SWIGTYPE_p_SignalWrap swig_types[3]
...
SWIGV8_ClientData _exports_SignalWrap_clientData;


static SwigV8ReturnValue _wrap_new_SignalWrap(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  int res2 = 0 ;
  SignalWrap *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_SignalWrap.");
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_SignalWrap.");
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_SignalWrap" "', argument " "1"" of type '" "Environment *""'"); 
  }
  arg1 = reinterpret_cast< Environment * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_LocalT_Object_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_SignalWrap" "', argument " "2"" of type '" "Local< Object >""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_SignalWrap" "', argument " "2"" of type '" "Local< Object >""'");
    } else {
      arg2 = *(reinterpret_cast< Local< Object > * >(argp2));
    }
  }
  result = (SignalWrap *)new SignalWrap(arg1,arg2);
  
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_SignalWrap, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_SignalWrap_uv_signal_stop(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  SignalWrap *arg1 = (SignalWrap *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_SignalWrap_uv_signal_stop.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_SignalWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SignalWrap_uv_signal_stop" "', argument " "1"" of type '" "SignalWrap *""'"); 
  }
  arg1 = reinterpret_cast< SignalWrap * >(argp1);
  result = (int)(arg1)->uv_signal_stop();
...
static SwigV8ReturnValue _wrap_SignalWrap_uv_signal_start(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_SignalWrap_uv_signal_start.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_SignalWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SignalWrap_uv_signal_start" "', argument " "1"" of type '" "SignalWrap *""'"); 
  }
  arg1 = reinterpret_cast< SignalWrap * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_OnSignal,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "SignalWrap_uv_signal_start" "', argument " "2"" of type '" "OnSignal""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "SignalWrap_uv_signal_start" "', argument " "2"" of type '" "OnSignal""'");
    } else {
      arg2 = *(reinterpret_cast< OnSignal * >(argp2));
    }
  }
  ecode3 = SWIG_AsVal_int(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "SignalWrap_uv_signal_start" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (int)(arg1)->uv_signal_start(arg2,arg3);
  jsresult = SWIG_From_int(static_cast< int >(result));
...
static void _wrap_delete_SignalWrap(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    SignalWrap * arg1 = (SignalWrap *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_OnSignal = {"_p_OnSignal", "OnSignal *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_SignalWrap = {"_p_SignalWrap", "p_SignalWrap|SignalWrap *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_OnSignal[] = {  {&_swigt__p_OnSignal, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_SignalWrap[] = {  {&_swigt__p_SignalWrap, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_SignalWrap, Type: p_SignalWrap, Dtor: _wrap_delete_SignalWrap */
SWIGV8_FUNCTION_TEMPLATE _exports_SignalWrap_class = SWIGV8_CreateClassTemplate("_exports_SignalWrap");
SWIGV8_SET_CLASS_TEMPL(_exports_SignalWrap_clientData.class_templ, _exports_SignalWrap_class);
_exports_SignalWrap_clientData.dtor = _wrap_delete_SignalWrap;
if (SWIGTYPE_p_SignalWrap->clientdata == 0) {
  SWIGTYPE_p_SignalWrap->clientdata = &_exports_SignalWrap_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_SignalWrap_class, "uv_signal_stop", _wrap_SignalWrap_uv_signal_stop);
SWIGV8_AddMemberFunction(_exports_SignalWrap_class, "uv_signal_start", _wrap_SignalWrap_uv_signal_start);
  ...
  /* class instances */
  /* Class: SignalWrap (_exports_SignalWrap) */
SWIGV8_FUNCTION_TEMPLATE _exports_SignalWrap_class_0 = SWIGV8_CreateClassTemplate("SignalWrap");
_exports_SignalWrap_class_0->SetCallHandler(_wrap_new_SignalWrap);
_exports_SignalWrap_class_0->Inherit(_exports_SignalWrap_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_SignalWrap_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_SignalWrap_obj = _exports_SignalWrap_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_SignalWrap_obj = _exports_SignalWrap_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("SignalWrap"), _exports_SignalWrap_obj));
