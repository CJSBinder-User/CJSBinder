...
#define SWIGTYPE_p_FileHandle swig_types[1]
#define SWIGTYPE_p_LocalT_Value_t swig_types[2]
#define SWIGTYPE_p_MaybeLocalT_Promise_t swig_types[3]
...
SWIGV8_ClientData _exports_FileHandle_clientData;


static SwigV8ReturnValue _wrap_new_FileHandle(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  int res3 = 0 ;
  FileHandle *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_FileHandle.");
  if(args.Length() != 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_FileHandle.");
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_FileHandle" "', argument " "1"" of type '" "Environment *""'"); 
  }
  arg1 = reinterpret_cast< Environment * >(argp1);
  ecode2 = SWIG_AsVal_int(args[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "new_FileHandle" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    res3 = SWIG_ConvertPtr(args[2], &argp3, SWIGTYPE_p_LocalT_Value_t,  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "new_FileHandle" "', argument " "3"" of type '" "Local< Value >""'"); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_FileHandle" "', argument " "3"" of type '" "Local< Value >""'");
    } else {
      arg3 = *(reinterpret_cast< Local< Value > * >(argp3));
    }
  }
  result = (FileHandle *)new FileHandle(arg1,arg2,arg3);
  
  
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_FileHandle, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_FileHandle_ClosePromise(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  void *argp1 = 0 ;
  int res1 = 0 ;
  SwigValueWrapper< MaybeLocal< Promise > > result;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_FileHandle_ClosePromise.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_FileHandle, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "FileHandle_ClosePromise" "', argument " "1"" of type '" "FileHandle *""'"); 
  }
  arg1 = reinterpret_cast< FileHandle * >(argp1);
  result = (arg1)->ClosePromise();
  jsresult = SWIG_NewPointerObj((new MaybeLocal< Promise >(result)), SWIGTYPE_p_MaybeLocalT_Promise_t, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_FileHandle_AfterClose(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_FileHandle_AfterClose.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_FileHandle, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "FileHandle_AfterClose" "', argument " "1"" of type '" "FileHandle *""'"); 
  }
  arg1 = reinterpret_cast< FileHandle * >(argp1);
  (arg1)->AfterClose();
...
static void _wrap_delete_FileHandle(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    FileHandle * arg1 = (FileHandle *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_FileHandle = {"_p_FileHandle", "p_FileHandle|FileHandle *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_LocalT_Value_t = {"_p_LocalT_Value_t", "Local< Value > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_MaybeLocalT_Promise_t = {"_p_MaybeLocalT_Promise_t", "MaybeLocal< Promise > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_MaybeLocalT_Promise_t,
  &_swigt__p_char,
};
...
static swig_cast_info _swigc__p_MaybeLocalT_Promise_t[] = {  {&_swigt__p_MaybeLocalT_Promise_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_MaybeLocalT_Promise_t,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_FileHandle, Type: p_FileHandle, Dtor: _wrap_delete_FileHandle */
SWIGV8_FUNCTION_TEMPLATE _exports_FileHandle_class = SWIGV8_CreateClassTemplate("_exports_FileHandle");
SWIGV8_SET_CLASS_TEMPL(_exports_FileHandle_clientData.class_templ, _exports_FileHandle_class);
_exports_FileHandle_clientData.dtor = _wrap_delete_FileHandle;
if (SWIGTYPE_p_FileHandle->clientdata == 0) {
  SWIGTYPE_p_FileHandle->clientdata = &_exports_FileHandle_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_FileHandle_class, "ClosePromise", _wrap_FileHandle_ClosePromise);
SWIGV8_AddMemberFunction(_exports_FileHandle_class, "AfterClose", _wrap_FileHandle_AfterClose);
  ...
  /* class instances */
  /* Class: FileHandle (_exports_FileHandle) */
SWIGV8_FUNCTION_TEMPLATE _exports_FileHandle_class_0 = SWIGV8_CreateClassTemplate("FileHandle");
_exports_FileHandle_class_0->SetCallHandler(_wrap_new_FileHandle);
_exports_FileHandle_class_0->Inherit(_exports_FileHandle_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_FileHandle_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_FileHandle_obj = _exports_FileHandle_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_FileHandle_obj = _exports_FileHandle_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("FileHandle"), _exports_FileHandle_obj));
