...
#define SWIGTYPE_p_ContextifyScript swig_types[0]
#define SWIGTYPE_p_Environment swig_types[1]
#define SWIGTYPE_p_FunctionCallbackInfoT_Value_t swig_types[2]
...
SWIGV8_ClientData _exports_ContextifyScript_clientData;


static SwigV8ReturnValue _wrap_new_ContextifyScript(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  void *argp2 ;
  int res2 = 0 ;
  ContextifyScript *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_ContextifyScript.");
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_ContextifyScript.");
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_ContextifyScript" "', argument " "1"" of type '" "Environment *""'"); 
  }
  arg1 = reinterpret_cast< Environment * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_LocalT_Object_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_ContextifyScript" "', argument " "2"" of type '" "Local< Object >""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_ContextifyScript" "', argument " "2"" of type '" "Local< Object >""'");
    } else {
      arg2 = *(reinterpret_cast< Local< Object > * >(argp2));
    }
  }
  result = (ContextifyScript *)new ContextifyScript(arg1,arg2);
  
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_ContextifyScript, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_ContextifyScript_EvalMachine(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  ContextifyScript *arg1 = (ContextifyScript *) 0 ;
  Environment *arg2 = (Environment *) 0 ;
  long long arg3 ;
  bool arg4 ;
  bool arg5 ;
  FunctionCallbackInfo< Value > *arg6 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if(args.Length() != 5) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ContextifyScript_EvalMachine.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_ContextifyScript, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ContextifyScript_EvalMachine" "', argument " "1"" of type '" "ContextifyScript *""'"); 
  }
  arg1 = reinterpret_cast< ContextifyScript * >(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ContextifyScript_EvalMachine" "', argument " "2"" of type '" "Environment *""'"); 
  }
  arg2 = reinterpret_cast< Environment * >(argp2);
  ecode3 = SWIG_AsVal_long_SS_long(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "ContextifyScript_EvalMachine" "', argument " "3"" of type '" "long long""'");
  } 
  arg3 = static_cast< long long >(val3);
  ecode4 = SWIG_AsVal_bool(args[2], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "ContextifyScript_EvalMachine" "', argument " "4"" of type '" "bool""'");
  } 
  arg4 = static_cast< bool >(val4);
  ecode5 = SWIG_AsVal_bool(args[3], &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "ContextifyScript_EvalMachine" "', argument " "5"" of type '" "bool""'");
  } 
  arg5 = static_cast< bool >(val5);
  res6 = SWIG_ConvertPtr(args[4], &argp6, SWIGTYPE_p_FunctionCallbackInfoT_Value_t,  0 );
  if (!SWIG_IsOK(res6)) {
    SWIG_exception_fail(SWIG_ArgError(res6), "in method '" "ContextifyScript_EvalMachine" "', argument " "6"" of type '" "FunctionCallbackInfo< Value > const &""'"); 
  }
  if (!argp6) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ContextifyScript_EvalMachine" "', argument " "6"" of type '" "FunctionCallbackInfo< Value > const &""'"); 
  }
  arg6 = reinterpret_cast< FunctionCallbackInfo< Value > * >(argp6);
  result = (bool)(arg1)->EvalMachine(arg2,arg3,arg4,arg5,(FunctionCallbackInfo< Value > const &)*arg6);
...
static void _wrap_delete_ContextifyScript(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    ContextifyScript * arg1 = (ContextifyScript *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_ContextifyScript = {"_p_ContextifyScript", "p_ContextifyScript|ContextifyScript *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Environment = {"_p_Environment", "Environment *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_FunctionCallbackInfoT_Value_t = {"_p_FunctionCallbackInfoT_Value_t", "FunctionCallbackInfo< Value > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_LocalT_Object_t = {"_p_LocalT_Object_t", "Local< Object > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ContextifyScript,
  &_swigt__p_Environment,
  &_swigt__p_FunctionCallbackInfoT_Value_t,
  &_swigt__p_LocalT_Object_t,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_ContextifyScript[] = {  {&_swigt__p_ContextifyScript, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Environment[] = {  {&_swigt__p_Environment, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FunctionCallbackInfoT_Value_t[] = {  {&_swigt__p_FunctionCallbackInfoT_Value_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_LocalT_Object_t[] = {  {&_swigt__p_LocalT_Object_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ContextifyScript,
  _swigc__p_Environment,
  _swigc__p_FunctionCallbackInfoT_Value_t,
...
#endif
{
  ...
  /* Name: _exports_ContextifyScript, Type: p_ContextifyScript, Dtor: _wrap_delete_ContextifyScript */
SWIGV8_FUNCTION_TEMPLATE _exports_ContextifyScript_class = SWIGV8_CreateClassTemplate("_exports_ContextifyScript");
SWIGV8_SET_CLASS_TEMPL(_exports_ContextifyScript_clientData.class_templ, _exports_ContextifyScript_class);
_exports_ContextifyScript_clientData.dtor = _wrap_delete_ContextifyScript;
if (SWIGTYPE_p_ContextifyScript->clientdata == 0) {
  SWIGTYPE_p_ContextifyScript->clientdata = &_exports_ContextifyScript_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_ContextifyScript_class, "EvalMachine", _wrap_ContextifyScript_EvalMachine);
  ...
  /* class instances */
  /* Class: ContextifyScript (_exports_ContextifyScript) */
SWIGV8_FUNCTION_TEMPLATE _exports_ContextifyScript_class_0 = SWIGV8_CreateClassTemplate("ContextifyScript");
_exports_ContextifyScript_class_0->SetCallHandler(_wrap_new_ContextifyScript);
_exports_ContextifyScript_class_0->Inherit(_exports_ContextifyScript_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_ContextifyScript_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_ContextifyScript_obj = _exports_ContextifyScript_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_ContextifyScript_obj = _exports_ContextifyScript_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ContextifyScript"), _exports_ContextifyScript_obj));
