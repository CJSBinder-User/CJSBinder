...
#define SWIGTYPE_p_OnTimeout swig_types[2]
#define SWIGTYPE_p_TimerWrap swig_types[3]
...
SWIGV8_ClientData _exports_TimerWrap_clientData;


static SwigV8ReturnValue _wrap_new_TimerWrap(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  int res2 = 0 ;
  TimerWrap *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_TimerWrap.");
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_TimerWrap.");
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_TimerWrap" "', argument " "1"" of type '" "Environment *""'"); 
  }
  arg1 = reinterpret_cast< Environment * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_LocalT_Object_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_TimerWrap" "', argument " "2"" of type '" "Local< Object >""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_TimerWrap" "', argument " "2"" of type '" "Local< Object >""'");
    } else {
      arg2 = *(reinterpret_cast< Local< Object > * >(argp2));
    }
  }
  result = (TimerWrap *)new TimerWrap(arg1,arg2);
  
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_TimerWrap, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_TimerWrap_uv_timer_stop(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  TimerWrap *arg1 = (TimerWrap *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_TimerWrap_uv_timer_stop.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_TimerWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TimerWrap_uv_timer_stop" "', argument " "1"" of type '" "TimerWrap *""'"); 
  }
  arg1 = reinterpret_cast< TimerWrap * >(argp1);
  result = (int)(arg1)->uv_timer_stop();
...
static SwigV8ReturnValue _wrap_TimerWrap_uv_timer_start(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_TimerWrap_uv_timer_start.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_TimerWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TimerWrap_uv_timer_start" "', argument " "1"" of type '" "TimerWrap *""'"); 
  }
  arg1 = reinterpret_cast< TimerWrap * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_OnTimeout,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "TimerWrap_uv_timer_start" "', argument " "2"" of type '" "OnTimeout""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "TimerWrap_uv_timer_start" "', argument " "2"" of type '" "OnTimeout""'");
    } else {
      arg2 = *(reinterpret_cast< OnTimeout * >(argp2));
    }
  }
  ecode3 = SWIG_AsVal_long_SS_long(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "TimerWrap_uv_timer_start" "', argument " "3"" of type '" "long long""'");
  } 
  arg3 = static_cast< long long >(val3);
  result = (int)(arg1)->uv_timer_start(arg2,arg3);
  jsresult = SWIG_From_int(static_cast< int >(result));
...
static void _wrap_delete_TimerWrap(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    TimerWrap * arg1 = (TimerWrap *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_OnTimeout = {"_p_OnTimeout", "OnTimeout *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_TimerWrap = {"_p_TimerWrap", "p_TimerWrap|TimerWrap *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_OnTimeout[] = {  {&_swigt__p_OnTimeout, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_TimerWrap[] = {  {&_swigt__p_TimerWrap, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_TimerWrap, Type: p_TimerWrap, Dtor: _wrap_delete_TimerWrap */
SWIGV8_FUNCTION_TEMPLATE _exports_TimerWrap_class = SWIGV8_CreateClassTemplate("_exports_TimerWrap");
SWIGV8_SET_CLASS_TEMPL(_exports_TimerWrap_clientData.class_templ, _exports_TimerWrap_class);
_exports_TimerWrap_clientData.dtor = _wrap_delete_TimerWrap;
if (SWIGTYPE_p_TimerWrap->clientdata == 0) {
  SWIGTYPE_p_TimerWrap->clientdata = &_exports_TimerWrap_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_TimerWrap_class, "uv_timer_stop", _wrap_TimerWrap_uv_timer_stop);
SWIGV8_AddMemberFunction(_exports_TimerWrap_class, "uv_timer_start", _wrap_TimerWrap_uv_timer_start);
  ...
  /* class instances */
  /* Class: TimerWrap (_exports_TimerWrap) */
SWIGV8_FUNCTION_TEMPLATE _exports_TimerWrap_class_0 = SWIGV8_CreateClassTemplate("TimerWrap");
_exports_TimerWrap_class_0->SetCallHandler(_wrap_new_TimerWrap);
_exports_TimerWrap_class_0->Inherit(_exports_TimerWrap_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_TimerWrap_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_TimerWrap_obj = _exports_TimerWrap_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_TimerWrap_obj = _exports_TimerWrap_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("TimerWrap"), _exports_TimerWrap_obj));
