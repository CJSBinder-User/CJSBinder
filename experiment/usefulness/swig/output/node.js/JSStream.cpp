...
#define SWIGTYPE_p_JSStream swig_types[1]
#define SWIGTYPE_p_LocalT_Object_t swig_types[2]
#define SWIGTYPE_p_char swig_types[3]
#define SWIGTYPE_p_uv_buf_t swig_types[4]
...
SWIGV8_ClientData _exports_JSStream_clientData;


static SwigV8ReturnValue _wrap_new_JSStream(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  int res2 = 0 ;
  JSStream *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_JSStream.");
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_JSStream.");
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_JSStream" "', argument " "1"" of type '" "Environment *""'"); 
  }
  arg1 = reinterpret_cast< Environment * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_LocalT_Object_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_JSStream" "', argument " "2"" of type '" "Local< Object >""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_JSStream" "', argument " "2"" of type '" "Local< Object >""'");
    } else {
      arg2 = *(reinterpret_cast< Local< Object > * >(argp2));
    }
  }
  result = (JSStream *)new JSStream(arg1,arg2);
  
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_JSStream, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_JSStream_EmitRead(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  JSStream *arg1 = (JSStream *) 0 ;
  unsigned int arg2 ;
  uv_buf_t *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_JSStream_EmitRead.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_JSStream, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "JSStream_EmitRead" "', argument " "1"" of type '" "JSStream *""'"); 
  }
  arg1 = reinterpret_cast< JSStream * >(argp1);
  ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "JSStream_EmitRead" "', argument " "2"" of type '" "unsigned int""'");
  } 
  arg2 = static_cast< unsigned int >(val2);
  res3 = SWIG_ConvertPtr(args[1], &argp3, SWIGTYPE_p_uv_buf_t,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "JSStream_EmitRead" "', argument " "3"" of type '" "uv_buf_t const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "JSStream_EmitRead" "', argument " "3"" of type '" "uv_buf_t const &""'"); 
  }
  arg3 = reinterpret_cast< uv_buf_t * >(argp3);
  (arg1)->EmitRead(arg2,(uv_buf_t const &)*arg3);
...
static void _wrap_delete_JSStream(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    JSStream * arg1 = (JSStream *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_JSStream = {"_p_JSStream", "p_JSStream|JSStream *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_JSStream[] = {  {&_swigt__p_JSStream, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_JSStream, Type: p_JSStream, Dtor: _wrap_delete_JSStream */
SWIGV8_FUNCTION_TEMPLATE _exports_JSStream_class = SWIGV8_CreateClassTemplate("_exports_JSStream");
SWIGV8_SET_CLASS_TEMPL(_exports_JSStream_clientData.class_templ, _exports_JSStream_class);
_exports_JSStream_clientData.dtor = _wrap_delete_JSStream;
if (SWIGTYPE_p_JSStream->clientdata == 0) {
  SWIGTYPE_p_JSStream->clientdata = &_exports_JSStream_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_JSStream_class, "EmitRead", _wrap_JSStream_EmitRead);
  ...
  /* class instances */
  /* Class: JSStream (_exports_JSStream) */
SWIGV8_FUNCTION_TEMPLATE _exports_JSStream_class_0 = SWIGV8_CreateClassTemplate("JSStream");
_exports_JSStream_class_0->SetCallHandler(_wrap_new_JSStream);
_exports_JSStream_class_0->Inherit(_exports_JSStream_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_JSStream_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_JSStream_obj = _exports_JSStream_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_JSStream_obj = _exports_JSStream_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("JSStream"), _exports_JSStream_obj));
