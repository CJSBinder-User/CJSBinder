...
#define SWIGTYPE_p_AsyncWrap swig_types[0]
...
SWIGV8_ClientData _exports_AsyncWrap_clientData;


static SwigV8ReturnValue _wrap_AsyncWrap_get_async_id(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  AsyncWrap *arg1 = (AsyncWrap *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double result;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_AsyncWrap_get_async_id.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_AsyncWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AsyncWrap_get_async_id" "', argument " "1"" of type '" "AsyncWrap const *""'"); 
  }
  arg1 = reinterpret_cast< AsyncWrap * >(argp1);
  result = (double)((AsyncWrap const *)arg1)->get_async_id();
...
static SwigV8ReturnValue _wrap_AsyncWrap_AsyncReset__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  SWIGV8_HANDLESCOPE();
  ...
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_AsyncWrap, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AsyncWrap_AsyncReset" "', argument " "1"" of type '" "AsyncWrap *""'"); 
  }
  arg1 = reinterpret_cast< AsyncWrap * >(argp1);
  ecode2 = SWIG_AsVal_double(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "AsyncWrap_AsyncReset" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  ecode3 = SWIG_AsVal_bool(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "AsyncWrap_AsyncReset" "', argument " "3"" of type '" "bool""'");
  } 
  arg3 = static_cast< bool >(val3);
  (arg1)->AsyncReset(arg2,arg3);
...
static SwigV8ReturnValue _wrap_AsyncWrap_AsyncReset__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_AsyncWrap_AsyncReset__SWIG_2(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_AsyncWrap__wrap_AsyncWrap_AsyncReset(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() == 2) {
    ...
    _wrap_AsyncWrap_AsyncReset__SWIG_0(args, errorHandler);
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
    _wrap_AsyncWrap_AsyncReset__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    }
  }
  ...
  if(args.Length() == 0) {
    errorHandler.err.Clear();
    _wrap_AsyncWrap_AsyncReset__SWIG_2(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    }
  }
  ...
  SWIG_exception_fail(SWIG_ERROR, "Illegal arguments for function AsyncReset.");
...
static SwigV8ReturnValue _wrap_new_AsyncWrap(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  AsyncWrap *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_AsyncWrap.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_AsyncWrap.");
  result = (AsyncWrap *)new AsyncWrap();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_AsyncWrap, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_AsyncWrap(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    AsyncWrap * arg1 = (AsyncWrap *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_AsyncWrap = {"_p_AsyncWrap", "AsyncWrap *|p_AsyncWrap", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_AsyncWrap[] = {  {&_swigt__p_AsyncWrap, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_AsyncWrap, Type: p_AsyncWrap, Dtor: _wrap_delete_AsyncWrap */
SWIGV8_FUNCTION_TEMPLATE _exports_AsyncWrap_class = SWIGV8_CreateClassTemplate("_exports_AsyncWrap");
SWIGV8_SET_CLASS_TEMPL(_exports_AsyncWrap_clientData.class_templ, _exports_AsyncWrap_class);
_exports_AsyncWrap_clientData.dtor = _wrap_delete_AsyncWrap;
if (SWIGTYPE_p_AsyncWrap->clientdata == 0) {
  SWIGTYPE_p_AsyncWrap->clientdata = &_exports_AsyncWrap_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_AsyncWrap_class, "get_async_id", _wrap_AsyncWrap_get_async_id);
SWIGV8_AddMemberFunction(_exports_AsyncWrap_class, "AsyncReset", _wrap_AsyncWrap__wrap_AsyncWrap_AsyncReset);
  ...
  /* class instances */
  /* Class: AsyncWrap (_exports_AsyncWrap) */
SWIGV8_FUNCTION_TEMPLATE _exports_AsyncWrap_class_0 = SWIGV8_CreateClassTemplate("AsyncWrap");
_exports_AsyncWrap_class_0->SetCallHandler(_wrap_new_AsyncWrap);
_exports_AsyncWrap_class_0->Inherit(_exports_AsyncWrap_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_AsyncWrap_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_AsyncWrap_obj = _exports_AsyncWrap_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_AsyncWrap_obj = _exports_AsyncWrap_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("AsyncWrap"), _exports_AsyncWrap_obj));
