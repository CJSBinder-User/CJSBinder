...
#define SWIGTYPE_p_StatWatcher swig_types[3]
...
SWIGV8_ClientData _exports_StatWatcher_clientData;


static SwigV8ReturnValue _wrap_new_StatWatcher(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  int res2 = 0 ;
  StatWatcher *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_StatWatcher.");
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_StatWatcher.");
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_StatWatcher" "', argument " "1"" of type '" "Environment *""'"); 
  }
  arg1 = reinterpret_cast< Environment * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_LocalT_Object_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_StatWatcher" "', argument " "2"" of type '" "Local< Object >""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_StatWatcher" "', argument " "2"" of type '" "Local< Object >""'");
    } else {
      arg2 = *(reinterpret_cast< Local< Object > * >(argp2));
    }
  }
  result = (StatWatcher *)new StatWatcher(arg1,arg2);
  
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_StatWatcher, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_StatWatcher_uv_fs_poll_start(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  StatWatcher *arg1 = (StatWatcher *) 0 ;
  CallBack arg2 ;
  char *arg3 = (char *) 0 ;
  unsigned int arg4 ;
  void *argp1 = 0 ;
  ...
  if(args.Length() != 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_StatWatcher_uv_fs_poll_start.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_StatWatcher, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "StatWatcher_uv_fs_poll_start" "', argument " "1"" of type '" "StatWatcher *""'"); 
  }
  arg1 = reinterpret_cast< StatWatcher * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_CallBack,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "StatWatcher_uv_fs_poll_start" "', argument " "2"" of type '" "CallBack""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "StatWatcher_uv_fs_poll_start" "', argument " "2"" of type '" "CallBack""'");
    } else {
  ...
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "StatWatcher_uv_fs_poll_start" "', argument " "3"" of type '" "char const *""'");
  }
  arg3 = reinterpret_cast< char * >(buf3);
  ecode4 = SWIG_AsVal_unsigned_SS_int(args[2], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "StatWatcher_uv_fs_poll_start" "', argument " "4"" of type '" "unsigned int""'");
  } 
  arg4 = static_cast< unsigned int >(val4);
  result = (int)(arg1)->uv_fs_poll_start(arg2,(char const *)arg3,arg4);
...
static void _wrap_delete_StatWatcher(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    StatWatcher * arg1 = (StatWatcher *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_StatWatcher = {"_p_StatWatcher", "p_StatWatcher|StatWatcher *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_StatWatcher[] = {  {&_swigt__p_StatWatcher, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_StatWatcher, Type: p_StatWatcher, Dtor: _wrap_delete_StatWatcher */
SWIGV8_FUNCTION_TEMPLATE _exports_StatWatcher_class = SWIGV8_CreateClassTemplate("_exports_StatWatcher");
SWIGV8_SET_CLASS_TEMPL(_exports_StatWatcher_clientData.class_templ, _exports_StatWatcher_class);
_exports_StatWatcher_clientData.dtor = _wrap_delete_StatWatcher;
if (SWIGTYPE_p_StatWatcher->clientdata == 0) {
  SWIGTYPE_p_StatWatcher->clientdata = &_exports_StatWatcher_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_StatWatcher_class, "uv_fs_poll_start", _wrap_StatWatcher_uv_fs_poll_start);
  ...
  /* class instances */
  /* Class: StatWatcher (_exports_StatWatcher) */
SWIGV8_FUNCTION_TEMPLATE _exports_StatWatcher_class_0 = SWIGV8_CreateClassTemplate("StatWatcher");
_exports_StatWatcher_class_0->SetCallHandler(_wrap_new_StatWatcher);
_exports_StatWatcher_class_0->Inherit(_exports_StatWatcher_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_StatWatcher_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_StatWatcher_obj = _exports_StatWatcher_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_StatWatcher_obj = _exports_StatWatcher_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("StatWatcher"), _exports_StatWatcher_obj));
