...
#define SWIGTYPE_p_Worker swig_types[2]
...
SWIGV8_ClientData _exports_Worker_clientData;


static SwigV8ReturnValue _wrap_new_Worker(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  int res3 = 0 ;
  Worker *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_Worker.");
  if(args.Length() != 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Worker.");
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_Environment, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_Worker" "', argument " "1"" of type '" "Environment *""'"); 
  }
  arg1 = reinterpret_cast< Environment * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_LocalT_Object_t,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_Worker" "', argument " "2"" of type '" "Local< Object >""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_Worker" "', argument " "2"" of type '" "Local< Object >""'");
    } else {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "new_Worker" "', argument " "3"" of type '" "std::string""'"); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_Worker" "', argument " "3"" of type '" "std::string""'");
    } else {
      arg3 = *(reinterpret_cast< std::string * >(argp3));
    }
  }
  result = (Worker *)new Worker(arg1,arg2,arg3);
  
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_Worker, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_Worker_uvref(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Worker_uvref.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Worker, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Worker_uvref" "', argument " "1"" of type '" "Worker *""'"); 
  }
  arg1 = reinterpret_cast< Worker * >(argp1);
  (arg1)->uvref();
...
static SwigV8ReturnValue _wrap_Worker_JoinThread(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Worker_JoinThread.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Worker, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Worker_JoinThread" "', argument " "1"" of type '" "Worker *""'"); 
  }
  arg1 = reinterpret_cast< Worker * >(argp1);
  (arg1)->JoinThread();
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_Worker_Unref(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Worker_Unref.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Worker, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Worker_Unref" "', argument " "1"" of type '" "Worker *""'"); 
  }
  arg1 = reinterpret_cast< Worker * >(argp1);
  (arg1)->Unref();
  jsresult = SWIGV8_UNDEFINED();
...
static void _wrap_delete_Worker(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    Worker * arg1 = (Worker *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_Worker = {"_p_Worker", "Worker *|p_Worker", 0, 0, (void*)0, 0};
...
#endif
{
  ...
  /* Name: _exports_Worker, Type: p_Worker, Dtor: _wrap_delete_Worker */
SWIGV8_FUNCTION_TEMPLATE _exports_Worker_class = SWIGV8_CreateClassTemplate("_exports_Worker");
SWIGV8_SET_CLASS_TEMPL(_exports_Worker_clientData.class_templ, _exports_Worker_class);
_exports_Worker_clientData.dtor = _wrap_delete_Worker;
if (SWIGTYPE_p_Worker->clientdata == 0) {
  SWIGTYPE_p_Worker->clientdata = &_exports_Worker_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_Worker_class, "uvref", _wrap_Worker_uvref);
SWIGV8_AddMemberFunction(_exports_Worker_class, "JoinThread", _wrap_Worker_JoinThread);
SWIGV8_AddMemberFunction(_exports_Worker_class, "Unref", _wrap_Worker_Unref);
  ...
  /* class instances */
  /* Class: Worker (_exports_Worker) */
SWIGV8_FUNCTION_TEMPLATE _exports_Worker_class_0 = SWIGV8_CreateClassTemplate("Worker");
_exports_Worker_class_0->SetCallHandler(_wrap_new_Worker);
_exports_Worker_class_0->Inherit(_exports_Worker_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_Worker_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_Worker_obj = _exports_Worker_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_Worker_obj = _exports_Worker_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("Worker"), _exports_Worker_obj));
