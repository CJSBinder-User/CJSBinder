obj = new DISTRIBUTING_ITEMS_PERSON_CANNOT_TAKE_TWO_ITEMS_TYPE();
...
for(let i = 0; i < param0.length; ++i) {
    print(obj.D_I_P_C_T_T_I_T_f_gold(param0[i],param1[i],param2[i]))
}
obj.D_I_P_C_T_T_I_T_f_gold("abc", "abc", "abc")