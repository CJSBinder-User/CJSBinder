...
//
//[code snippet 1]
void SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1* obj = new SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1();
...
//
//[code snippet 2]
void SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || !args[0]->IsInt32() || !args[1]->IsInt32() || !args[2]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1* obj = static_cast<SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->S_O_T_I_W_C_O_1_f_gold(x, y, z);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1").ToLocalChecked());

    // Register the function
    tpl->PrototypeTemplate()->Set(isolate, "S_O_T_I_W_C_O_1_f_gold", v8::FunctionTemplate::New(isolate, SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1").ToLocalChecked(), constructor);
