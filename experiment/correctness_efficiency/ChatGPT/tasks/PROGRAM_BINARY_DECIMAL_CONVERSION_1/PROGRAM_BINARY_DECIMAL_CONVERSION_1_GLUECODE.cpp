...
//
//[code snippet 1]
void PROGRAM_BINARY_DECIMAL_CONVERSION_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PROGRAM_BINARY_DECIMAL_CONVERSION_1* obj = new PROGRAM_BINARY_DECIMAL_CONVERSION_1();
...
//
//[code snippet 2]
void PROGRAM_BINARY_DECIMAL_CONVERSION_1_P_B_D_C_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    PROGRAM_BINARY_DECIMAL_CONVERSION_1* obj = static_cast<PROGRAM_BINARY_DECIMAL_CONVERSION_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->P_B_D_C_1_f_gold(n);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PROGRAM_BINARY_DECIMAL_CONVERSION_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PROGRAM_BINARY_DECIMAL_CONVERSION_1").ToLocalChecked());
  
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PROGRAM_BINARY_DECIMAL_CONVERSION_1_P_B_D_C_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_B_D_C_1_f_gold", method_tpl);
  
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PROGRAM_BINARY_DECIMAL_CONVERSION_1").ToLocalChecked(), constructor);
