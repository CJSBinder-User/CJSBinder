...
//
//[code snippet 1]
void SUM_TWO_LARGE_NUMBERS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUM_TWO_LARGE_NUMBERS* obj = new SUM_TWO_LARGE_NUMBERS();
...
//
//[code snippet 2]
void SUM_TWO_LARGE_NUMBERS_S_T_L_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    SUM_TWO_LARGE_NUMBERS* obj = static_cast<SUM_TWO_LARGE_NUMBERS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    std::string result = obj->S_T_L_N_f_gold(*str1, *str2);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUM_TWO_LARGE_NUMBERS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUM_TWO_LARGE_NUMBERS").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SUM_TWO_LARGE_NUMBERS_S_T_L_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_T_L_N_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUM_TWO_LARGE_NUMBERS").ToLocalChecked(), constructor);
