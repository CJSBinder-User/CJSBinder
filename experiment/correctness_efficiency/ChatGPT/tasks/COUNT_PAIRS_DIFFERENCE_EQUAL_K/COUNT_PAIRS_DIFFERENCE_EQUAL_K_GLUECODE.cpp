...
//
//[code snippet 1]
void COUNT_PAIRS_DIFFERENCE_EQUAL_K_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_PAIRS_DIFFERENCE_EQUAL_K* obj = new COUNT_PAIRS_DIFFERENCE_EQUAL_K();
...
//
//[code snippet 2]
void COUNT_PAIRS_DIFFERENCE_EQUAL_K_C_P_D_E_K_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    COUNT_PAIRS_DIFFERENCE_EQUAL_K* obj = static_cast<COUNT_PAIRS_DIFFERENCE_EQUAL_K*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->C_P_D_E_K_f_gold(arr, n, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_PAIRS_DIFFERENCE_EQUAL_K_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_PAIRS_DIFFERENCE_EQUAL_K").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, COUNT_PAIRS_DIFFERENCE_EQUAL_K_C_P_D_E_K_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_P_D_E_K_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_PAIRS_DIFFERENCE_EQUAL_K").ToLocalChecked(), constructor);
