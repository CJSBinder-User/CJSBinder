...
//
//[code snippet 1]
void SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS* obj = new SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS();
...
//
//[code snippet 2]
void SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS_S_N_M_C_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS* obj = static_cast<SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->S_N_M_C_N_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS_S_N_M_C_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_N_M_C_N_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SPLIT_N_MAXIMUM_COMPOSITE_NUMBERS").ToLocalChecked(), constructor);
