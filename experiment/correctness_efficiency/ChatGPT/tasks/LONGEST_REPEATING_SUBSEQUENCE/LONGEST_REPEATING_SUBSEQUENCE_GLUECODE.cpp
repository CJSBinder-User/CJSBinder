...
//
//[code snippet 1]
void LONGEST_REPEATING_SUBSEQUENCE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
...
//
//[code snippet 2]
void LONGEST_REPEATING_SUBSEQUENCE_L_R_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LONGEST_REPEATING_SUBSEQUENCE* obj = static_cast<LONGEST_REPEATING_SUBSEQUENCE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_R_S_f_gold(str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LONGEST_REPEATING_SUBSEQUENCE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LONGEST_REPEATING_SUBSEQUENCE").ToLocalChecked());
    
    // Register the method
    tpl->PrototypeTemplate()->Set(isolate, "L_R_S_f_gold", v8::FunctionTemplate::New(isolate, LONGEST_REPEATING_SUBSEQUENCE_L_R_S_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LONGEST_REPEATING_SUBSEQUENCE").ToLocalChecked(), constructor);
