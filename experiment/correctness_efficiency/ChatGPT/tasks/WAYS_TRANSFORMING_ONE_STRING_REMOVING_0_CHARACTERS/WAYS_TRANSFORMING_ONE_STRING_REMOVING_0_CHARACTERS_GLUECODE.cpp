...
//
//[code snippet 1]
void WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS* obj = new WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS();
...
//
//[code snippet 2]
void W_T_O_S_R_0_C_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsString() || !args[1]->IsString()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }

    v8::String::Utf8Value str_a(args.GetIsolate(), args[0]);
    std::string a(*str_a);
    
    v8::String::Utf8Value str_b(args.GetIsolate(), args[1]);
    std::string b(*str_b);

    WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS* obj = 
        static_cast<WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    int result = obj->W_T_O_S_R_0_C_f_gold(a, b);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "W_T_O_S_R_0_C_f_gold",
                                  v8::FunctionTemplate::New(isolate, W_T_O_S_R_0_C_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, 
                           v8::String::NewFromUtf8(isolate, "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS").ToLocalChecked(), 
                           constructor);
