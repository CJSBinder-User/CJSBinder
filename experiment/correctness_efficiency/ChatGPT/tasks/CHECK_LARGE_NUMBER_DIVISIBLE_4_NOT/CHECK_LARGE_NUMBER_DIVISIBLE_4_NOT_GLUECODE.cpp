...
//
//[code snippet 1]
void CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT* obj = new CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT();
...
//
//[code snippet 2]
void CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT_C_L_N_D_4_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT* obj = static_cast<CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->C_L_N_D_4_N_f_gold(str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "C_L_N_D_4_N_f_gold", v8::FunctionTemplate::New(isolate, CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT_C_L_N_D_4_N_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_LARGE_NUMBER_DIVISIBLE_4_NOT").ToLocalChecked(), constructor);
