...
//
//[code snippet 1]
void PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11* obj = new PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11();
...
//
//[code snippet 2]
void PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11_P_F_R_L_N_D_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsString()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }

    // Convert the V8 string to a C++ string
    v8::String::Utf8Value utf8_value(args.GetIsolate(), args[0]);
    std::string str(*utf8_value);

    PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11* obj = static_cast<PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->P_F_R_L_N_D_1_f_gold(str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "P_F_R_L_N_D_1_f_gold", v8::FunctionTemplate::New(isolate, PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11_P_F_R_L_N_D_1_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PROGRAM_FIND_REMAINDER_LARGE_NUMBER_DIVIDED_11").ToLocalChecked(), constructor);
