...
//
//[code snippet 1]
void DOUBLE_FACTORIAL_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    DOUBLE_FACTORIAL_1* obj = new DOUBLE_FACTORIAL_1();
...
//
//[code snippet 2]
void DOUBLE_FACTORIAL_1_D_F_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsUint32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    DOUBLE_FACTORIAL_1* obj = static_cast<DOUBLE_FACTORIAL_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    unsigned int n = args[0]->Uint32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    unsigned int result = obj->D_F_1_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, DOUBLE_FACTORIAL_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "DOUBLE_FACTORIAL_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "D_F_1_f_gold", v8::FunctionTemplate::New(isolate, DOUBLE_FACTORIAL_1_D_F_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "DOUBLE_FACTORIAL_1").ToLocalChecked(), constructor);
