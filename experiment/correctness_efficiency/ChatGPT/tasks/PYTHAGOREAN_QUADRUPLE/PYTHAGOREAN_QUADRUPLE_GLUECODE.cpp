...
//
//[code snippet 1]
void PYTHAGOREAN_QUADRUPLE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PYTHAGOREAN_QUADRUPLE* obj = new PYTHAGOREAN_QUADRUPLE();
...
//
//[code snippet 2]
void PYTHAGOREAN_QUADRUPLE_P_Q_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 4 || 
        !args[0]->IsInt32() || 
        !args[1]->IsInt32() || 
        !args[2]->IsInt32() || 
    ...
    PYTHAGOREAN_QUADRUPLE* obj = static_cast<PYTHAGOREAN_QUADRUPLE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int d = args[3]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    
    bool result = obj->P_Q_f_gold(a, b, c, d);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PYTHAGOREAN_QUADRUPLE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PYTHAGOREAN_QUADRUPLE").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PYTHAGOREAN_QUADRUPLE_P_Q_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_Q_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PYTHAGOREAN_QUADRUPLE").ToLocalChecked(), constructor);
