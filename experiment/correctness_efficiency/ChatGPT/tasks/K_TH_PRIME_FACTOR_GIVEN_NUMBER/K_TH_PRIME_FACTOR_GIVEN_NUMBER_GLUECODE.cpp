...
//
//[code snippet 1]
void K_TH_PRIME_FACTOR_GIVEN_NUMBER_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    K_TH_PRIME_FACTOR_GIVEN_NUMBER* obj = new K_TH_PRIME_FACTOR_GIVEN_NUMBER();
...
//
//[code snippet 2]
void K_T_P_F_G_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    K_TH_PRIME_FACTOR_GIVEN_NUMBER* obj = static_cast<K_TH_PRIME_FACTOR_GIVEN_NUMBER*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->K_T_P_F_G_N_f_gold(n, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, K_TH_PRIME_FACTOR_GIVEN_NUMBER_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "K_TH_PRIME_FACTOR_GIVEN_NUMBER").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, K_T_P_F_G_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "K_T_P_F_G_N_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "K_TH_PRIME_FACTOR_GIVEN_NUMBER").ToLocalChecked(), constructor);
