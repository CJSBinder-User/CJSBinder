...
//
//[code snippet 1]
void PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON* obj = new PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON();
...
//
//[code snippet 2]
void PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON_P_T_F_T_A_O_P_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsNumber()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON* obj = static_cast<PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    double a = args[0]->NumberValue(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    double result = obj->P_T_F_T_A_O_P_f_gold(a);
...
void Initialize(v8::Isolate* isolate, v8::Local<v8::Context>& context) {
    ...
    //
//[code snippet 3]
// Assuming that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON_P_T_F_T_A_O_P_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_T_F_T_A_O_P_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PROGRAM_TO_FIND_THE_AREA_OF_PENTAGON").ToLocalChecked(), constructor);
