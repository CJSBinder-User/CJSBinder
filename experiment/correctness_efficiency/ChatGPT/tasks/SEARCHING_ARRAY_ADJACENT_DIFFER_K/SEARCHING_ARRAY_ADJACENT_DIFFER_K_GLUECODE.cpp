...
//
//[code snippet 1]
void SEARCHING_ARRAY_ADJACENT_DIFFER_K_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SEARCHING_ARRAY_ADJACENT_DIFFER_K* obj = new SEARCHING_ARRAY_ADJACENT_DIFFER_K();
...
//
//[code snippet 2]
void SEARCHING_ARRAY_ADJACENT_DIFFER_K_S_A_A_D_K_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    SEARCHING_ARRAY_ADJACENT_DIFFER_K* obj = static_cast<SEARCHING_ARRAY_ADJACENT_DIFFER_K*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->S_A_A_D_K_f_gold(arr, n, x, k);
    delete[] arr; // Clean up C++ array
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SEARCHING_ARRAY_ADJACENT_DIFFER_K_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SEARCHING_ARRAY_ADJACENT_DIFFER_K").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SEARCHING_ARRAY_ADJACENT_DIFFER_K_S_A_A_D_K_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_A_A_D_K_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SEARCHING_ARRAY_ADJACENT_DIFFER_K").ToLocalChecked(), constructor);
