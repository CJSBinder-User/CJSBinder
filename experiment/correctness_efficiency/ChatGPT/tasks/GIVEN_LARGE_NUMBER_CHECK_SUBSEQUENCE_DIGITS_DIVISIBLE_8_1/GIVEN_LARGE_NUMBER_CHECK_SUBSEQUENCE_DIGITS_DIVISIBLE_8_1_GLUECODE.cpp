...
//
//[code snippet 1]
void GIVEN_LARGE_NUMBER_CHECK_SUBSEQUENCE_DIGITS_DIVISIBLE_8_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    GIVEN_LARGE_NUMBER_CHECK_SUBSEQUENCE_DIGITS_DIVISIBLE_8_1* obj = new GIVEN_LARGE_NUMBER_CHECK_SUBSEQUENCE_DIGITS_DIVISIBLE_8_1();
...
//
//[code snippet 2]
void G_L_N_C_S_D_D_8_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    std::string cstr(*str, str.length());

    GIVEN_LARGE_NUMBER_CHECK_SUBSEQUENCE_DIGITS_DIVISIBLE_8_1* obj = static_cast<GIVEN_LARGE_NUMBER_CHECK_SUBSEQUENCE_DIGITS_DIVISIBLE_8_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->G_L_N_C_S_D_D_8_1_f_gold(cstr);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, GIVEN_LARGE_NUMBER_CHECK_SUBSEQUENCE_DIGITS_DIVISIBLE_8_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "GIVEN_LARGE_NUMBER_CHECK_SUBSEQUENCE_DIGITS_DIVISIBLE_8_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "G_L_N_C_S_D_D_8_1_f_gold", v8::FunctionTemplate::New(isolate, G_L_N_C_S_D_D_8_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "GIVEN_LARGE_NUMBER_CHECK_SUBSEQUENCE_DIGITS_DIVISIBLE_8_1").ToLocalChecked(), constructor);
