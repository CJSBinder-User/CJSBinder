...
//
//[code snippet 1]
void PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K* obj = new PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K();
...
//
//[code snippet 2]
void PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K_P_T_A_S_E_P_G_E_K_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 4 || 
        !args[0]->IsArray() || 
        !args[1]->IsArray() || 
        !args[2]->IsInt32() || 
    ...
    // Convert arguments from JS to C++
    ...
    // Call the C++ method
    PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K* obj = static_cast<PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->P_T_A_S_E_P_G_E_K_f_gold(a, b, n, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "P_T_A_S_E_P_G_E_K_f_gold", v8::FunctionTemplate::New(isolate, PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K_P_T_A_S_E_P_G_E_K_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PERMUTE_TWO_ARRAYS_SUM_EVERY_PAIR_GREATER_EQUAL_K").ToLocalChecked(), constructor);
