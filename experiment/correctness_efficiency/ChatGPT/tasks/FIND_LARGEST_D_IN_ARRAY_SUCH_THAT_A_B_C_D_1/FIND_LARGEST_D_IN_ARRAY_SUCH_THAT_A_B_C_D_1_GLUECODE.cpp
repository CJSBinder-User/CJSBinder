...
//
//[code snippet 1]
void FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1* obj = new FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1();
...
//
//[code snippet 2]
void FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1_F_L_D_I_A_S_T_A_B_C_D_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1* obj = static_cast<FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_L_D_I_A_S_T_A_B_C_D_1_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1_F_L_D_I_A_S_T_A_B_C_D_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_L_D_I_A_S_T_A_B_C_D_1_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_LARGEST_D_IN_ARRAY_SUCH_THAT_A_B_C_D_1").ToLocalChecked(), constructor);
