...
//
//[code snippet 1]
void FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1* obj = new FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1();
...
//
//[code snippet 2]
void FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1_f_N_T_S_O_G_S_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1* obj = static_cast<FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    int result = obj->F_N_T_S_O_G_S_1_f_gold(*str0, *str1);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1_f_N_T_S_O_G_S_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_N_T_S_O_G_S_1_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_NUMBER_TIMES_STRING_OCCURS_GIVEN_STRING_1").ToLocalChecked(), constructor);
