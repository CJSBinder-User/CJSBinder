...
//
//[code snippet 1]
void FIND_PAIR_MAXIMUM_GCD_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_PAIR_MAXIMUM_GCD_ARRAY* obj = new FIND_PAIR_MAXIMUM_GCD_ARRAY();
...
//
//[code snippet 2]
void FIND_PAIR_MAXIMUM_GCD_ARRAY_F_P_M_G_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    // Create instance of the C++ class and call the function
    FIND_PAIR_MAXIMUM_GCD_ARRAY* obj = static_cast<FIND_PAIR_MAXIMUM_GCD_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_P_M_G_A_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_PAIR_MAXIMUM_GCD_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_PAIR_MAXIMUM_GCD_ARRAY").ToLocalChecked());

    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_PAIR_MAXIMUM_GCD_ARRAY_F_P_M_G_A_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_P_M_G_A_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_PAIR_MAXIMUM_GCD_ARRAY").ToLocalChecked(), constructor);
