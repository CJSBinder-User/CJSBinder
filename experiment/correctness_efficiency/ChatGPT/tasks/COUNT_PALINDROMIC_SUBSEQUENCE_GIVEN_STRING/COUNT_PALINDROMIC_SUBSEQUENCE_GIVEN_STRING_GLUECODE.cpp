...
//
//[code snippet 1]
void COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING* obj = new COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING();
...
//
//[code snippet 2]
void COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING_C_P_S_G_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING* obj = 
        static_cast<COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    int result = obj->C_P_S_G_S_f_gold(str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING").ToLocalChecked());

    tpl->PrototypeTemplate()->Set(isolate, "C_P_S_G_S_f_gold", v8::FunctionTemplate::New(isolate, COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING_C_P_S_G_S_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_PALINDROMIC_SUBSEQUENCE_GIVEN_STRING").ToLocalChecked(), constructor);
