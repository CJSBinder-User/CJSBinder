...
//
//[code snippet 1]
void C_PROGRAM_FACTORIAL_NUMBER_2_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    C_PROGRAM_FACTORIAL_NUMBER_2* obj = new C_PROGRAM_FACTORIAL_NUMBER_2();
...
//
//[code snippet 2]
void C_PROGRAM_FACTORIAL_NUMBER_2_C_P_F_N_2_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    C_PROGRAM_FACTORIAL_NUMBER_2* obj = static_cast<C_PROGRAM_FACTORIAL_NUMBER_2*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->C_P_F_N_2_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, C_PROGRAM_FACTORIAL_NUMBER_2_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "C_PROGRAM_FACTORIAL_NUMBER_2").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, C_PROGRAM_FACTORIAL_NUMBER_2_C_P_F_N_2_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_P_F_N_2_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "C_PROGRAM_FACTORIAL_NUMBER_2").ToLocalChecked(), constructor);
