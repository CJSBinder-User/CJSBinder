...
//
//[code snippet 1]
void TAIL_RECURSION_FIBONACCI_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    TAIL_RECURSION_FIBONACCI* obj = new TAIL_RECURSION_FIBONACCI();
...
//
//[code snippet 2]
void TAIL_RECURSION_FIBONACCI_T_R_F_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || !args[0]->IsInt32() || !args[1]->IsInt32() || !args[2]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    TAIL_RECURSION_FIBONACCI* obj = static_cast<TAIL_RECURSION_FIBONACCI*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->T_R_F_f_gold(n, a, b);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, TAIL_RECURSION_FIBONACCI_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "TAIL_RECURSION_FIBONACCI").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, TAIL_RECURSION_FIBONACCI_T_R_F_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "T_R_F_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "TAIL_RECURSION_FIBONACCI").ToLocalChecked(), constructor);
