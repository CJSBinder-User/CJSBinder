...
//
//[code snippet 1]
void CHECK_LINE_PASSES_ORIGIN_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_LINE_PASSES_ORIGIN* obj = new CHECK_LINE_PASSES_ORIGIN();
...
//
//[code snippet 2]
void CHECK_LINE_PASSES_ORIGIN_C_L_P_O_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 4 || !args[0]->IsInt32() || !args[1]->IsInt32() || !args[2]->IsInt32() || !args[3]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    CHECK_LINE_PASSES_ORIGIN* obj = static_cast<CHECK_LINE_PASSES_ORIGIN*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->C_L_P_O_f_gold(x1, y1, x2, y2);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_LINE_PASSES_ORIGIN_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_LINE_PASSES_ORIGIN").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, CHECK_LINE_PASSES_ORIGIN_C_L_P_O_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_L_P_O_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_LINE_PASSES_ORIGIN").ToLocalChecked(), constructor);
