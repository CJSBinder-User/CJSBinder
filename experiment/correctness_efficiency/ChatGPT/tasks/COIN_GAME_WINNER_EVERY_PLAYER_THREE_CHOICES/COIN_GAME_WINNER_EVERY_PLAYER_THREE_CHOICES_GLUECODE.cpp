...
//
//[code snippet 1]
void COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES* obj = new COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES();
...
//
//[code snippet 2]
void COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES_C_G_W_E_P_T_C_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || 
        !args[0]->IsInt32() || 
        !args[1]->IsInt32() || 
        !args[2]->IsInt32()) {
    ...
    COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES* obj = static_cast<COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->C_G_W_E_P_T_C_f_gold(x, y, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "C_G_W_E_P_T_C_f_gold", v8::FunctionTemplate::New(isolate, COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES_C_G_W_E_P_T_C_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COIN_GAME_WINNER_EVERY_PLAYER_THREE_CHOICES").ToLocalChecked(), constructor);
