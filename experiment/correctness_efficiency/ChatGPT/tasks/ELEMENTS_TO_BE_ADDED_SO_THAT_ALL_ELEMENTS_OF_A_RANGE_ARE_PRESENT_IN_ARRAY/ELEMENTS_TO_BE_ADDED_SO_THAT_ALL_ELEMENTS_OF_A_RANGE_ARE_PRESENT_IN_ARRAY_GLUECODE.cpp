...
//
//[code snippet 1]
void ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY* obj = 
        new ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY();
...
//
//[code snippet 2]
void ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY* obj =
        static_cast<ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY*>(
            v8::External::Cast(*args.This()->GetInternalField(0))->Value());

    // Prepare the input array
    v8::Local<v8::Array> inputArray = v8::Local<v8::Array>::Cast(args[0]);
    int n = static_cast<int>(args[1]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0));
    ...
    // Call the C++ method
    int result = obj->E_T_B_A_S_T_A_E_O_A_R_A_P_I_A_f_gold(arr, n);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY").ToLocalChecked());
    // Register the method
    tpl->PrototypeTemplate()->Set(isolate, "E_T_B_A_S_T_A_E_O_A_R_A_P_I_A_f_gold", v8::FunctionTemplate::New(isolate, ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "ELEMENTS_TO_BE_ADDED_SO_THAT_ALL_ELEMENTS_OF_A_RANGE_ARE_PRESENT_IN_ARRAY").ToLocalChecked(), constructor);
