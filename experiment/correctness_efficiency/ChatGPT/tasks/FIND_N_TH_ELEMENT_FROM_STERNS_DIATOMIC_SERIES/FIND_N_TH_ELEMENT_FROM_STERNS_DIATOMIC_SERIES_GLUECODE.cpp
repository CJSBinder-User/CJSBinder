...
//
//[code snippet 1]
void FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES* obj = new FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES();
...
//
//[code snippet 2]
void FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_F_N_T_E_F_S_D_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES* obj = static_cast<FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->F_N_T_E_F_S_D_S_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "F_N_T_E_F_S_D_S_f_gold", v8::FunctionTemplate::New(isolate, FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_F_N_T_E_F_S_D_S_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES").ToLocalChecked(), constructor);
