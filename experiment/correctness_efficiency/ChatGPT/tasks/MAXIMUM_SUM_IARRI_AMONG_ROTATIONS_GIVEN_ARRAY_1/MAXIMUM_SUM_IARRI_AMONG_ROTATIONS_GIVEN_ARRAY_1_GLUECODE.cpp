...
//
//[code snippet 1]
void MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1* obj = new MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1();
...
//
//[code snippet 2]
void MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1_M_S_I_A_R_G_A_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    // Convert v8 Array to a C++ int array
    int* c_arr = new int[n];
    for (int i = 0; i < n; ++i) {
    ...
    MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1* obj = static_cast<MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_S_I_A_R_G_A_1_f_gold(c_arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "M_S_I_A_R_G_A_1_f_gold", v8::FunctionTemplate::New(isolate, MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1_M_S_I_A_R_G_A_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_1").ToLocalChecked(), constructor);
