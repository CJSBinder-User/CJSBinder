...
//
//[code snippet 1]
void NUMBER_RECTANGLES_NM_GRID_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_RECTANGLES_NM_GRID* obj = new NUMBER_RECTANGLES_NM_GRID();
...
//
//[code snippet 2]
void NUMBER_RECTANGLES_NM_GRID_N_R_N_G_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    NUMBER_RECTANGLES_NM_GRID* obj = static_cast<NUMBER_RECTANGLES_NM_GRID*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->N_R_N_G_f_gold(n, m);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_RECTANGLES_NM_GRID_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_RECTANGLES_NM_GRID").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "N_R_N_G_f_gold", v8::FunctionTemplate::New(isolate, NUMBER_RECTANGLES_NM_GRID_N_R_N_G_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_RECTANGLES_NM_GRID").ToLocalChecked(), constructor);
