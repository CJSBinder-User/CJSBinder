...
//
//[code snippet 1]
void COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS* obj = new COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS();
...
//
//[code snippet 2]
void COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS_C_S_W_S_E_A_O_E_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS* obj = static_cast<COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->C_S_W_S_E_A_O_E_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS").ToLocalChecked());
    
    // Registering the method
    tpl->PrototypeTemplate()->Set(isolate, "C_S_W_S_E_A_O_E_f_gold", v8::FunctionTemplate::New(isolate, COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS_C_S_W_S_E_A_O_E_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_SUBARRAYS_WITH_SAME_EVEN_AND_ODD_ELEMENTS").ToLocalChecked(), constructor);
