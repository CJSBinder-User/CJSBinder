...
//
//[code snippet 1]
void MODULUS_TWO_FLOAT_DOUBLE_NUMBERS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MODULUS_TWO_FLOAT_DOUBLE_NUMBERS* obj = new MODULUS_TWO_FLOAT_DOUBLE_NUMBERS();
...
//
//[code snippet 2]
void MODULUS_TWO_FLOAT_DOUBLE_NUMBERS_M_T_F_D_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsNumber() || !args[1]->IsNumber()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    MODULUS_TWO_FLOAT_DOUBLE_NUMBERS* obj = static_cast<MODULUS_TWO_FLOAT_DOUBLE_NUMBERS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    double result = obj->M_T_F_D_N_f_gold(a, b);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MODULUS_TWO_FLOAT_DOUBLE_NUMBERS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MODULUS_TWO_FLOAT_DOUBLE_NUMBERS").ToLocalChecked());
    
    // Set the method
    tpl->PrototypeTemplate()->Set(isolate, "M_T_F_D_N_f_gold", v8::FunctionTemplate::New(isolate, MODULUS_TWO_FLOAT_DOUBLE_NUMBERS_M_T_F_D_N_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MODULUS_TWO_FLOAT_DOUBLE_NUMBERS").ToLocalChecked(), constructor);
