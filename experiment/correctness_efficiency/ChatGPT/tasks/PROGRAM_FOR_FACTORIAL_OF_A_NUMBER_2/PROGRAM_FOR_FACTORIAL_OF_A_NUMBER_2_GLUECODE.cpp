...
//
//[code snippet 1]
void PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2* obj = new PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2();
...
//
//[code snippet 2]
void PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2_P_F_F_O_A_N_2_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2* obj = static_cast<PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->P_F_F_O_A_N_2_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2_P_F_F_O_A_N_2_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_F_F_O_A_N_2_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PROGRAM_FOR_FACTORIAL_OF_A_NUMBER_2").ToLocalChecked(), constructor);
