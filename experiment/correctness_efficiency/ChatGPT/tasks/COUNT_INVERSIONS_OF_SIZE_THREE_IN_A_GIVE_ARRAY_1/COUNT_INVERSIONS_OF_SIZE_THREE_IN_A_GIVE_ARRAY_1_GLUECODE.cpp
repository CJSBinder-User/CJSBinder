...
//
//[code snippet 1]
void COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1* obj = new COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1();
...
//
//[code snippet 2]
void COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1_C_I_O_S_T_I_A_G_A_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1* obj = 
        static_cast<COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    int result = obj->C_I_O_S_T_I_A_G_A_1_f_gold(c_arr, n);
    args.GetReturnValue().Set(v8::Integer::New(args.GetIsolate(), result));

    delete[] c_arr; // Remember to free allocated memory
}
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, 
        "C_I_O_S_T_I_A_G_A_1_f_gold", 
        v8::FunctionTemplate::New(isolate, COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1_C_I_O_S_T_I_A_G_A_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, 
        v8::String::NewFromUtf8(isolate, "COUNT_INVERSIONS_OF_SIZE_THREE_IN_A_GIVE_ARRAY_1").ToLocalChecked(), 
        constructor);
