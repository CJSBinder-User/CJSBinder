...
//
//[code snippet 1]
void PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP* obj = new PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP();
...
//
//[code snippet 2]
void PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_P_T_R_C_N_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP* obj = static_cast<PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    double result = obj->P_T_R_C_N_A_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_P_T_R_C_N_A_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_T_R_C_N_A_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP").ToLocalChecked(), constructor);
