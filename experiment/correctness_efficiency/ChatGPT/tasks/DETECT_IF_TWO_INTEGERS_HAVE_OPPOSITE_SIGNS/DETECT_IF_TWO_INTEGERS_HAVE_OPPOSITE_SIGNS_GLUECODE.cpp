...
//
//[code snippet 1]
void DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS* obj = new DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS();
...
//
//[code snippet 2]
void DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS_D_I_T_I_H_O_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS* obj = static_cast<DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->D_I_T_I_H_O_S_f_gold(x, y);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS_D_I_T_I_H_O_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "D_I_T_I_H_O_S_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "DETECT_IF_TWO_INTEGERS_HAVE_OPPOSITE_SIGNS").ToLocalChecked(), constructor);
