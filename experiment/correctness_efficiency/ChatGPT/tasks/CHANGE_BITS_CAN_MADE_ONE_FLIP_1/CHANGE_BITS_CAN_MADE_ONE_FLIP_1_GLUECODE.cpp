...
//
//[code snippet 1]
void CHANGE_BITS_CAN_MADE_ONE_FLIP_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHANGE_BITS_CAN_MADE_ONE_FLIP_1* obj = new CHANGE_BITS_CAN_MADE_ONE_FLIP_1();
...
//
//[code snippet 2]
void CHANGE_BITS_CAN_MADE_ONE_FLIP_1_C_B_C_M_O_F_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHANGE_BITS_CAN_MADE_ONE_FLIP_1* obj = static_cast<CHANGE_BITS_CAN_MADE_ONE_FLIP_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->C_B_C_M_O_F_1_f_gold(str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHANGE_BITS_CAN_MADE_ONE_FLIP_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHANGE_BITS_CAN_MADE_ONE_FLIP_1").ToLocalChecked());

    // Register the method
    tpl->PrototypeTemplate()->Set(isolate, "C_B_C_M_O_F_1_f_gold", v8::FunctionTemplate::New(isolate, CHANGE_BITS_CAN_MADE_ONE_FLIP_1_C_B_C_M_O_F_1_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHANGE_BITS_CAN_MADE_ONE_FLIP_1").ToLocalChecked(), constructor);
