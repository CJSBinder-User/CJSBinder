...
//
//[code snippet 1]
void PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1* obj = new PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1();
...
//
//[code snippet 2]
void PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1_P_W_G_P_S_1_F_I_A_P_E_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1* obj = static_cast<PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    // Call the actual function and return the result.
    bool result = obj->P_W_G_P_S_1_F_I_A_P_E_1_f_gold(arr, n, x);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1").ToLocalChecked());
    
    // Register the method
    tpl->PrototypeTemplate()->Set(isolate, "P_W_G_P_S_1_F_I_A_P_E_1_f_gold", v8::FunctionTemplate::New(isolate, PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1_P_W_G_P_S_1_F_I_A_P_E_1_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PAIR_WITH_GIVEN_PRODUCT_SET_1_FIND_IF_ANY_PAIR_EXISTS_1").ToLocalChecked(), constructor);
