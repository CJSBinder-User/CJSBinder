obj = new MINIMUM_ROOMS_FOR_M_EVENTS_OF_N_BATCHES_WITH_GIVEN_SCHEDULE();
let param0 =[["pECmwnMblBFWx","CZPrc","mPCbBVdYeMOeh","yA","ZgJF","UrbTP","RPXLB","RxGMlM","ZowRSvJjB","ICedYoDz","MCvIVUr","TGg","jx","VRAXfWhuO","HMQ","mPU MBf","lcVtOPShz","BIROOQ","bgOyYX"," kjIRdPbRBQT","RCbHGtUDPztaay","w","RonaGfwzcTf","ZyUqBFCw","pFzGVsOqL","nruTMPVMBtf","zfMzqNbYugR","cJQR","YsDkmGLVbTwXWt","YD","Dy"],
...
let param1 =[18,3,11,34,33,8,5,7,1,7];
let param2 =[30,7,10,13,21,7,4,12,1,8];
for(let i = 0; i < param0.length; ++i) {
    print(obj.M_R_F_M_E_O_N_B_W_G_S_f_gold(param0[i],param1[i],param2[i]))
}
obj.M_R_F_M_E_O_N_B_W_G_S_f_gold(-1, "abc", "abc")
