...
//
//[code snippet 1]
void LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING* obj = new LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING();
...
//
//[code snippet 2]
void LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING_L_R_A_N_O_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING* obj = 
        static_cast<LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    std::string result = obj->L_R_A_N_O_S_f_gold(*str);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "L_R_A_N_O_S_f_gold", v8::FunctionTemplate::New(isolate, LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING_L_R_A_N_O_S_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LONGEST_REPEATING_AND_NON_OVERLAPPING_SUBSTRING").ToLocalChecked(), constructor);
