...
//
//[code snippet 1]
void MULTIPLY_AN_INTEGER_WITH_3_5_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MULTIPLY_AN_INTEGER_WITH_3_5* obj = new MULTIPLY_AN_INTEGER_WITH_3_5();
...
//
//[code snippet 2]
void MULTIPLY_AN_INTEGER_WITH_3_5_M_A_I_W_3_5_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    MULTIPLY_AN_INTEGER_WITH_3_5* obj = static_cast<MULTIPLY_AN_INTEGER_WITH_3_5*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int x = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->M_A_I_W_3_5_f_gold(x);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MULTIPLY_AN_INTEGER_WITH_3_5_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MULTIPLY_AN_INTEGER_WITH_3_5").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, MULTIPLY_AN_INTEGER_WITH_3_5_M_A_I_W_3_5_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "M_A_I_W_3_5_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MULTIPLY_AN_INTEGER_WITH_3_5").ToLocalChecked(), constructor);
