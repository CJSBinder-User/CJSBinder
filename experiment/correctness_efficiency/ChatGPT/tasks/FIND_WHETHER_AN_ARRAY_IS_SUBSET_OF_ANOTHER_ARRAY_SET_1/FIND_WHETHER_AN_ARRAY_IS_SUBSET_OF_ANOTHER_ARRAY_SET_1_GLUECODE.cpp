...
//
//[code snippet 1]
void FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1* obj = new FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1();
...
//
//[code snippet 2]
void FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1_F_W_A_A_I_S_O_A_A_S_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    for (int i = 0; i < n; i++) {
        arr2[i] = jsArr2->Get(args.GetIsolate()->GetCurrentContext(), i).ToLocalChecked()->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    }
    
    FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1* obj = static_cast<FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->F_W_A_A_I_S_O_A_A_S_1_f_gold(arr1, arr2, m, n);
    
    delete[] arr1;
    delete[] arr2;
    
    args.GetReturnValue().Set(result ? v8::True(args.GetIsolate()) : v8::False(args.GetIsolate()));
}
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "F_W_A_A_I_S_O_A_A_S_1_f_gold", v8::FunctionTemplate::New(isolate, FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1_F_W_A_A_I_S_O_A_A_S_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_WHETHER_AN_ARRAY_IS_SUBSET_OF_ANOTHER_ARRAY_SET_1").ToLocalChecked(), constructor);
