...
//
//[code snippet 1]
void CHECK_DIVISIBILITY_BINARY_STRING_2K_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_DIVISIBILITY_BINARY_STRING_2K* obj = new CHECK_DIVISIBILITY_BINARY_STRING_2K();
...
//
//[code snippet 2]
void CHECK_DIVISIBILITY_BINARY_STRING_2K_C_D_B_S_2_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsString() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    CHECK_DIVISIBILITY_BINARY_STRING_2K* obj = static_cast<CHECK_DIVISIBILITY_BINARY_STRING_2K*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->C_D_B_S_2_f_gold(str, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_DIVISIBILITY_BINARY_STRING_2K_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_DIVISIBILITY_BINARY_STRING_2K").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, CHECK_DIVISIBILITY_BINARY_STRING_2K_C_D_B_S_2_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_D_B_S_2_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_DIVISIBILITY_BINARY_STRING_2K").ToLocalChecked(), constructor);
