...
//
//[code snippet 1]
void PAINTING_FENCE_ALGORITHM_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PAINTING_FENCE_ALGORITHM* obj = new PAINTING_FENCE_ALGORITHM();
...
//
//[code snippet 2]
void PAINTING_FENCE_ALGORITHM_P_F_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    PAINTING_FENCE_ALGORITHM* obj = static_cast<PAINTING_FENCE_ALGORITHM*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    long result = obj->P_F_A_f_gold(n, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PAINTING_FENCE_ALGORITHM_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PAINTING_FENCE_ALGORITHM").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PAINTING_FENCE_ALGORITHM_P_F_A_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_F_A_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PAINTING_FENCE_ALGORITHM").ToLocalChecked(), constructor);
