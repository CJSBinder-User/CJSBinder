...
//
//[code snippet 1]
void SPACE_OPTIMIZED_SOLUTION_LCS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SPACE_OPTIMIZED_SOLUTION_LCS* obj = new SPACE_OPTIMIZED_SOLUTION_LCS();
...
//
//[code snippet 2]
void SPACE_OPTIMIZED_SOLUTION_LCS_S_O_S_L_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    SPACE_OPTIMIZED_SOLUTION_LCS* obj = 
        static_cast<SPACE_OPTIMIZED_SOLUTION_LCS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->S_O_S_L_f_gold(x, y);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SPACE_OPTIMIZED_SOLUTION_LCS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SPACE_OPTIMIZED_SOLUTION_LCS").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SPACE_OPTIMIZED_SOLUTION_LCS_S_O_S_L_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_O_S_L_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SPACE_OPTIMIZED_SOLUTION_LCS").ToLocalChecked(), constructor);
