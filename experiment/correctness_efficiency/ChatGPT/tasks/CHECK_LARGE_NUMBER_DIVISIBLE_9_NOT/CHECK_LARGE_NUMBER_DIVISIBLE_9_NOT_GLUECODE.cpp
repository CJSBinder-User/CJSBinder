...
//
//[code snippet 1]
void CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT* obj = new CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT();
...
//
//[code snippet 2]
void CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT_C_L_N_D_9_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsString()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    v8::String::Utf8Value str(args.GetIsolate(), args[0].As<v8::String>());
    CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT* obj = static_cast<CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->C_L_N_D_9_N_f_gold(*str);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT_C_L_N_D_9_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_L_N_D_9_N_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_LARGE_NUMBER_DIVISIBLE_9_NOT").ToLocalChecked(), constructor);
