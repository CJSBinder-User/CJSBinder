...
//
//[code snippet 1]
void COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE* obj = new COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE();
...
//
//[code snippet 2]
void COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE_C_D_O_A_A_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE* obj = static_cast<COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    // Call the method and retrieve the result
    int result = obj->C_D_O_A_A_S_f_gold(std::string(*str1), std::string(*str2));
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE").ToLocalChecked());

    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE_C_D_O_A_A_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_D_O_A_A_S_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_DISTINCT_OCCURRENCES_AS_A_SUBSEQUENCE").ToLocalChecked(), constructor);
