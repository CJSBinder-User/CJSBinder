...
//
//[code snippet 1]
void NUMBER_IS_DIVISIBLE_BY_29_OR_NOT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_IS_DIVISIBLE_BY_29_OR_NOT* obj = new NUMBER_IS_DIVISIBLE_BY_29_OR_NOT();
...
//
//[code snippet 2]
void NUMBER_IS_DIVISIBLE_BY_29_OR_NOT_N_I_D_B_2_O_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsBigInt()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    NUMBER_IS_DIVISIBLE_BY_29_OR_NOT* obj = static_cast<NUMBER_IS_DIVISIBLE_BY_29_OR_NOT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    long long n = args[0]->ToBigInt(args.GetIsolate()->GetCurrentContext()).ToLocalChecked()->Value();
    bool result = obj->N_I_D_B_2_O_N_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_IS_DIVISIBLE_BY_29_OR_NOT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_IS_DIVISIBLE_BY_29_OR_NOT").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "N_I_D_B_2_O_N_f_gold", v8::FunctionTemplate::New(isolate, NUMBER_IS_DIVISIBLE_BY_29_OR_NOT_N_I_D_B_2_O_N_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_IS_DIVISIBLE_BY_29_OR_NOT").ToLocalChecked(), constructor);
