...
//
//[code snippet 1]
void FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT* obj = new FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT();
...
//
//[code snippet 2]
void FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT_F_E_D_P_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT* obj = static_cast<FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->F_E_D_P_N_f_gold(*str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "F_E_D_P_N_f_gold", v8::FunctionTemplate::New(isolate, FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT_F_E_D_P_N_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_EXPRESSION_DUPLICATE_PARENTHESIS_NOT").ToLocalChecked(), constructor);
