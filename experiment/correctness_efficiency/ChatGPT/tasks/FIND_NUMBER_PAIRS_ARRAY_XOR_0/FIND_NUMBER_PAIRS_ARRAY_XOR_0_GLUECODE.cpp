...
//
//[code snippet 1]
void FIND_NUMBER_PAIRS_ARRAY_XOR_0_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_NUMBER_PAIRS_ARRAY_XOR_0* obj = new FIND_NUMBER_PAIRS_ARRAY_XOR_0();
...
//
//[code snippet 2]
void FIND_NUMBER_PAIRS_ARRAY_XOR_0_F_N_P_A_X_0_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    // Extract the array elements into a C++ array
    int* a = new int[n];
    for (int i = 0; i < n; ++i) {
    ...
    FIND_NUMBER_PAIRS_ARRAY_XOR_0* obj = static_cast<FIND_NUMBER_PAIRS_ARRAY_XOR_0*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_N_P_A_X_0_f_gold(a, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_NUMBER_PAIRS_ARRAY_XOR_0_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_NUMBER_PAIRS_ARRAY_XOR_0").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_NUMBER_PAIRS_ARRAY_XOR_0_F_N_P_A_X_0_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_N_P_A_X_0_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_NUMBER_PAIRS_ARRAY_XOR_0").ToLocalChecked(), constructor);
