...
//
//[code snippet 1]
void PERFECT_REVERSIBLE_STRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PERFECT_REVERSIBLE_STRING* obj = new PERFECT_REVERSIBLE_STRING();
...
//
//[code snippet 2]
void PERFECT_REVERSIBLE_STRING_P_R_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    PERFECT_REVERSIBLE_STRING* obj = static_cast<PERFECT_REVERSIBLE_STRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->P_R_S_f_gold(*str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PERFECT_REVERSIBLE_STRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PERFECT_REVERSIBLE_STRING").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PERFECT_REVERSIBLE_STRING_P_R_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_R_S_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PERFECT_REVERSIBLE_STRING").ToLocalChecked(), constructor);
