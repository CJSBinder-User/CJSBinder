...
//
//[code snippet 1]
void FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM* obj = new FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM();
...
//
//[code snippet 2]
void FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM_F_T_L_S_W_0_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM* obj = static_cast<FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_T_L_S_W_0_S_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM").ToLocalChecked());

    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM_F_T_L_S_W_0_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_T_L_S_W_0_S_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_THE_LARGEST_SUBARRAY_WITH_0_SUM").ToLocalChecked(), constructor);
