...
//
//[code snippet 1]
void ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS* obj = new ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS();
...
//
//[code snippet 2]
void ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS_A_T_N_W_U_A_O_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS* obj = static_cast<ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->A_T_N_W_U_A_O_f_gold(x, y);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "A_T_N_W_U_A_O_f_gold", v8::FunctionTemplate::New(isolate, ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS_A_T_N_W_U_A_O_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "ADD_TWO_NUMBERS_WITHOUT_USING_ARITHMETIC_OPERATORS").ToLocalChecked(), constructor);
