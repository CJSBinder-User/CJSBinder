...
//
//[code snippet 1]
void SUBSET_SUM_DIVISIBLE_M_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUBSET_SUM_DIVISIBLE_M* obj = new SUBSET_SUM_DIVISIBLE_M();
...
//
//[code snippet 2]
void SUBSET_SUM_DIVISIBLE_M_S_S_D_M_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || 
        !args[0]->IsArray() || 
        !args[1]->IsInt32() || 
        !args[2]->IsInt32()) {
    ...
    SUBSET_SUM_DIVISIBLE_M* obj = static_cast<SUBSET_SUM_DIVISIBLE_M*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->S_S_D_M_f_gold(cpp_arr, n, m);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUBSET_SUM_DIVISIBLE_M_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUBSET_SUM_DIVISIBLE_M").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SUBSET_SUM_DIVISIBLE_M_S_S_D_M_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_S_D_M_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUBSET_SUM_DIVISIBLE_M").ToLocalChecked(), constructor);
