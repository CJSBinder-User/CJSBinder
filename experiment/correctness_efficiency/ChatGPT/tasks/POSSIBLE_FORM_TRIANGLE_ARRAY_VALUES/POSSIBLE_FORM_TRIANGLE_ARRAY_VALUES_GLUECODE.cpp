...
//
//[code snippet 1]
void POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES* obj = new POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES();
...
//
//[code snippet 2]
void POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES_P_F_T_A_V_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsArray() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }

    POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES* obj = static_cast<POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->P_F_T_A_V_f_gold(arr, N);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES_P_F_T_A_V_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_F_T_A_V_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "POSSIBLE_FORM_TRIANGLE_ARRAY_VALUES").ToLocalChecked(), constructor);
