...
//
//[code snippet 1]
void COMPUTE_N_UNDER_MODULO_P_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COMPUTE_N_UNDER_MODULO_P* obj = new COMPUTE_N_UNDER_MODULO_P();
...
//
//[code snippet 2]
void COMPUTE_N_UNDER_MODULO_P_C_N_U_M_P_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    COMPUTE_N_UNDER_MODULO_P* obj = static_cast<COMPUTE_N_UNDER_MODULO_P*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->C_N_U_M_P_f_gold(n, p);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COMPUTE_N_UNDER_MODULO_P_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COMPUTE_N_UNDER_MODULO_P").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, COMPUTE_N_UNDER_MODULO_P_C_N_U_M_P_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_N_U_M_P_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COMPUTE_N_UNDER_MODULO_P").ToLocalChecked(), constructor);
