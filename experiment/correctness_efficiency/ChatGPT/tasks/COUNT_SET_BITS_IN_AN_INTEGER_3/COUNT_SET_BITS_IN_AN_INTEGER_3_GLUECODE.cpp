...
//
//[code snippet 1]
void COUNT_SET_BITS_IN_AN_INTEGER_3_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_SET_BITS_IN_AN_INTEGER_3* obj = new COUNT_SET_BITS_IN_AN_INTEGER_3();
...
//
//[code snippet 2]
void COUNT_SET_BITS_IN_AN_INTEGER_3_C_S_B_I_A_I_3_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    COUNT_SET_BITS_IN_AN_INTEGER_3* obj = static_cast<COUNT_SET_BITS_IN_AN_INTEGER_3*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->C_S_B_I_A_I_3_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_SET_BITS_IN_AN_INTEGER_3_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_SET_BITS_IN_AN_INTEGER_3").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "C_S_B_I_A_I_3_f_gold", v8::FunctionTemplate::New(isolate, COUNT_SET_BITS_IN_AN_INTEGER_3_C_S_B_I_A_I_3_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_SET_BITS_IN_AN_INTEGER_3").ToLocalChecked(), constructor);
