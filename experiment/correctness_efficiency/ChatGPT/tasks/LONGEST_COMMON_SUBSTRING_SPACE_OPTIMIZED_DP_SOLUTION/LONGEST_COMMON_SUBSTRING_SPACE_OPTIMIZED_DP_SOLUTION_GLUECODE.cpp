...
//
//[code snippet 1]
void LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION* obj = new LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION();
...
//
//[code snippet 2]
void LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION_L_C_S_S_O_D_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION* obj = static_cast<LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_C_S_S_O_D_S_f_gold(X, Y);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION_L_C_S_S_O_D_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "L_C_S_S_O_D_S_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LONGEST_COMMON_SUBSTRING_SPACE_OPTIMIZED_DP_SOLUTION").ToLocalChecked(), constructor);
