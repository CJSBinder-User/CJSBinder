...
//
//[code snippet 1]
void ADD_1_TO_A_GIVEN_NUMBER_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ADD_1_TO_A_GIVEN_NUMBER_1* obj = new ADD_1_TO_A_GIVEN_NUMBER_1();
...
//
//[code snippet 2]
void ADD_1_TO_A_GIVEN_NUMBER_1_A_1_T_A_G_N_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    ADD_1_TO_A_GIVEN_NUMBER_1* obj = static_cast<ADD_1_TO_A_GIVEN_NUMBER_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int x = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->A_1_T_A_G_N_1_f_gold(x);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, ADD_1_TO_A_GIVEN_NUMBER_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "ADD_1_TO_A_GIVEN_NUMBER_1").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, ADD_1_TO_A_GIVEN_NUMBER_1_A_1_T_A_G_N_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "A_1_T_A_G_N_1_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "ADD_1_TO_A_GIVEN_NUMBER_1").ToLocalChecked(), constructor);
