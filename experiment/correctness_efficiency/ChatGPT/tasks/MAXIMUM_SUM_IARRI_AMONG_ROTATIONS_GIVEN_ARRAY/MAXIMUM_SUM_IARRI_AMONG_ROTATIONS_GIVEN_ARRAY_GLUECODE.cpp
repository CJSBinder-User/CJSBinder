...
//
//[code snippet 1]
void MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY* obj = new MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY();
...
//
//[code snippet 2]
void MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_M_S_I_A_R_G_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY* obj = static_cast<MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_S_I_A_R_G_A_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "M_S_I_A_R_G_A_f_gold", v8::FunctionTemplate::New(isolate, MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY_M_S_I_A_R_G_A_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MAXIMUM_SUM_IARRI_AMONG_ROTATIONS_GIVEN_ARRAY").ToLocalChecked(), constructor);
