...
//
//[code snippet 1]
void REMAINDER_7_LARGE_NUMBERS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    REMAINDER_7_LARGE_NUMBERS* obj = new REMAINDER_7_LARGE_NUMBERS();
...
//
//[code snippet 2]
void REMAINDER_7_LARGE_NUMBERS_R_7_L_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    std::string num(*str); // Convert V8 string to std::string

    REMAINDER_7_LARGE_NUMBERS* obj = static_cast<REMAINDER_7_LARGE_NUMBERS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->R_7_L_N_f_gold(num);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, REMAINDER_7_LARGE_NUMBERS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "REMAINDER_7_LARGE_NUMBERS").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "R_7_L_N_f_gold", v8::FunctionTemplate::New(isolate, REMAINDER_7_LARGE_NUMBERS_R_7_L_N_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "REMAINDER_7_LARGE_NUMBERS").ToLocalChecked(), constructor);
