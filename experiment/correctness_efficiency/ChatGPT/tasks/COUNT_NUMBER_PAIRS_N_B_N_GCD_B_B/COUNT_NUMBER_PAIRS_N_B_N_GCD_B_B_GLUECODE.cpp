...
//
//[code snippet 1]
void COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B* obj = new COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B();
...
//
//[code snippet 2]
void COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B_C_N_P_N_B_N_G_B_B_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B* obj = static_cast<COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->C_N_P_N_B_N_G_B_B_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "C_N_P_N_B_N_G_B_B_f_gold", v8::FunctionTemplate::New(isolate, COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B_C_N_P_N_B_N_G_B_B_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_NUMBER_PAIRS_N_B_N_GCD_B_B").ToLocalChecked(), constructor);
