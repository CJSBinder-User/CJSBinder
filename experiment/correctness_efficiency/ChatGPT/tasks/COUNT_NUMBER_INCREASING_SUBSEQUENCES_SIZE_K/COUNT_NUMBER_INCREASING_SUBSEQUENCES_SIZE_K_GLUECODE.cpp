...
//
//[code snippet 1]
void COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K* obj = new COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K();
...
//
//[code snippet 2]
void COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K_C_N_I_S_S_K_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K* obj = static_cast<COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->C_N_I_S_S_K_f_gold(c_arr, n, k);
    
    delete[] c_arr; // Clean up the dynamically allocated array
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "C_N_I_S_S_K_f_gold", v8::FunctionTemplate::New(isolate, COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K_C_N_I_S_S_K_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_NUMBER_INCREASING_SUBSEQUENCES_SIZE_K").ToLocalChecked(), constructor);
