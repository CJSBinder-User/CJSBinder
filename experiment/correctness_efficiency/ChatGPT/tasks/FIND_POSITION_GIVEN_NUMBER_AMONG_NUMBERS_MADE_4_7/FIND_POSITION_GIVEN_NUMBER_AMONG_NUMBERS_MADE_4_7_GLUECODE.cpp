...
//
//[code snippet 1]
void FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7* obj = new FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7();
...
//
//[code snippet 2]
void FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsString()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7* obj = static_cast<FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    v8::String::Utf8Value str(args.GetIsolate(), args[0]);
    std::string n = std::string(*str);
    
    int result = obj->F_P_G_N_A_N_M_4_7_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "F_P_G_N_A_N_M_4_7_f_gold", v8::FunctionTemplate::New(isolate, FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_POSITION_GIVEN_NUMBER_AMONG_NUMBERS_MADE_4_7").ToLocalChecked(), constructor);
