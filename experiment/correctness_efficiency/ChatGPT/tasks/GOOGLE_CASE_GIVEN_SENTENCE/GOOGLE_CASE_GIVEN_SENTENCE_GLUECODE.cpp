...
//
//[code snippet 1]
void GOOGLE_CASE_GIVEN_SENTENCE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    GOOGLE_CASE_GIVEN_SENTENCE* obj = new GOOGLE_CASE_GIVEN_SENTENCE();
...
//
//[code snippet 2]
void GOOGLE_CASE_GIVEN_SENTENCE_G_C_G_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    GOOGLE_CASE_GIVEN_SENTENCE* obj = static_cast<GOOGLE_CASE_GIVEN_SENTENCE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    std::string result = obj->G_C_G_S_f_gold(s);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, GOOGLE_CASE_GIVEN_SENTENCE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "GOOGLE_CASE_GIVEN_SENTENCE").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, GOOGLE_CASE_GIVEN_SENTENCE_G_C_G_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "G_C_G_S_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "GOOGLE_CASE_GIVEN_SENTENCE").ToLocalChecked(), constructor);
