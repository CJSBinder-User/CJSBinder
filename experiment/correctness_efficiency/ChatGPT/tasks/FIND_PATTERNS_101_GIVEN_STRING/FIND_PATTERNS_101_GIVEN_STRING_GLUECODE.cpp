...
//
//[code snippet 1]
void FIND_PATTERNS_101_GIVEN_STRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_PATTERNS_101_GIVEN_STRING* obj = new FIND_PATTERNS_101_GIVEN_STRING();
...
//
//[code snippet 2]
void FIND_PATTERNS_101_GIVEN_STRING_F_P_1_G_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_PATTERNS_101_GIVEN_STRING* obj = static_cast<FIND_PATTERNS_101_GIVEN_STRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    int result = obj->F_P_1_G_S_f_gold(*str);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_PATTERNS_101_GIVEN_STRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_PATTERNS_101_GIVEN_STRING").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "F_P_1_G_S_f_gold", v8::FunctionTemplate::New(isolate, FIND_PATTERNS_101_GIVEN_STRING_F_P_1_G_S_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_PATTERNS_101_GIVEN_STRING").ToLocalChecked(), constructor);
