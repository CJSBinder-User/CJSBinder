...
//
//[code snippet 1]
void LONGEST_CONSECUTIVE_SUBSEQUENCE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LONGEST_CONSECUTIVE_SUBSEQUENCE* obj = new LONGEST_CONSECUTIVE_SUBSEQUENCE();
...
//
//[code snippet 2]
void LONGEST_CONSECUTIVE_SUBSEQUENCE_L_C_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LONGEST_CONSECUTIVE_SUBSEQUENCE* obj = static_cast<LONGEST_CONSECUTIVE_SUBSEQUENCE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_C_S_f_gold(cpp_arr, n);
    
    delete[] cpp_arr; // Clean up the allocated memory
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LONGEST_CONSECUTIVE_SUBSEQUENCE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LONGEST_CONSECUTIVE_SUBSEQUENCE").ToLocalChecked());
    
    // Register public method
    tpl->PrototypeTemplate()->Set(isolate, "L_C_S_f_gold", v8::FunctionTemplate::New(isolate, LONGEST_CONSECUTIVE_SUBSEQUENCE_L_C_S_f_gold));
    
    // Create the constructor
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LONGEST_CONSECUTIVE_SUBSEQUENCE").ToLocalChecked(), constructor);
