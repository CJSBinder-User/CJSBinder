...
//
//[code snippet 1]
void PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES* obj = new PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES();
...
//
//[code snippet 2]
void PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_P_T_S_5_L_L_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES* obj = static_cast<PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int p = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    bool result = obj->P_T_S_5_L_L_S_f_gold(p);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "P_T_S_5_L_L_S_f_gold", v8::FunctionTemplate::New(isolate, PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_P_T_S_5_L_L_S_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES").ToLocalChecked(), constructor);
