...
//
//[code snippet 1]
void NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1* obj = new NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1();
...
//
//[code snippet 2]
void NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1_N_D_P_T_N_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1* obj = static_cast<NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->N_D_P_T_N_1_f_gold(a, b);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "N_D_P_T_N_1_f_gold", v8::FunctionTemplate::New(isolate, NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1_N_D_P_T_N_1_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_DIGITS_PRODUCT_TWO_NUMBERS_1").ToLocalChecked(), constructor);
