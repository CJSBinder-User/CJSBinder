...
//
//[code snippet 1]
void MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1* obj = new MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1();
...
//
//[code snippet 2]
void MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1_M_S_P_S_D_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1* obj = static_cast<MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_S_P_S_D_1_f_gold(arr, N, k);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "M_S_P_S_D_1_f_gold", v8::FunctionTemplate::New(isolate, MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1_M_S_P_S_D_1_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MAXIMUM_SUM_PAIRS_SPECIFIC_DIFFERENCE_1").ToLocalChecked(), constructor);
