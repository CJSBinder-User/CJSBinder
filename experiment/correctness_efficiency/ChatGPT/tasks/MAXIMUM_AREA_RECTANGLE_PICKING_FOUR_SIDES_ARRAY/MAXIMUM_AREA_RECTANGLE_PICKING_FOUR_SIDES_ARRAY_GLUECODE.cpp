...
//
//[code snippet 1]
void MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY* obj = new MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY();
...
//
//[code snippet 2]
void MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_M_A_R_P_F_S_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY* obj = static_cast<MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_A_R_P_F_S_A_f_gold(c_arr, n);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_M_A_R_P_F_S_A_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "M_A_R_P_F_S_A_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY").ToLocalChecked(), constructor);
