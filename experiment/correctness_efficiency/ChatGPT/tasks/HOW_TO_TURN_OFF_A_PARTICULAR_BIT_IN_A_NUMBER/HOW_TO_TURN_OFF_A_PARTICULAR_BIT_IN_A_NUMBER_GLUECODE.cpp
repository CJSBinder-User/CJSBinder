...
//
//[code snippet 1]
void HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER* obj = new HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER();
...
//
//[code snippet 2]
void HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER_H_T_T_O_A_P_B_I_A_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER* obj = static_cast<HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->H_T_T_O_A_P_B_I_A_N_f_gold(n, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER_H_T_T_O_A_P_B_I_A_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "H_T_T_O_A_P_B_I_A_N_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "HOW_TO_TURN_OFF_A_PARTICULAR_BIT_IN_A_NUMBER").ToLocalChecked(), constructor);
