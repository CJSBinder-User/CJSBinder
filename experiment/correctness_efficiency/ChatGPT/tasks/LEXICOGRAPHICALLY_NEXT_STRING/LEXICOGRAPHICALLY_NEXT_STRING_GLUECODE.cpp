...
//
//[code snippet 1]
void LEXICOGRAPHICALLY_NEXT_STRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LEXICOGRAPHICALLY_NEXT_STRING* obj = new LEXICOGRAPHICALLY_NEXT_STRING();
...
//
//[code snippet 2]
void LEXICOGRAPHICALLY_NEXT_STRING_L_N_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LEXICOGRAPHICALLY_NEXT_STRING* obj = static_cast<LEXICOGRAPHICALLY_NEXT_STRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    std::string result = obj->L_N_S_f_gold(s);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LEXICOGRAPHICALLY_NEXT_STRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LEXICOGRAPHICALLY_NEXT_STRING").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "L_N_S_f_gold", v8::FunctionTemplate::New(isolate, LEXICOGRAPHICALLY_NEXT_STRING_L_N_S_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LEXICOGRAPHICALLY_NEXT_STRING").ToLocalChecked(), constructor);
