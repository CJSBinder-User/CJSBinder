...
//
//[code snippet 1]
void COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N* obj = new COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N();
...
//
//[code snippet 2]
void COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N_C_S_O_D_I_N_F_1_T_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N* obj = static_cast<COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->C_S_O_D_I_N_F_1_T_N_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "C_S_O_D_I_N_F_1_T_N_f_gold", v8::FunctionTemplate::New(isolate, COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N_C_S_O_D_I_N_F_1_T_N_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_SUM_OF_DIGITS_IN_NUMBERS_FROM_1_TO_N").ToLocalChecked(), constructor);
