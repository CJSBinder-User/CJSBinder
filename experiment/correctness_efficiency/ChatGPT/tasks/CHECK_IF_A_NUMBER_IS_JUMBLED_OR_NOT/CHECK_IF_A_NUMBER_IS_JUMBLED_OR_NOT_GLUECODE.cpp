...
//
//[code snippet 1]
void CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT* obj = new CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT();
...
//
//[code snippet 2]
void CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT_C_I_A_N_I_J_O_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT* obj = static_cast<CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int num = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    bool result = obj->C_I_A_N_I_J_O_N_f_gold(num);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT_C_I_A_N_I_J_O_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_I_A_N_I_J_O_N_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_IF_A_NUMBER_IS_JUMBLED_OR_NOT").ToLocalChecked(), constructor);
