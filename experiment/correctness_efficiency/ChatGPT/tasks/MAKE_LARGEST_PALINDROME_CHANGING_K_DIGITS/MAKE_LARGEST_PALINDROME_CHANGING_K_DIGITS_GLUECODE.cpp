...
//
//[code snippet 1]
void MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS* obj = new MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS();
...
//
//[code snippet 2]
void MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS* obj = 
        static_cast<MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    std::string result = obj->M_L_P_C_K_D_f_gold(*str, k);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "M_L_P_C_K_D_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS").ToLocalChecked(), constructor);
