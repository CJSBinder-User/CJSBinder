...
//
//[code snippet 1]
void SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY* obj = new SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY();
...
//
//[code snippet 2]
void SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY_S_I_A_D_I_A_U_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY* obj = static_cast<SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->S_I_A_D_I_A_U_A_f_gold(c_arr, n, key);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY_S_I_A_D_I_A_U_A_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_I_A_D_I_A_U_A_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SEARCH_INSERT_AND_DELETE_IN_AN_UNSORTED_ARRAY").ToLocalChecked(), constructor);
