...
//
//[code snippet 1]
void QUICK_WAY_CHECK_CHARACTERS_STRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    QUICK_WAY_CHECK_CHARACTERS_STRING* obj = new QUICK_WAY_CHECK_CHARACTERS_STRING();
...
//
//[code snippet 2]
void QUICK_WAY_CHECK_CHARACTERS_STRING_Q_W_C_C_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsString()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    v8::String::Utf8Value utf8_string(args.GetIsolate(), args[0]);
    string s(*utf8_string); // Convert V8 string to std::string
    QUICK_WAY_CHECK_CHARACTERS_STRING* obj = static_cast<QUICK_WAY_CHECK_CHARACTERS_STRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->Q_W_C_C_S_f_gold(s);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, QUICK_WAY_CHECK_CHARACTERS_STRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "QUICK_WAY_CHECK_CHARACTERS_STRING").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, QUICK_WAY_CHECK_CHARACTERS_STRING_Q_W_C_C_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "Q_W_C_C_S_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "QUICK_WAY_CHECK_CHARACTERS_STRING").ToLocalChecked(), constructor);
