...
//
//[code snippet 1]
void LONGEST_PREFIX_ALSO_SUFFIX_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LONGEST_PREFIX_ALSO_SUFFIX_1* obj = new LONGEST_PREFIX_ALSO_SUFFIX_1();
...
//
//[code snippet 2]
void LONGEST_PREFIX_ALSO_SUFFIX_1_L_P_A_S_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LONGEST_PREFIX_ALSO_SUFFIX_1* obj = static_cast<LONGEST_PREFIX_ALSO_SUFFIX_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_P_A_S_1_f_gold(s);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LONGEST_PREFIX_ALSO_SUFFIX_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LONGEST_PREFIX_ALSO_SUFFIX_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "L_P_A_S_1_f_gold", v8::FunctionTemplate::New(isolate, LONGEST_PREFIX_ALSO_SUFFIX_1_L_P_A_S_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LONGEST_PREFIX_ALSO_SUFFIX_1").ToLocalChecked(), constructor);
