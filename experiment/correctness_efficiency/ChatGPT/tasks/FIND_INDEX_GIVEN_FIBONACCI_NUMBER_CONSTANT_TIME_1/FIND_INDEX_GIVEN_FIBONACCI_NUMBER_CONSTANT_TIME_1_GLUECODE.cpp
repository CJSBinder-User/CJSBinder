...
//
//[code snippet 1]
void FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1* obj = new FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1();
...
//
//[code snippet 2]
void FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1_F_I_G_F_N_C_T_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1* obj = static_cast<FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->F_I_G_F_N_C_T_1_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "F_I_G_F_N_C_T_1_f_gold", v8::FunctionTemplate::New(isolate, FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1_F_I_G_F_N_C_T_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_INDEX_GIVEN_FIBONACCI_NUMBER_CONSTANT_TIME_1").ToLocalChecked(), constructor);
