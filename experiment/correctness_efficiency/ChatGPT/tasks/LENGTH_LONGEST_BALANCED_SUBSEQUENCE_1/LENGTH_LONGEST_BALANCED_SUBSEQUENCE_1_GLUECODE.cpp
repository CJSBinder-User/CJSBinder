...
//
//[code snippet 1]
void LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1* obj = new LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1();
...
//
//[code snippet 2]
void LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1_L_L_B_S_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1* obj = static_cast<LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_L_B_S_1_f_gold(s, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1").ToLocalChecked());
    
    // Register the method
    tpl->PrototypeTemplate()->Set(isolate, "L_L_B_S_1_f_gold", v8::FunctionTemplate::New(isolate, LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1_L_L_B_S_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LENGTH_LONGEST_BALANCED_SUBSEQUENCE_1").ToLocalChecked(), constructor);
