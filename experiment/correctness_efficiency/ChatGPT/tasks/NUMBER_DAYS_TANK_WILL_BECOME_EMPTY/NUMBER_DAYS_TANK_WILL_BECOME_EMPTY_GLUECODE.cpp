...
//
//[code snippet 1]
void NUMBER_DAYS_TANK_WILL_BECOME_EMPTY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_DAYS_TANK_WILL_BECOME_EMPTY* obj = new NUMBER_DAYS_TANK_WILL_BECOME_EMPTY();
...
//
//[code snippet 2]
void NUMBER_DAYS_TANK_WILL_BECOME_EMPTY_N_D_T_W_B_E_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    NUMBER_DAYS_TANK_WILL_BECOME_EMPTY* obj = static_cast<NUMBER_DAYS_TANK_WILL_BECOME_EMPTY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int C = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int l = args[1]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->N_D_T_W_B_E_f_gold(C, l);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_DAYS_TANK_WILL_BECOME_EMPTY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_DAYS_TANK_WILL_BECOME_EMPTY").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "N_D_T_W_B_E_f_gold", v8::FunctionTemplate::New(isolate, NUMBER_DAYS_TANK_WILL_BECOME_EMPTY_N_D_T_W_B_E_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_DAYS_TANK_WILL_BECOME_EMPTY").ToLocalChecked(), constructor);
