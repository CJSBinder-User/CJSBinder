...
//
//[code snippet 1]
void FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT* obj = new FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT();
...
//
//[code snippet 2]
void FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT_F_W_G_I_P_3_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT* obj = static_cast<FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    bool result = obj->F_W_G_I_P_3_N_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT_F_W_G_I_P_3_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_W_G_I_P_3_N_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_WHETHER_GIVEN_INTEGER_POWER_3_NOT").ToLocalChecked(), constructor);
