...
//
//[code snippet 1]
void MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS* obj = new MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS();
...
//
//[code snippet 2]
void MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS_M_C_M_A_S_1_R_L_P_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS* obj = static_cast<MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_C_M_A_S_1_R_L_P_f_gold(a, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS").ToLocalChecked());

    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS_M_C_M_A_S_1_R_L_P_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "M_C_M_A_S_1_R_L_P_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MINIMUM_COST_MAKE_ARRAY_SIZE_1_REMOVING_LARGER_PAIRS").ToLocalChecked(), constructor);
