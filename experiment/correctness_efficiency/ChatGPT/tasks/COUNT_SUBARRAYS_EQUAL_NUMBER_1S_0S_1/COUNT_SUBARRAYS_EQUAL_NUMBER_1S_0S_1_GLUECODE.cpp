...
//
//[code snippet 1]
void COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1* obj = new COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1();
...
//
//[code snippet 2]
void COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1_C_S_E_N_1_0_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsArray() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }

    COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1* obj = static_cast<COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->C_S_E_N_1_0_1_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1_C_S_E_N_1_0_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_S_E_N_1_0_1_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_SUBARRAYS_EQUAL_NUMBER_1S_0S_1").ToLocalChecked(), constructor);
