...
//
//[code snippet 1]
void LENGTH_LONGEST_BALANCED_SUBSEQUENCE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LENGTH_LONGEST_BALANCED_SUBSEQUENCE* obj = new LENGTH_LONGEST_BALANCED_SUBSEQUENCE();
...
//
//[code snippet 2]
void LENGTH_LONGEST_BALANCED_SUBSEQUENCE_L_L_B_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LENGTH_LONGEST_BALANCED_SUBSEQUENCE* obj = static_cast<LENGTH_LONGEST_BALANCED_SUBSEQUENCE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_L_B_S_f_gold(s, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LENGTH_LONGEST_BALANCED_SUBSEQUENCE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LENGTH_LONGEST_BALANCED_SUBSEQUENCE").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, LENGTH_LONGEST_BALANCED_SUBSEQUENCE_L_L_B_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "L_L_B_S_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LENGTH_LONGEST_BALANCED_SUBSEQUENCE").ToLocalChecked(), constructor);
