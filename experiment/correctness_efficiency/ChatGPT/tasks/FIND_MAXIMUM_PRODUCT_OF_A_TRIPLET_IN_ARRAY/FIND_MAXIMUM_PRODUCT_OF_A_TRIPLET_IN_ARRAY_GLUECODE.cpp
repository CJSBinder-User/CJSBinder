...
//
//[code snippet 1]
void FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY* obj = new FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY();
...
//
//[code snippet 2]
void FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_F_M_P_O_A_T_I_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY* obj = static_cast<FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_M_P_O_A_T_I_A_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "F_M_P_O_A_T_I_A_f_gold", v8::FunctionTemplate::New(isolate, FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_F_M_P_O_A_T_I_A_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY").ToLocalChecked(), constructor);
