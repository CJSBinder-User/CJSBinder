...
//
//[code snippet 1]
void DIVISIBILITY_9_USING_BITWISE_OPERATORS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    DIVISIBILITY_9_USING_BITWISE_OPERATORS* obj = new DIVISIBILITY_9_USING_BITWISE_OPERATORS();
...
//
//[code snippet 2]
void DIVISIBILITY_9_USING_BITWISE_OPERATORS_D_9_U_B_O_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    DIVISIBILITY_9_USING_BITWISE_OPERATORS* obj = static_cast<DIVISIBILITY_9_USING_BITWISE_OPERATORS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    bool result = obj->D_9_U_B_O_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, DIVISIBILITY_9_USING_BITWISE_OPERATORS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "DIVISIBILITY_9_USING_BITWISE_OPERATORS").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "D_9_U_B_O_f_gold", v8::FunctionTemplate::New(isolate, DIVISIBILITY_9_USING_BITWISE_OPERATORS_D_9_U_B_O_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "DIVISIBILITY_9_USING_BITWISE_OPERATORS").ToLocalChecked(), constructor);
