...
//
//[code snippet 1]
void COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3* obj = new COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3();
...
//
//[code snippet 2]
void COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3_C_P_G_S_2_3_S_M_3_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        c_arr[i] = value->IsInt32() ? value->Int32Value(args.GetIsolate()->GetCurrentContext()).ToChecked() : 0;
    }

    COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3* obj = 
        static_cast<COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->C_P_G_S_2_3_S_M_3_f_gold(c_arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "C_P_G_S_2_3_S_M_3_f_gold", v8::FunctionTemplate::New(isolate, COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3_C_P_G_S_2_3_S_M_3_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_POSSIBLE_GROUPS_SIZE_2_3_SUM_MULTIPLE_3").ToLocalChecked(), constructor);
