...
//
//[code snippet 1]
void PANGRAM_CHECKING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PANGRAM_CHECKING* obj = new PANGRAM_CHECKING();
...
//
//[code snippet 2]
void PANGRAM_CHECKING_P_C_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    PANGRAM_CHECKING* obj = static_cast<PANGRAM_CHECKING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->P_C_f_gold(native_str);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PANGRAM_CHECKING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PANGRAM_CHECKING").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "P_C_f_gold", v8::FunctionTemplate::New(isolate, PANGRAM_CHECKING_P_C_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PANGRAM_CHECKING").ToLocalChecked(), constructor);
