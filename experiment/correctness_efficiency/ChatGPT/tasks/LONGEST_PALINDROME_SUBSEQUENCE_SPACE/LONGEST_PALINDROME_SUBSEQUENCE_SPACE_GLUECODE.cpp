...
//
//[code snippet 1]
void LONGEST_PALINDROME_SUBSEQUENCE_SPACE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LONGEST_PALINDROME_SUBSEQUENCE_SPACE* obj = new LONGEST_PALINDROME_SUBSEQUENCE_SPACE();
...
//
//[code snippet 2]
void LONGEST_PALINDROME_SUBSEQUENCE_SPACE_L_P_S_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LONGEST_PALINDROME_SUBSEQUENCE_SPACE* obj = static_cast<LONGEST_PALINDROME_SUBSEQUENCE_SPACE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_P_S_S_f_gold(s);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LONGEST_PALINDROME_SUBSEQUENCE_SPACE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LONGEST_PALINDROME_SUBSEQUENCE_SPACE").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, LONGEST_PALINDROME_SUBSEQUENCE_SPACE_L_P_S_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "L_P_S_S_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LONGEST_PALINDROME_SUBSEQUENCE_SPACE").ToLocalChecked(), constructor);
