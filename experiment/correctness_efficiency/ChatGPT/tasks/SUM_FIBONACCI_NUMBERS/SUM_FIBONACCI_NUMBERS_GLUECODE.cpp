...
//
//[code snippet 1]
void SUM_FIBONACCI_NUMBERS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUM_FIBONACCI_NUMBERS* obj = new SUM_FIBONACCI_NUMBERS();
...
//
//[code snippet 2]
void SUM_FIBONACCI_NUMBERS_S_F_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SUM_FIBONACCI_NUMBERS* obj = static_cast<SUM_FIBONACCI_NUMBERS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUM_FIBONACCI_NUMBERS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUM_FIBONACCI_NUMBERS").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "S_F_N_f_gold", v8::FunctionTemplate::New(isolate, SUM_FIBONACCI_NUMBERS_S_F_N_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUM_FIBONACCI_NUMBERS").ToLocalChecked(), constructor);
