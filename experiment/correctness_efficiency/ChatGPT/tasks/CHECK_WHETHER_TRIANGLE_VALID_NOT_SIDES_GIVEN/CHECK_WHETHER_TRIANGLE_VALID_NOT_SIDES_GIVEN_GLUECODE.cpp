...
//
//[code snippet 1]
void CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN* obj = new CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN();
...
//
//[code snippet 2]
void CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN_C_W_T_V_N_S_G_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || !args[0]->IsInt32() || !args[1]->IsInt32() || !args[2]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN* obj = static_cast<CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->C_W_T_V_N_S_G_f_gold(a, b, c);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "C_W_T_V_N_S_G_f_gold", v8::FunctionTemplate::New(isolate, CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN_C_W_T_V_N_S_G_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_WHETHER_TRIANGLE_VALID_NOT_SIDES_GIVEN").ToLocalChecked(), constructor);
