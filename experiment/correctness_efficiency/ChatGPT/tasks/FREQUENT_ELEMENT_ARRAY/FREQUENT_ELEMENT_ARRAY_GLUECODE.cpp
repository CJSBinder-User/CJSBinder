...
//
//[code snippet 1]
void FREQUENT_ELEMENT_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FREQUENT_ELEMENT_ARRAY* obj = new FREQUENT_ELEMENT_ARRAY();
...
//
//[code snippet 2]
void FREQUENT_ELEMENT_ARRAY_F_E_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FREQUENT_ELEMENT_ARRAY* obj = static_cast<FREQUENT_ELEMENT_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_E_A_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FREQUENT_ELEMENT_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FREQUENT_ELEMENT_ARRAY").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "F_E_A_f_gold", v8::FunctionTemplate::New(isolate, FREQUENT_ELEMENT_ARRAY_F_E_A_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FREQUENT_ELEMENT_ARRAY").ToLocalChecked(), constructor);
