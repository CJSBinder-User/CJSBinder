...
//
//[code snippet 1]
void PROGRAM_FIND_STRING_START_END_GEEKS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PROGRAM_FIND_STRING_START_END_GEEKS* obj = new PROGRAM_FIND_STRING_START_END_GEEKS();
...
//
//[code snippet 2]
void PROGRAM_FIND_STRING_START_END_GEEKS_P_F_S_S_E_G_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    PROGRAM_FIND_STRING_START_END_GEEKS* obj = static_cast<PROGRAM_FIND_STRING_START_END_GEEKS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    bool result = obj->P_F_S_S_E_G_f_gold(*str1, *str2);
    
    // Converting bool to JavaScript value
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PROGRAM_FIND_STRING_START_END_GEEKS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PROGRAM_FIND_STRING_START_END_GEEKS").ToLocalChecked());

    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PROGRAM_FIND_STRING_START_END_GEEKS_P_F_S_S_E_G_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_F_S_S_E_G_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PROGRAM_FIND_STRING_START_END_GEEKS").ToLocalChecked(), constructor);
