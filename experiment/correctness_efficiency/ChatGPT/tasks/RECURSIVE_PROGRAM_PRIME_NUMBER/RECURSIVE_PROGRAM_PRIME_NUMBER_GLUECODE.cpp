...
//
//[code snippet 1]
void RECURSIVE_PROGRAM_PRIME_NUMBER_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    RECURSIVE_PROGRAM_PRIME_NUMBER* obj = new RECURSIVE_PROGRAM_PRIME_NUMBER();
...
//
//[code snippet 2]
void RECURSIVE_PROGRAM_PRIME_NUMBER_R_P_P_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    RECURSIVE_PROGRAM_PRIME_NUMBER* obj = static_cast<RECURSIVE_PROGRAM_PRIME_NUMBER*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->R_P_P_N_f_gold(n, i);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, RECURSIVE_PROGRAM_PRIME_NUMBER_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "RECURSIVE_PROGRAM_PRIME_NUMBER").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "R_P_P_N_f_gold", v8::FunctionTemplate::New(isolate, RECURSIVE_PROGRAM_PRIME_NUMBER_R_P_P_N_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "RECURSIVE_PROGRAM_PRIME_NUMBER").ToLocalChecked(), constructor);
