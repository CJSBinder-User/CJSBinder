...
//
//[code snippet 1]
void PROGRAM_CIRCUMFERENCE_PARALLELOGRAM_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PROGRAM_CIRCUMFERENCE_PARALLELOGRAM* obj = new PROGRAM_CIRCUMFERENCE_PARALLELOGRAM();
...
//
//[code snippet 2]
void PROGRAM_CIRCUMFERENCE_PARALLELOGRAM_P_C_P_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsNumber() || !args[1]->IsNumber()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    PROGRAM_CIRCUMFERENCE_PARALLELOGRAM* obj = static_cast<PROGRAM_CIRCUMFERENCE_PARALLELOGRAM*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    double result = obj->P_C_P_f_gold(a, b);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PROGRAM_CIRCUMFERENCE_PARALLELOGRAM_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PROGRAM_CIRCUMFERENCE_PARALLELOGRAM").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "P_C_P_f_gold", v8::FunctionTemplate::New(isolate, PROGRAM_CIRCUMFERENCE_PARALLELOGRAM_P_C_P_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PROGRAM_CIRCUMFERENCE_PARALLELOGRAM").ToLocalChecked(), constructor);
