...
//
//[code snippet 1]
void MAXIMIZE_SUM_ARRII_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAXIMIZE_SUM_ARRII* obj = new MAXIMIZE_SUM_ARRII();
...
//
//[code snippet 2]
void MAXIMIZE_SUM_ARRII_M_S_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsArray() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    
    MAXIMIZE_SUM_ARRII* obj = static_cast<MAXIMIZE_SUM_ARRII*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->M_S_A_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAXIMIZE_SUM_ARRII_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAXIMIZE_SUM_ARRII").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "M_S_A_f_gold", v8::FunctionTemplate::New(isolate, MAXIMIZE_SUM_ARRII_M_S_A_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MAXIMIZE_SUM_ARRII").ToLocalChecked(), constructor);
