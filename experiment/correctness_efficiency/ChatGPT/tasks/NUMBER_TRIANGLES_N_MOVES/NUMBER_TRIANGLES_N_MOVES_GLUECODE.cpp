...
//
//[code snippet 1]
void NUMBER_TRIANGLES_N_MOVES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_TRIANGLES_N_MOVES* obj = new NUMBER_TRIANGLES_N_MOVES();
...
//
//[code snippet 2]
void NUMBER_TRIANGLES_N_MOVES_N_T_N_M_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    NUMBER_TRIANGLES_N_MOVES* obj = static_cast<NUMBER_TRIANGLES_N_MOVES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->N_T_N_M_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_TRIANGLES_N_MOVES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_TRIANGLES_N_MOVES").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, NUMBER_TRIANGLES_N_MOVES_N_T_N_M_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "N_T_N_M_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_TRIANGLES_N_MOVES").ToLocalChecked(), constructor);
