...
//
//[code snippet 1]
void PAPER_CUT_MINIMUM_NUMBER_SQUARES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PAPER_CUT_MINIMUM_NUMBER_SQUARES* obj = new PAPER_CUT_MINIMUM_NUMBER_SQUARES();
...
//
//[code snippet 2]
void PAPER_CUT_MINIMUM_NUMBER_SQUARES_P_C_M_N_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    PAPER_CUT_MINIMUM_NUMBER_SQUARES* obj = static_cast<PAPER_CUT_MINIMUM_NUMBER_SQUARES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->P_C_M_N_S_f_gold(a, b);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PAPER_CUT_MINIMUM_NUMBER_SQUARES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PAPER_CUT_MINIMUM_NUMBER_SQUARES").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, PAPER_CUT_MINIMUM_NUMBER_SQUARES_P_C_M_N_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "P_C_M_N_S_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PAPER_CUT_MINIMUM_NUMBER_SQUARES").ToLocalChecked(), constructor);
