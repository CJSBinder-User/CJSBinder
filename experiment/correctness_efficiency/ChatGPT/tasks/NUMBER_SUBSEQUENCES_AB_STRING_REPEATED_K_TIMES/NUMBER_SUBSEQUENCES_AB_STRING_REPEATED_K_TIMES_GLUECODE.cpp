...
//
//[code snippet 1]
void NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES* obj = new NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES();
...
//
//[code snippet 2]
void NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES_N_S_A_S_R_K_T_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES* obj = static_cast<NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    int result = obj->N_S_A_S_R_K_T_f_gold(*str, K);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES_N_S_A_S_R_K_T_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "N_S_A_S_R_K_T_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_SUBSEQUENCES_AB_STRING_REPEATED_K_TIMES").ToLocalChecked(), constructor);
