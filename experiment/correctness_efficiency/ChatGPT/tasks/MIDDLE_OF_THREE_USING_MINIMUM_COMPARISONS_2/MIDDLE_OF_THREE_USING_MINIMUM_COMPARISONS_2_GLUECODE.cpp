...
//
//[code snippet 1]
void MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2* obj = new MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2();
...
//
//[code snippet 2]
void MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2_M_O_T_U_M_C_2_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || !args[0]->IsInt32() || !args[1]->IsInt32() || !args[2]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2* obj = static_cast<MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->M_O_T_U_M_C_2_f_gold(a, b, c);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "M_O_T_U_M_C_2_f_gold", v8::FunctionTemplate::New(isolate, MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2_M_O_T_U_M_C_2_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MIDDLE_OF_THREE_USING_MINIMUM_COMPARISONS_2").ToLocalChecked(), constructor);
