...
//
//[code snippet 1]
void FINDING_POWER_PRIME_NUMBER_P_N_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FINDING_POWER_PRIME_NUMBER_P_N_1* obj = new FINDING_POWER_PRIME_NUMBER_P_N_1();
...
//
//[code snippet 2]
void FINDING_POWER_PRIME_NUMBER_P_N_1_F_P_P_N_P_N_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    FINDING_POWER_PRIME_NUMBER_P_N_1* obj = static_cast<FINDING_POWER_PRIME_NUMBER_P_N_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->F_P_P_N_P_N_1_f_gold(n, p);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FINDING_POWER_PRIME_NUMBER_P_N_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FINDING_POWER_PRIME_NUMBER_P_N_1").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FINDING_POWER_PRIME_NUMBER_P_N_1_F_P_P_N_P_N_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_P_P_N_P_N_1_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FINDING_POWER_PRIME_NUMBER_P_N_1").ToLocalChecked(), constructor);
