...
//
//[code snippet 1]
void FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2* obj = new FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2();
...
//
//[code snippet 2]
void FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2* obj = static_cast<FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_T_E_T_A_O_2_f_gold(a, n);
    delete[] a;
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2").ToLocalChecked());

    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_T_E_T_A_O_2_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_THE_ELEMENT_THAT_APPEARS_ONCE_2").ToLocalChecked(), constructor);
