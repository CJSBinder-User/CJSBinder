...
//
//[code snippet 1]
void ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS* obj = new ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS();
...
//
//[code snippet 2]
void ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS_A_O_A_S_2_A_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS* obj = static_cast<ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->A_O_A_S_2_A_A_f_gold(arr, n, x);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS").ToLocalChecked());
    
    // Registering the method
    tpl->PrototypeTemplate()->Set(isolate, "A_O_A_S_2_A_A_f_gold", v8::FunctionTemplate::New(isolate, ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS_A_O_A_S_2_A_A_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "ANALYSIS_OF_ALGORITHMS_SET_2_ASYMPTOTIC_ANALYSIS").ToLocalChecked(), constructor);
