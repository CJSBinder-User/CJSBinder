...
//
//[code snippet 1]
void SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS* obj = new SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS();
...
//
//[code snippet 2]
void SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS_S_F_A_P_A_N_I_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS* obj = static_cast<SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->S_F_A_P_A_N_I_f_gold(arr, n);
    delete[] arr; // Clean up memory
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "S_F_A_P_A_N_I_f_gold", v8::FunctionTemplate::New(isolate, SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS_S_F_A_P_A_N_I_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUM_FAI_AJ_PAIRS_ARRAY_N_INTEGERS").ToLocalChecked(), constructor);
