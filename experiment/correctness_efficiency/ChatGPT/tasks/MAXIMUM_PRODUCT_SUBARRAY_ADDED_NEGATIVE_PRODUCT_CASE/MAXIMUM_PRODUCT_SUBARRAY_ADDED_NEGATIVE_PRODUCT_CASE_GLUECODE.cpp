...
//
//[code snippet 1]
void MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE* obj = new MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE();
...
//
//[code snippet 2]
void MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE_M_P_S_A_N_P_C_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE* obj = 
        static_cast<MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    int result = obj->M_P_S_A_N_P_C_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE").ToLocalChecked());
    // Registering the method
    tpl->PrototypeTemplate()->Set(isolate, "M_P_S_A_N_P_C_f_gold", 
                                  v8::FunctionTemplate::New(isolate, MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE_M_P_S_A_N_P_C_f_gold));
                                  
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, 
                           v8::String::NewFromUtf8(isolate, "MAXIMUM_PRODUCT_SUBARRAY_ADDED_NEGATIVE_PRODUCT_CASE").ToLocalChecked(), 
                           constructor);
