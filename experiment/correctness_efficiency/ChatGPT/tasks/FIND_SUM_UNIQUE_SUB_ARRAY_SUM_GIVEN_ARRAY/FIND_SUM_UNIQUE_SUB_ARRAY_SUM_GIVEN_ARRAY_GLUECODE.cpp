...
//
//[code snippet 1]
void FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY* obj = new FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY();
...
//
//[code snippet 2]
void FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY_F_S_U_S_A_S_G_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY* obj = static_cast<FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    long long result = obj->F_S_U_S_A_S_G_A_f_gold(arr, n);
...
// Assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "F_S_U_S_A_S_G_A_f_gold", v8::FunctionTemplate::New(isolate, FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY_F_S_U_S_A_S_G_A_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_SUM_UNIQUE_SUB_ARRAY_SUM_GIVEN_ARRAY").ToLocalChecked(), constructor);
