...
//
//[code snippet 1]
void MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY* obj = new MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY();
...
//
//[code snippet 2]
void MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY_M_C_C_W_N_R_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY* obj = static_cast<MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_C_C_W_N_R_A_f_gold(a, n);
    delete[] a; // Clean up
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "M_C_C_W_N_R_A_f_gold", v8::FunctionTemplate::New(isolate, MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY_M_C_C_W_N_R_A_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MINIMUM_COST_CONNECT_WEIGHTED_NODES_REPRESENTED_ARRAY").ToLocalChecked(), constructor);
