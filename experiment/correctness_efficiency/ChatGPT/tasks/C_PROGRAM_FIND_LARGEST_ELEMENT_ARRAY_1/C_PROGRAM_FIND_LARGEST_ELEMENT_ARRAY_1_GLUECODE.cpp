...
//
//[code snippet 1]
void C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1* obj = new C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1();
...
//
//[code snippet 2]
void C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1_C_P_F_L_E_A_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1* obj = static_cast<C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->C_P_F_L_E_A_1_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1_C_P_F_L_E_A_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_P_F_L_E_A_1_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "C_PROGRAM_FIND_LARGEST_ELEMENT_ARRAY_1").ToLocalChecked(), constructor);
