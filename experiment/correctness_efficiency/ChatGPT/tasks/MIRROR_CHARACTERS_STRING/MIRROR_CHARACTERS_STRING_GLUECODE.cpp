...
//
//[code snippet 1]
void MIRROR_CHARACTERS_STRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MIRROR_CHARACTERS_STRING* obj = new MIRROR_CHARACTERS_STRING();
...
//
//[code snippet 2]
void MIRROR_CHARACTERS_STRING_M_C_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MIRROR_CHARACTERS_STRING* obj = static_cast<MIRROR_CHARACTERS_STRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    std::string result = obj->M_C_S_f_gold(*str, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MIRROR_CHARACTERS_STRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MIRROR_CHARACTERS_STRING").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, MIRROR_CHARACTERS_STRING_M_C_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "M_C_S_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MIRROR_CHARACTERS_STRING").ToLocalChecked(), constructor);
