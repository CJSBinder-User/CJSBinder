...
//
//[code snippet 1]
void CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1* obj = new CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1();
...
//
//[code snippet 2]
void CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1_C_I_A_N_I_P_O_A_N_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1* obj = static_cast<CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->C_I_A_N_I_P_O_A_N_1_f_gold(x, y);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "C_I_A_N_I_P_O_A_N_1_f_gold", v8::FunctionTemplate::New(isolate, CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1_C_I_A_N_I_P_O_A_N_1_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_IF_A_NUMBER_IS_POWER_OF_ANOTHER_NUMBER_1").ToLocalChecked(), constructor);
