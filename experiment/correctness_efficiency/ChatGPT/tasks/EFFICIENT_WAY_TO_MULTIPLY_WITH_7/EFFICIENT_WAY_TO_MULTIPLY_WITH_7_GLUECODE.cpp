...
//
//[code snippet 1]
void EFFICIENT_WAY_TO_MULTIPLY_WITH_7_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    EFFICIENT_WAY_TO_MULTIPLY_WITH_7* obj = new EFFICIENT_WAY_TO_MULTIPLY_WITH_7();
...
//
//[code snippet 2]
void E_W_T_M_W_7_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    EFFICIENT_WAY_TO_MULTIPLY_WITH_7* obj = static_cast<EFFICIENT_WAY_TO_MULTIPLY_WITH_7*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    long n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    long result = obj->E_W_T_M_W_7_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, EFFICIENT_WAY_TO_MULTIPLY_WITH_7_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "EFFICIENT_WAY_TO_MULTIPLY_WITH_7").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "E_W_T_M_W_7_f_gold", v8::FunctionTemplate::New(isolate, E_W_T_M_W_7_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "EFFICIENT_WAY_TO_MULTIPLY_WITH_7").ToLocalChecked(), constructor);
