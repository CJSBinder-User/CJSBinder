...
//
//[code snippet 1]
void GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1* obj = new GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1();
...
//
//[code snippet 2]
void GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1_G_T_S_F_F_S_S_S_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 4 || !args[0]->IsString() || !args[1]->IsString() || !args[2]->IsInt32() || !args[3]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    
    v8::String::Utf8Value str1(args.GetIsolate(), args[0]->ToString(args.GetIsolate()));
    v8::String::Utf8Value str2(args.GetIsolate(), args[1]->ToString(args.GetIsolate()));
    ...
    GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1* obj = static_cast<GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    bool result = obj->G_T_S_F_F_S_S_S_1_f_gold(*str1, *str2, m, n);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "G_T_S_F_F_S_S_S_1_f_gold", v8::FunctionTemplate::New(isolate, GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1_G_T_S_F_F_S_S_S_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "GIVEN_TWO_STRINGS_FIND_FIRST_STRING_SUBSEQUENCE_SECOND_1").ToLocalChecked(), constructor);
