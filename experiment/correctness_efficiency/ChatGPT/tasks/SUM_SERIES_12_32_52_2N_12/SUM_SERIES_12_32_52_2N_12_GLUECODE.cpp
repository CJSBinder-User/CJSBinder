...
//
//[code snippet 1]
void SUM_SERIES_12_32_52_2N_12_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUM_SERIES_12_32_52_2N_12* obj = new SUM_SERIES_12_32_52_2N_12();
...
//
//[code snippet 2]
void SUM_SERIES_12_32_52_2N_12_S_S_1_3_5_2_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SUM_SERIES_12_32_52_2N_12* obj = static_cast<SUM_SERIES_12_32_52_2N_12*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->S_S_1_3_5_2_1_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUM_SERIES_12_32_52_2N_12_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUM_SERIES_12_32_52_2N_12").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "S_S_1_3_5_2_1_f_gold", v8::FunctionTemplate::New(isolate, SUM_SERIES_12_32_52_2N_12_S_S_1_3_5_2_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUM_SERIES_12_32_52_2N_12").ToLocalChecked(), constructor);
