...
//
//[code snippet 1]
void NUMBER_SUBSTRINGS_STRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_SUBSTRINGS_STRING* obj = new NUMBER_SUBSTRINGS_STRING();
...
//
//[code snippet 2]
void NUMBER_SUBSTRINGS_STRING_N_S_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    NUMBER_SUBSTRINGS_STRING* obj = static_cast<NUMBER_SUBSTRINGS_STRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    int result = obj->N_S_S_f_gold(std::string(*str));
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_SUBSTRINGS_STRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_SUBSTRINGS_STRING").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "N_S_S_f_gold", v8::FunctionTemplate::New(isolate, NUMBER_SUBSTRINGS_STRING_N_S_S_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_SUBSTRINGS_STRING").ToLocalChecked(), constructor);
