...
//
//[code snippet 1]
void SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS* obj = new SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS();
...
//
//[code snippet 2]
void SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS_S_S_0_6_0_0_0_0_0_0_N_T_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS* obj = static_cast<SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    double result = obj->S_S_0_6_0_0_0_0_0_0_N_T_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "S_S_0_6_0_0_0_0_0_0_N_T_f_gold", v8::FunctionTemplate::New(isolate, SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS_S_S_0_6_0_0_0_0_0_0_N_T_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUM_SERIES_0_6_0_06_0_006_0_0006_N_TERMS").ToLocalChecked(), constructor);
