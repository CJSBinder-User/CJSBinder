...
//
//[code snippet 1]
void LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED* obj = new LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED();
...
//
//[code snippet 2]
void LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED_L_L_S_S_C_M_R_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED* obj = static_cast<LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_L_S_S_C_M_R_f_gold(str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED").ToLocalChecked());
    
    // Prototype methods
    tpl->PrototypeTemplate()->Set(isolate, "L_L_S_S_C_M_R_f_gold", v8::FunctionTemplate::New(isolate, LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED_L_L_S_S_C_M_R_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LENGTH_LONGEST_SUB_STRING_CAN_MAKE_REMOVED").ToLocalChecked(), constructor);
