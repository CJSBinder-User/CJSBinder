...
//
//[code snippet 1]
void COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS* obj = new COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS();
...
//
//[code snippet 2]
void COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS_C_C_S_D_E_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsString()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    v8::String::Utf8Value str(args.GetIsolate(), args[0]);
    COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS* obj = static_cast<COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->C_C_S_D_E_A_f_gold(*str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "C_C_S_D_E_A_f_gold", v8::FunctionTemplate::New(isolate, COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS_C_C_S_D_E_A_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_CHARACTERS_STRING_DISTANCE_ENGLISH_ALPHABETS").ToLocalChecked(), constructor);
