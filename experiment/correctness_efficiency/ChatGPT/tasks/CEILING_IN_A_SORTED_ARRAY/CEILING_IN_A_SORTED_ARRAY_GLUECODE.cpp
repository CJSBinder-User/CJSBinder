...
//
//[code snippet 1]
void CEILING_IN_A_SORTED_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CEILING_IN_A_SORTED_ARRAY* obj = new CEILING_IN_A_SORTED_ARRAY();
...
//
//[code snippet 2]
void CEILING_IN_A_SORTED_ARRAY_C_I_A_S_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 4 || !args[0]->IsArray() || !args[1]->IsInt32() || !args[2]->IsInt32() || !args[3]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    
    CEILING_IN_A_SORTED_ARRAY* obj = static_cast<CEILING_IN_A_SORTED_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    // Populating the C++ array from the JavaScript array
    ...
    int result = obj->C_I_A_S_A_f_gold(arr, low, high, x);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CEILING_IN_A_SORTED_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CEILING_IN_A_SORTED_ARRAY").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "C_I_A_S_A_f_gold", v8::FunctionTemplate::New(isolate, CEILING_IN_A_SORTED_ARRAY_C_I_A_S_A_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CEILING_IN_A_SORTED_ARRAY").ToLocalChecked(), constructor);
