...
//
//[code snippet 1]
void COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4* obj = new COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4();
...
//
//[code snippet 2]
void COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4_C_O_W_E_N_S_1_3_4_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4* obj = static_cast<COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->C_O_W_E_N_S_1_3_4_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4_C_O_W_E_N_S_1_3_4_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_O_W_E_N_S_1_3_4_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_OFDIFFERENT_WAYS_EXPRESS_N_SUM_1_3_4").ToLocalChecked(), constructor);
