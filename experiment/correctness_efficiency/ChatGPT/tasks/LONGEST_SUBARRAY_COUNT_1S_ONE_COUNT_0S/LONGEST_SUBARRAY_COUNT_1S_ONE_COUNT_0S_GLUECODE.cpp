...
//
//[code snippet 1]
void LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S* obj = new LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S();
...
//
//[code snippet 2]
void LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S_L_S_C_1_O_C_0_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S* obj = static_cast<LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->L_S_C_1_O_C_0_f_gold(cpp_arr, n);
    delete[] cpp_arr; // Clean up the allocated array
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S_L_S_C_1_O_C_0_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "L_S_C_1_O_C_0_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LONGEST_SUBARRAY_COUNT_1S_ONE_COUNT_0S").ToLocalChecked(), constructor);
