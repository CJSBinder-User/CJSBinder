...
//
//[code snippet 1]
void TRIANGULAR_NUMBERS_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    TRIANGULAR_NUMBERS_1* obj = new TRIANGULAR_NUMBERS_1();
...
//
//[code snippet 2]
void TRIANGULAR_NUMBERS_1_T_N_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    TRIANGULAR_NUMBERS_1* obj = static_cast<TRIANGULAR_NUMBERS_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int num = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    bool result = obj->T_N_1_f_gold(num);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, TRIANGULAR_NUMBERS_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "TRIANGULAR_NUMBERS_1").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, TRIANGULAR_NUMBERS_1_T_N_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "T_N_1_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "TRIANGULAR_NUMBERS_1").ToLocalChecked(), constructor);
