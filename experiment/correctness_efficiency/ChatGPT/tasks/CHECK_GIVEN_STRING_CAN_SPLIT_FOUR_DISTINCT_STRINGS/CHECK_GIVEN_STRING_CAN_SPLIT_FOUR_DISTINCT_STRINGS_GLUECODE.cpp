...
//
//[code snippet 1]
void CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS* obj = new CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS();
...
//
//[code snippet 2]
void CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS_C_G_S_C_S_F_D_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS* obj = static_cast<CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->C_G_S_C_S_F_D_S_f_gold(s);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS_C_G_S_C_S_F_D_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_G_S_C_S_F_D_S_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_GIVEN_STRING_CAN_SPLIT_FOUR_DISTINCT_STRINGS").ToLocalChecked(), constructor);
