...
//
//[code snippet 1]
void NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES* obj = new NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES();
...
//
//[code snippet 2]
void NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES_N_U_R_F_U_N_U_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES* obj = static_cast<NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->N_U_R_F_U_N_U_S_f_gold(n);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "N_U_R_F_U_N_U_S_f_gold", v8::FunctionTemplate::New(isolate, NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES_N_U_R_F_U_N_U_S_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_UNIQUE_RECTANGLES_FORMED_USING_N_UNIT_SQUARES").ToLocalChecked(), constructor);
