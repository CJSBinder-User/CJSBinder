...
//
//[code snippet 1]
void GCD_ELEMENTS_GIVEN_RANGE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    GCD_ELEMENTS_GIVEN_RANGE* obj = new GCD_ELEMENTS_GIVEN_RANGE();
...
//
//[code snippet 2]
void GCD_ELEMENTS_GIVEN_RANGE_G_E_G_R_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    GCD_ELEMENTS_GIVEN_RANGE* obj = static_cast<GCD_ELEMENTS_GIVEN_RANGE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->G_E_G_R_f_gold(n, m);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, GCD_ELEMENTS_GIVEN_RANGE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "GCD_ELEMENTS_GIVEN_RANGE").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, GCD_ELEMENTS_GIVEN_RANGE_G_E_G_R_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "G_E_G_R_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "GCD_ELEMENTS_GIVEN_RANGE").ToLocalChecked(), constructor);
