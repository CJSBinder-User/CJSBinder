...
//
//[code snippet 1]
void SQUARED_TRIANGULAR_NUMBER_SUM_CUBES_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SQUARED_TRIANGULAR_NUMBER_SUM_CUBES* obj = new SQUARED_TRIANGULAR_NUMBER_SUM_CUBES();
...
//
//[code snippet 2]
void SQUARED_TRIANGULAR_NUMBER_SUM_CUBES_S_T_N_S_C_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SQUARED_TRIANGULAR_NUMBER_SUM_CUBES* obj = static_cast<SQUARED_TRIANGULAR_NUMBER_SUM_CUBES*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int s = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->S_T_N_S_C_f_gold(s);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SQUARED_TRIANGULAR_NUMBER_SUM_CUBES_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SQUARED_TRIANGULAR_NUMBER_SUM_CUBES").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SQUARED_TRIANGULAR_NUMBER_SUM_CUBES_S_T_N_S_C_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_T_N_S_C_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SQUARED_TRIANGULAR_NUMBER_SUM_CUBES").ToLocalChecked(), constructor);
