...
//
//[code snippet 1]
void FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1* obj = new FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1();
...
//
//[code snippet 2]
void FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    // Convert V8 Array to C++ integer array
    int* arr = new int[n];
    for (int i = 0; i < n; i++) {
    ...
    FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1* obj = static_cast<FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_M_P_O_A_T_I_A_1_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "F_M_P_O_A_T_I_A_1_f_gold", v8::FunctionTemplate::New(isolate, FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_MAXIMUM_PRODUCT_OF_A_TRIPLET_IN_ARRAY_1").ToLocalChecked(), constructor);
