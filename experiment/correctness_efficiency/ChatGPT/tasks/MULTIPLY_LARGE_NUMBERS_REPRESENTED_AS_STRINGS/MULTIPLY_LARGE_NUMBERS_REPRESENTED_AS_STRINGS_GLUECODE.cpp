...
//
//[code snippet 1]
void MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS* obj = new MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS();
...
//
//[code snippet 2]
void MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS_M_L_N_R_A_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS* obj = static_cast<MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    string result = obj->M_L_N_R_A_S_f_gold(*str1, *str2);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "M_L_N_R_A_S_f_gold", v8::FunctionTemplate::New(isolate, MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS_M_L_N_R_A_S_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MULTIPLY_LARGE_NUMBERS_REPRESENTED_AS_STRINGS").ToLocalChecked(), constructor);
