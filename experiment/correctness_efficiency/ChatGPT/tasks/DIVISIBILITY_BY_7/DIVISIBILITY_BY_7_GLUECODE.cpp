...
//
//[code snippet 1]
void DIVISIBILITY_BY_7_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    DIVISIBILITY_BY_7* obj = new DIVISIBILITY_BY_7();
...
//
//[code snippet 2]
void DIVISIBILITY_BY_7_D_B_7_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    DIVISIBILITY_BY_7* obj = static_cast<DIVISIBILITY_BY_7*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int num = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->D_B_7_f_gold(num);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, DIVISIBILITY_BY_7_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "DIVISIBILITY_BY_7").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, DIVISIBILITY_BY_7_D_B_7_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "D_B_7_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "DIVISIBILITY_BY_7").ToLocalChecked(), constructor);
