...
//
//[code snippet 1]
void REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX* obj = new REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX();
...
//
//[code snippet 2]
void REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX_R_M_E_E_S_2_M_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX* obj = static_cast<REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->R_M_E_E_S_2_M_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX_R_M_E_E_S_2_M_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "R_M_E_E_S_2_M_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "REMOVE_MINIMUM_ELEMENTS_EITHER_SIDE_2MIN_MAX").ToLocalChecked(), constructor);
