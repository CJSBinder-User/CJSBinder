...
//
//[code snippet 1]
void STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT* obj = new STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT();
...
//
//[code snippet 2]
void STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT_S_K_D_C_N_C_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT* obj = static_cast<STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    string result = obj->S_K_D_C_N_C_A_f_gold(n, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT_S_K_D_C_N_C_A_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_K_D_C_N_C_A_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "STRING_K_DISTINCT_CHARACTERS_NO_CHARACTERS_ADJACENT").ToLocalChecked(), constructor);
