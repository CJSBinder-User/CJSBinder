...
//
//[code snippet 1]
void COUNTS_PATHS_POINT_REACH_ORIGIN_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNTS_PATHS_POINT_REACH_ORIGIN_1* obj = new COUNTS_PATHS_POINT_REACH_ORIGIN_1();
...
//
//[code snippet 2]
void COUNTS_PATHS_POINT_REACH_ORIGIN_1_C_P_P_R_O_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    COUNTS_PATHS_POINT_REACH_ORIGIN_1* obj = static_cast<COUNTS_PATHS_POINT_REACH_ORIGIN_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->C_P_P_R_O_1_f_gold(n, m);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNTS_PATHS_POINT_REACH_ORIGIN_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNTS_PATHS_POINT_REACH_ORIGIN_1").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "C_P_P_R_O_1_f_gold", v8::FunctionTemplate::New(isolate, COUNTS_PATHS_POINT_REACH_ORIGIN_1_C_P_P_R_O_1_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNTS_PATHS_POINT_REACH_ORIGIN_1").ToLocalChecked(), constructor);
