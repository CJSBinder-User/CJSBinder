...
//
//[code snippet 1]
void SWAP_ALL_ODD_AND_EVEN_BITS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SWAP_ALL_ODD_AND_EVEN_BITS* obj = new SWAP_ALL_ODD_AND_EVEN_BITS();
...
//
//[code snippet 2]
void SWAP_ALL_ODD_AND_EVEN_BITS_S_A_O_A_E_B_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsUint32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SWAP_ALL_ODD_AND_EVEN_BITS* obj = static_cast<SWAP_ALL_ODD_AND_EVEN_BITS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    unsigned int x = args[0]->Uint32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    unsigned int result = obj->S_A_O_A_E_B_f_gold(x);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SWAP_ALL_ODD_AND_EVEN_BITS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SWAP_ALL_ODD_AND_EVEN_BITS").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SWAP_ALL_ODD_AND_EVEN_BITS_S_A_O_A_E_B_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_A_O_A_E_B_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SWAP_ALL_ODD_AND_EVEN_BITS").ToLocalChecked(), constructor);
