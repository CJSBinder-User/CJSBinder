...
//
//[code snippet 1]
void SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS* obj = new SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS();
...
//
//[code snippet 2]
void SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS_S_K_T_G_O_P_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS* obj = static_cast<SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int k = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->S_K_T_G_O_P_N_f_gold(k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "S_K_T_G_O_P_N_f_gold", v8::FunctionTemplate::New(isolate, SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS_S_K_T_G_O_P_N_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUM_K_TH_GROUP_ODD_POSITIVE_NUMBERS").ToLocalChecked(), constructor);
