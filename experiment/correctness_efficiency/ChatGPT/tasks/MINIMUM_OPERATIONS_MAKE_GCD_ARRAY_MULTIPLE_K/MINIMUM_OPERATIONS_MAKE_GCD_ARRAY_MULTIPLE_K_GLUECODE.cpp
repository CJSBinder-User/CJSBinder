...
//
//[code snippet 1]
void MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K* obj = new MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K();
...
//
//[code snippet 2]
void MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K_M_O_M_G_A_M_K_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K* obj = static_cast<MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_O_M_G_A_M_K_f_gold(a, n, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K").ToLocalChecked());
    
    // Register the method
    tpl->PrototypeTemplate()->Set(isolate, "M_O_M_G_A_M_K_f_gold", v8::FunctionTemplate::New(isolate, MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K_M_O_M_G_A_M_K_f_gold));

    // Create the constructor function
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    
    // Attach the constructor to the global context
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MINIMUM_OPERATIONS_MAKE_GCD_ARRAY_MULTIPLE_K").ToLocalChecked(), constructor);
