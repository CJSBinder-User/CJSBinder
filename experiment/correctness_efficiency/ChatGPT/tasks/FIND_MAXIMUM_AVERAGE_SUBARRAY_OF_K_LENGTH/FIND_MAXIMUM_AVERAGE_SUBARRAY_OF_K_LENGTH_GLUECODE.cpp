...
//
//[code snippet 1]
void FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH* obj = new FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH();
...
//
//[code snippet 2]
void FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_F_M_A_S_O_K_L_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    // Get the C++ object
    FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH* obj = static_cast<FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int* c_arr = new int[n]; // Create a C++ array
    for (int i = 0; i < n; i++) {
    ...
    int result = obj->F_M_A_S_O_K_L_f_gold(c_arr, n, k);
    delete[] c_arr; // Clean up the array
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH").ToLocalChecked());
    
    // Register the method F_M_A_S_O_K_L_f_gold
    tpl->PrototypeTemplate()->Set(isolate, "F_M_A_S_O_K_L_f_gold", v8::FunctionTemplate::New(isolate, FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_F_M_A_S_O_K_L_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH").ToLocalChecked(), constructor);
