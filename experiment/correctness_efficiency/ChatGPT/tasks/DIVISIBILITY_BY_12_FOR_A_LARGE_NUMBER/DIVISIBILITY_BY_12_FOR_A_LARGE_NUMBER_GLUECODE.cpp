...
//
//[code snippet 1]
void DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER* obj = new DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER();
...
//
//[code snippet 2]
void DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER_D_B_1_F_A_L_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER* obj = static_cast<DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->D_B_1_F_A_L_N_f_gold(num);
...
//[code snippet 3]
    ...
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER_D_B_1_F_A_L_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "D_B_1_F_A_L_N_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "DIVISIBILITY_BY_12_FOR_A_LARGE_NUMBER").ToLocalChecked(), constructor);
