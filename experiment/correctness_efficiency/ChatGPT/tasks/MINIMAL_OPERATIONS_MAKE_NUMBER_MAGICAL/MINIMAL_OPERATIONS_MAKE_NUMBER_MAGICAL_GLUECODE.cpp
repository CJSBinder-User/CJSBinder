...
//
//[code snippet 1]
void MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL* obj = new MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL();
...
//
//[code snippet 2]
void MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_M_O_M_N_M_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL* obj = static_cast<MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_O_M_N_M_f_gold(s);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_M_O_M_N_M_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "M_O_M_N_M_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL").ToLocalChecked(), constructor);
