...
//
//[code snippet 1]
void MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1* obj = new MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1();
...
//
//[code snippet 2]
void MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1_M_A_R_P_F_S_A_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsArray() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }

    // Extracting C++ array from JavaScript array
    ...
    MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1* obj = static_cast<MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_A_R_P_F_S_A_1_f_gold(arr, n);
...
// assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1_M_A_R_P_F_S_A_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "M_A_R_P_F_S_A_1_f_gold", method_tpl->GetFunction(isolate->GetCurrentContext()).ToLocalChecked());
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MAXIMUM_AREA_RECTANGLE_PICKING_FOUR_SIDES_ARRAY_1").ToLocalChecked(), constructor).FromJust();
