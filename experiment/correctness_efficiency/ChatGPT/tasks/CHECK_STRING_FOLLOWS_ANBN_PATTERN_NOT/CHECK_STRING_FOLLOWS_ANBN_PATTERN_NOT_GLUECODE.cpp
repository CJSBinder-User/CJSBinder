...
//
//[code snippet 1]
void CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT* obj = new CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT();
...
//
//[code snippet 2]
void CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT_C_S_F_A_P_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT* obj = static_cast<CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    
    bool result = obj->C_S_F_A_P_N_f_gold(*str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT_C_S_F_A_P_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_S_F_A_P_N_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_STRING_FOLLOWS_ANBN_PATTERN_NOT").ToLocalChecked(), constructor);
