...
//
//[code snippet 1]
void CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS* obj = new CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS();
...
//
//[code snippet 2]
void CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || !args[0]->IsString() || !args[1]->IsString() || !args[2]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }

    CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS* obj = 
        static_cast<CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    bool result = obj->C_O_S_U_A_D_L_O_f_gold(*str1, *str2, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS").ToLocalChecked());

    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_O_S_U_A_D_L_O_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS").ToLocalChecked(), constructor);
