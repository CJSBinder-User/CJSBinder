...
//
//[code snippet 1]
void FIND_REPETITIVE_ELEMENT_1_N_1_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_REPETITIVE_ELEMENT_1_N_1_1* obj = new FIND_REPETITIVE_ELEMENT_1_N_1_1();
...
//
//[code snippet 2]
void FIND_REPETITIVE_ELEMENT_1_N_1_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_REPETITIVE_ELEMENT_1_N_1_1* obj = static_cast<FIND_REPETITIVE_ELEMENT_1_N_1_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_R_E_1_N_1_1_f_gold(cpp_arr, n);
    delete[] cpp_arr; // Clean up memory
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_REPETITIVE_ELEMENT_1_N_1_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_REPETITIVE_ELEMENT_1_N_1_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "F_R_E_1_N_1_1_f_gold", v8::FunctionTemplate::New(isolate, FIND_REPETITIVE_ELEMENT_1_N_1_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_REPETITIVE_ELEMENT_1_N_1_1").ToLocalChecked(), constructor);
