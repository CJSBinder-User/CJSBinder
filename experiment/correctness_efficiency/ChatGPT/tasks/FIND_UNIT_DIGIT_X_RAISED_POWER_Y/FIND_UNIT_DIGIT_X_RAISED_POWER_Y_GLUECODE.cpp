...
//
//[code snippet 1]
void FIND_UNIT_DIGIT_X_RAISED_POWER_Y_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_UNIT_DIGIT_X_RAISED_POWER_Y* obj = new FIND_UNIT_DIGIT_X_RAISED_POWER_Y();
...
//
//[code snippet 2]
void FIND_UNIT_DIGIT_X_RAISED_POWER_Y_F_U_D_X_R_P_Y_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    FIND_UNIT_DIGIT_X_RAISED_POWER_Y* obj = static_cast<FIND_UNIT_DIGIT_X_RAISED_POWER_Y*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->F_U_D_X_R_P_Y_f_gold(x, y);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_UNIT_DIGIT_X_RAISED_POWER_Y_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_UNIT_DIGIT_X_RAISED_POWER_Y").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_UNIT_DIGIT_X_RAISED_POWER_Y_F_U_D_X_R_P_Y_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_U_D_X_R_P_Y_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_UNIT_DIGIT_X_RAISED_POWER_Y").ToLocalChecked(), constructor);
