...
//
//[code snippet 1]
void FIND_REPETITIVE_ELEMENT_1_N_1_2_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_REPETITIVE_ELEMENT_1_N_1_2* obj = new FIND_REPETITIVE_ELEMENT_1_N_1_2();
...
//
//[code snippet 2]
void FIND_REPETITIVE_ELEMENT_1_N_1_2_F_R_E_1_N_1_2_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsArray() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    FIND_REPETITIVE_ELEMENT_1_N_1_2* obj = static_cast<FIND_REPETITIVE_ELEMENT_1_N_1_2*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->F_R_E_1_N_1_2_f_gold(arr, n);
    delete[] arr; // Don't forget to clean up
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_REPETITIVE_ELEMENT_1_N_1_2_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_REPETITIVE_ELEMENT_1_N_1_2").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, FIND_REPETITIVE_ELEMENT_1_N_1_2_F_R_E_1_N_1_2_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "F_R_E_1_N_1_2_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_REPETITIVE_ELEMENT_1_N_1_2").ToLocalChecked(), constructor);
