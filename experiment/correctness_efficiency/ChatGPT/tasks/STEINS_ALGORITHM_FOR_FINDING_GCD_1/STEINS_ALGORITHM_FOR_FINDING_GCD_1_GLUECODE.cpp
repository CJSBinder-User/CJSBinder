...
//
//[code snippet 1]
void STEINS_ALGORITHM_FOR_FINDING_GCD_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    STEINS_ALGORITHM_FOR_FINDING_GCD_1* obj = new STEINS_ALGORITHM_FOR_FINDING_GCD_1();
...
//
//[code snippet 2]
void STEINS_ALGORITHM_FOR_FINDING_GCD_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    STEINS_ALGORITHM_FOR_FINDING_GCD_1* obj = static_cast<STEINS_ALGORITHM_FOR_FINDING_GCD_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->S_A_F_F_G_1_f_gold(a, b);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, STEINS_ALGORITHM_FOR_FINDING_GCD_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "STEINS_ALGORITHM_FOR_FINDING_GCD_1").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, STEINS_ALGORITHM_FOR_FINDING_GCD_1_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_A_F_F_G_1_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "STEINS_ALGORITHM_FOR_FINDING_GCD_1").ToLocalChecked(), constructor);
