...
//
//[code snippet 1]
void SUM_AREA_RECTANGLES_POSSIBLE_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUM_AREA_RECTANGLES_POSSIBLE_ARRAY* obj = new SUM_AREA_RECTANGLES_POSSIBLE_ARRAY();
...
//
//[code snippet 2]
void SUM_AREA_RECTANGLES_POSSIBLE_ARRAY_S_A_R_P_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    SUM_AREA_RECTANGLES_POSSIBLE_ARRAY* obj = static_cast<SUM_AREA_RECTANGLES_POSSIBLE_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->S_A_R_P_A_f_gold(a, n);
    delete[] a; // Clean up the allocated memory
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUM_AREA_RECTANGLES_POSSIBLE_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUM_AREA_RECTANGLES_POSSIBLE_ARRAY").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SUM_AREA_RECTANGLES_POSSIBLE_ARRAY_S_A_R_P_A_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_A_R_P_A_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUM_AREA_RECTANGLES_POSSIBLE_ARRAY").ToLocalChecked(), constructor);
