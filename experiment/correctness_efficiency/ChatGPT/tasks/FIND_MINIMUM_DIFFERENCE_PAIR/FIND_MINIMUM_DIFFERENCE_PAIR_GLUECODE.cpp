...
//
//[code snippet 1]
void FIND_MINIMUM_DIFFERENCE_PAIR_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    FIND_MINIMUM_DIFFERENCE_PAIR* obj = new FIND_MINIMUM_DIFFERENCE_PAIR();
...
//
//[code snippet 2]
void FIND_MINIMUM_DIFFERENCE_PAIR_F_M_D_P_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    FIND_MINIMUM_DIFFERENCE_PAIR* obj = static_cast<FIND_MINIMUM_DIFFERENCE_PAIR*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->F_M_D_P_f_gold(arr, n);
    delete[] arr; // Clean up dynamically allocated array for performance
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, FIND_MINIMUM_DIFFERENCE_PAIR_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "FIND_MINIMUM_DIFFERENCE_PAIR").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "F_M_D_P_f_gold", v8::FunctionTemplate::New(isolate, FIND_MINIMUM_DIFFERENCE_PAIR_F_M_D_P_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "FIND_MINIMUM_DIFFERENCE_PAIR").ToLocalChecked(), constructor);
