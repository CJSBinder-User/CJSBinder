...
//
//[code snippet 1]
void LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING* obj = new LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING();
...
//
//[code snippet 2]
void LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING_L_M_S_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING* obj = static_cast<LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    std::string result = obj->L_M_S_S_f_gold(*str);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "L_M_S_S_f_gold", v8::FunctionTemplate::New(isolate, LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING_L_M_S_S_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LEXICOGRAPHICAL_MAXIMUM_SUBSTRING_STRING").ToLocalChecked(), constructor);
