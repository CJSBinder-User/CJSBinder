...
//
//[code snippet 1]
void NTH_EVEN_LENGTH_PALINDROME_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NTH_EVEN_LENGTH_PALINDROME* obj = new NTH_EVEN_LENGTH_PALINDROME();
...
//
//[code snippet 2]
void NTH_EVEN_LENGTH_PALINDROME_N_E_L_P_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    NTH_EVEN_LENGTH_PALINDROME* obj = static_cast<NTH_EVEN_LENGTH_PALINDROME*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    std::string result = obj->N_E_L_P_f_gold(n);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NTH_EVEN_LENGTH_PALINDROME_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NTH_EVEN_LENGTH_PALINDROME").ToLocalChecked());
    
    // Register the method
    tpl->PrototypeTemplate()->Set(isolate, "N_E_L_P_f_gold", v8::FunctionTemplate::New(isolate, NTH_EVEN_LENGTH_PALINDROME_N_E_L_P_f_gold));
    
    // Create the constructor
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    
    // Set the constructor in the global scope
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NTH_EVEN_LENGTH_PALINDROME").ToLocalChecked(), constructor);
