...
//
//[code snippet 1]
void CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED* obj = new CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED();
...
//
//[code snippet 2]
void CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED_C_R_S_A_M_A_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    // Convert v8 array to a regular C++ array
    int* arr = new int[n];
    for (int i = 0; i < n; ++i) {
    ...
    CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED* obj = static_cast<CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    bool result = obj->C_R_S_A_M_A_S_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' have been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED_C_R_S_A_M_A_S_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_R_S_A_M_A_S_f_gold", method_tpl->GetFunction(isolate->GetCurrentContext()).ToLocalChecked());
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "CHECK_REVERSING_SUB_ARRAY_MAKE_ARRAY_SORTED").ToLocalChecked(), constructor);
