...
//
//[code snippet 1]
void LONGEST_REPEATED_SUBSEQUENCE_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    LONGEST_REPEATED_SUBSEQUENCE_1* obj = new LONGEST_REPEATED_SUBSEQUENCE_1();
...
//
//[code snippet 2]
void LONGEST_REPEATED_SUBSEQUENCE_1_L_R_S_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    v8::String::Utf8Value utf8Str(args.GetIsolate(), args[0]);
    std::string str = *utf8Str;

    LONGEST_REPEATED_SUBSEQUENCE_1* obj = static_cast<LONGEST_REPEATED_SUBSEQUENCE_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    std::string result = obj->L_R_S_1_f_gold(str);

    // Convert C++ string back to JS string
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, LONGEST_REPEATED_SUBSEQUENCE_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "LONGEST_REPEATED_SUBSEQUENCE_1").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "L_R_S_1_f_gold", v8::FunctionTemplate::New(isolate, LONGEST_REPEATED_SUBSEQUENCE_1_L_R_S_1_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "LONGEST_REPEATED_SUBSEQUENCE_1").ToLocalChecked(), constructor);
