...
//
//[code snippet 1]
void K_TH_ELEMENT_TWO_SORTED_ARRAYS_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    K_TH_ELEMENT_TWO_SORTED_ARRAYS* obj = new K_TH_ELEMENT_TWO_SORTED_ARRAYS();
...
//
//[code snippet 2]
void K_TH_ELEMENT_TWO_SORTED_ARRAYS_K_T_E_T_S_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 5 || 
        !args[0]->IsArray() || 
        !args[1]->IsArray() || 
        !args[2]->IsInt32() || 
    ...
    K_TH_ELEMENT_TWO_SORTED_ARRAYS* obj = static_cast<K_TH_ELEMENT_TWO_SORTED_ARRAYS*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int k = args[4]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    ...
    int result = obj->K_T_E_T_S_A_f_gold(c_arr1, c_arr2, m, n, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, K_TH_ELEMENT_TWO_SORTED_ARRAYS_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "K_TH_ELEMENT_TWO_SORTED_ARRAYS").ToLocalChecked());

    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, K_TH_ELEMENT_TWO_SORTED_ARRAYS_K_T_E_T_S_A_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "K_T_E_T_S_A_f_gold", method_tpl);

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "K_TH_ELEMENT_TWO_SORTED_ARRAYS").ToLocalChecked(), constructor);
