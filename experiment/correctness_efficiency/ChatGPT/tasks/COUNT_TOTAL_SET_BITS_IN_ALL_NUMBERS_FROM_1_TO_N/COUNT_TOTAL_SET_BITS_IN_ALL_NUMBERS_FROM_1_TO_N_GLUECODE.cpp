...
//
//[code snippet 1]
void COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N* obj = new COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N();
...
//
//[code snippet 2]
void COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N_C_T_S_B_I_A_N_F_1_T_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N* obj = static_cast<COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->C_T_S_B_I_A_N_F_1_T_N_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N").ToLocalChecked());
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N_C_T_S_B_I_A_N_F_1_T_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "C_T_S_B_I_A_N_F_1_T_N_f_gold", method_tpl);
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_TOTAL_SET_BITS_IN_ALL_NUMBERS_FROM_1_TO_N").ToLocalChecked(), constructor);
