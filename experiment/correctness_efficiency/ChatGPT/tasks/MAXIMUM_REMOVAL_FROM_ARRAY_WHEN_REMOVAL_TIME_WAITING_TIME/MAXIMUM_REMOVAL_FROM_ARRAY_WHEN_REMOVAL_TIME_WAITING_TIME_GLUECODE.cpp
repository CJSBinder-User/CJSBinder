...
//
//[code snippet 1]
void MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME* obj = new MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME();
...
//
//[code snippet 2]
void MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME_M_R_F_A_W_R_T_W_T_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    int* arr = new int[n];
    for (int i = 0; i < n && i < jsArray->Length(); i++) {
    ...
    MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME* obj = static_cast<MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->M_R_F_A_W_R_T_W_T_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "M_R_F_A_W_R_T_W_T_f_gold", v8::FunctionTemplate::New(isolate, MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME_M_R_F_A_W_R_T_W_T_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "MAXIMUM_REMOVAL_FROM_ARRAY_WHEN_REMOVAL_TIME_WAITING_TIME").ToLocalChecked(), constructor);
