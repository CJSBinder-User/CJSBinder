...
//
//[code snippet 1]
void PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE* obj = new PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE();
...
//
//[code snippet 2]
void PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE_P_C_A_S_N_I_R_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE* obj = static_cast<PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->P_C_A_S_N_I_R_f_gold(arr, n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, "P_C_A_S_N_I_R_f_gold", v8::FunctionTemplate::New(isolate, PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE_P_C_A_S_N_I_R_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "PROGRAM_CHECK_ARRAY_SORTED_NOT_ITERATIVE_RECURSIVE").ToLocalChecked(), constructor);
