...
//
//[code snippet 1]
void EQUILIBRIUM_INDEX_OF_AN_ARRAY_1_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    EQUILIBRIUM_INDEX_OF_AN_ARRAY_1* obj = new EQUILIBRIUM_INDEX_OF_AN_ARRAY_1();
...
//
//[code snippet 2]
void EQUILIBRIUM_INDEX_OF_AN_ARRAY_1_E_I_O_A_A_1_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    EQUILIBRIUM_INDEX_OF_AN_ARRAY_1* obj = static_cast<EQUILIBRIUM_INDEX_OF_AN_ARRAY_1*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->E_I_O_A_A_1_f_gold(c_arr, n);
    delete[] c_arr; // Cleanup allocated memory
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, EQUILIBRIUM_INDEX_OF_AN_ARRAY_1_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "EQUILIBRIUM_INDEX_OF_AN_ARRAY_1").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "E_I_O_A_A_1_f_gold", v8::FunctionTemplate::New(isolate, EQUILIBRIUM_INDEX_OF_AN_ARRAY_1_E_I_O_A_A_1_f_gold));

    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "EQUILIBRIUM_INDEX_OF_AN_ARRAY_1").ToLocalChecked(), constructor);
