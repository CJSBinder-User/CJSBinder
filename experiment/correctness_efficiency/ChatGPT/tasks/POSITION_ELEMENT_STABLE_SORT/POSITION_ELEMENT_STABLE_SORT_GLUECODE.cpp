...
//
//[code snippet 1]
void POSITION_ELEMENT_STABLE_SORT_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    POSITION_ELEMENT_STABLE_SORT* obj = new POSITION_ELEMENT_STABLE_SORT();
...
//
//[code snippet 2]
void POSITION_ELEMENT_STABLE_SORT_P_E_S_S_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    int idx = args[2]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    ...
    POSITION_ELEMENT_STABLE_SORT* obj = static_cast<POSITION_ELEMENT_STABLE_SORT*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->P_E_S_S_f_gold(arr, n, idx);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, POSITION_ELEMENT_STABLE_SORT_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "POSITION_ELEMENT_STABLE_SORT").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "P_E_S_S_f_gold", v8::FunctionTemplate::New(isolate, POSITION_ELEMENT_STABLE_SORT_P_E_S_S_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "POSITION_ELEMENT_STABLE_SORT").ToLocalChecked(), constructor);
