...
//
//[code snippet 1]
void NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3* obj = new NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3();
...
//
//[code snippet 2]
void NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_N_D_R_M_N_D_3_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3* obj = static_cast<NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int result = obj->N_D_R_M_N_D_3_f_gold(num);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "N_D_R_M_N_D_3_f_gold", v8::FunctionTemplate::New(isolate, NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_N_D_R_M_N_D_3_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3").ToLocalChecked(), constructor);
