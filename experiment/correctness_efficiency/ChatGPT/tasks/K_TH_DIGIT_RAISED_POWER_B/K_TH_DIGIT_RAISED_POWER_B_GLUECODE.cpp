...
//
//[code snippet 1]
void K_TH_DIGIT_RAISED_POWER_B_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    K_TH_DIGIT_RAISED_POWER_B* obj = new K_TH_DIGIT_RAISED_POWER_B();
...
//
//[code snippet 2]
void K_TH_DIGIT_RAISED_POWER_B_K_T_D_R_P_B_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || !args[0]->IsInt32() || !args[1]->IsInt32() || !args[2]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    K_TH_DIGIT_RAISED_POWER_B* obj = static_cast<K_TH_DIGIT_RAISED_POWER_B*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->K_T_D_R_P_B_f_gold(a, b, k);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, K_TH_DIGIT_RAISED_POWER_B_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "K_TH_DIGIT_RAISED_POWER_B").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "K_T_D_R_P_B_f_gold", v8::FunctionTemplate::New(isolate, K_TH_DIGIT_RAISED_POWER_B_K_T_D_R_P_B_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "K_TH_DIGIT_RAISED_POWER_B").ToLocalChecked(), constructor);
