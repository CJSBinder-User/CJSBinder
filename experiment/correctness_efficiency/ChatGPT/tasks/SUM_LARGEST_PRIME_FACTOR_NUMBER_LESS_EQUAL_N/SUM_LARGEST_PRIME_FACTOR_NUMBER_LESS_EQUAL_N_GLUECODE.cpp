...
//
//[code snippet 1]
void SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N* obj = new SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N();
...
//
//[code snippet 2]
void SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N_S_L_P_F_N_L_E_N_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 1 || !args[0]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N* obj = static_cast<SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    int n = args[0]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    int result = obj->S_L_P_F_N_L_E_N_f_gold(n);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N").ToLocalChecked());
    
    v8::Local<v8::FunctionTemplate> method_tpl = v8::FunctionTemplate::New(isolate, SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N_S_L_P_F_N_L_E_N_f_gold);
    tpl->PrototypeTemplate()->Set(isolate, "S_L_P_F_N_L_E_N_f_gold", method_tpl);
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SUM_LARGEST_PRIME_FACTOR_NUMBER_LESS_EQUAL_N").ToLocalChecked(), constructor);
