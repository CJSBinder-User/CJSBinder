...
//
//[code snippet 1]
void COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ* obj = new COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ();
...
//
//[code snippet 2]
void COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ_C_F_K_M_S_N_M_J_I_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 2 || !args[0]->IsInt32() || !args[1]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    
    COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ* obj = static_cast<COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->C_F_K_M_S_N_M_J_I_f_gold(n, k);
...
// assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ").ToLocalChecked());
    
    // Register the method
    tpl->PrototypeTemplate()->Set(isolate, "C_F_K_M_S_N_M_J_I_f_gold", v8::FunctionTemplate::New(isolate, COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ_C_F_K_M_S_N_M_J_I_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "COUNT_FREQUENCY_K_MATRIX_SIZE_N_MATRIXI_J_IJ").ToLocalChecked(), constructor);
