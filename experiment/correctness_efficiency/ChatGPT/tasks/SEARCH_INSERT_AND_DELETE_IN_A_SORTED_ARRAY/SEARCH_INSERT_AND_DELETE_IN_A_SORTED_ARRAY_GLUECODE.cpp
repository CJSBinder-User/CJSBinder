...
//
//[code snippet 1]
void SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY* obj = new SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY();
...
//
//[code snippet 2]
void SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY_S_I_A_D_I_A_S_A_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || 
        !args[1]->IsInt32() || 
        !args[2]->IsInt32() || 
        !args[0]->IsArray()) {
    ...
    SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY* obj = static_cast<SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int key = args[3]->Int32Value(args.GetIsolate()->GetCurrentContext()).FromMaybe(0);
    
    int result = obj->S_I_A_D_I_A_S_A_f_gold(arr, low, high, key);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY").ToLocalChecked());
    tpl->PrototypeTemplate()->Set(isolate, "S_I_A_D_I_A_S_A_f_gold", v8::FunctionTemplate::New(isolate, SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY_S_I_A_D_I_A_S_A_f_gold));
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, v8::String::NewFromUtf8(isolate, "SEARCH_INSERT_AND_DELETE_IN_A_SORTED_ARRAY").ToLocalChecked(), constructor);
