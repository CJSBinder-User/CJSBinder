...
//
//[code snippet 1]
void DYNAMIC_PROGRAMMING_SET_28_MINIMUM_INSERTIONS_TO_FORM_A_PALINDROME_constructor(const v8::FunctionCallbackInfo<v8::Value>& args) {
    DYNAMIC_PROGRAMMING_SET_28_MINIMUM_INSERTIONS_TO_FORM_A_PALINDROME* obj = new DYNAMIC_PROGRAMMING_SET_28_MINIMUM_INSERTIONS_TO_FORM_A_PALINDROME();
...
//
//[code snippet 2]
void D_P_S_2_M_I_T_F_A_P_f_gold(const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (args.Length() < 3 || !args[1]->IsInt32() || !args[2]->IsInt32()) {
        args.GetReturnValue().Set(v8::Undefined(args.GetIsolate()));
        return;
    }
    
    DYNAMIC_PROGRAMMING_SET_28_MINIMUM_INSERTIONS_TO_FORM_A_PALINDROME* obj = static_cast<DYNAMIC_PROGRAMMING_SET_28_MINIMUM_INSERTIONS_TO_FORM_A_PALINDROME*>(v8::External::Cast(*args.This()->GetInternalField(0))->Value());
    ...
    int result = obj->D_P_S_2_M_I_T_F_A_P_f_gold(const_cast<char*>(c_str), l, h);
...
//assumed that 'isolate' and 'context' has been initialized
    v8::Local<v8::FunctionTemplate> tpl = v8::FunctionTemplate::New(isolate, DYNAMIC_PROGRAMMING_SET_28_MINIMUM_INSERTIONS_TO_FORM_A_PALINDROME_constructor);
    tpl->InstanceTemplate()->SetInternalFieldCount(1);
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "DYNAMIC_PROGRAMMING_SET_28_MINIMUM_INSERTIONS_TO_FORM_A_PALINDROME").ToLocalChecked());
    
    tpl->PrototypeTemplate()->Set(isolate, 
        "D_P_S_2_M_I_T_F_A_P_f_gold", 
        v8::FunctionTemplate::New(isolate, D_P_S_2_M_I_T_F_A_P_f_gold));
    
    v8::Local<v8::Function> constructor = tpl->GetFunction(context).ToLocalChecked();
    context->Global()->Set(context, 
        v8::String::NewFromUtf8(isolate, "DYNAMIC_PROGRAMMING_SET_28_MINIMUM_INSERTIONS_TO_FORM_A_PALINDROME").ToLocalChecked(), 
        constructor);
