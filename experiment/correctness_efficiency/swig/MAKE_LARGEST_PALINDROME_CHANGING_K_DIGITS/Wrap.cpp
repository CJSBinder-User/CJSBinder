...
#define SWIGTYPE_p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS swig_types[0]
...
SWIGV8_ClientData _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_clientData;


static SwigV8ReturnValue _wrap_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS *arg1 = (MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS *) 0 ;
  string arg2 ;
  int arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold" "', argument " "1"" of type '" "MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS *""'"); 
  }
  arg1 = reinterpret_cast< MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (arg1)->M_L_P_C_K_D_f_gold(arg2,arg3);
...
static SwigV8ReturnValue _wrap_new_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS.");
  result = (MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS *)new MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS * arg1 = (MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS = {"_p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS", "p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS|MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS[] = {  {&_swigt__p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS, Type: p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS, Dtor: _wrap_delete_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS */
SWIGV8_FUNCTION_TEMPLATE _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class = SWIGV8_CreateClassTemplate("_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS");
SWIGV8_SET_CLASS_TEMPL(_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_clientData.class_templ, _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class);
_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_clientData.dtor = _wrap_delete_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS;
if (SWIGTYPE_p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS->clientdata == 0) {
  SWIGTYPE_p_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS->clientdata = &_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class, "M_L_P_C_K_D_f_gold", _wrap_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_M_L_P_C_K_D_f_gold);
  ...
  /* class instances */
  /* Class: MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS (_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS) */
SWIGV8_FUNCTION_TEMPLATE _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class_0 = SWIGV8_CreateClassTemplate("MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS");
_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class_0->SetCallHandler(_wrap_new_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS);
_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class_0->Inherit(_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_obj = _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_obj = _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS"), _exports_MAKE_LARGEST_PALINDROME_CHANGING_K_DIGITS_obj));
