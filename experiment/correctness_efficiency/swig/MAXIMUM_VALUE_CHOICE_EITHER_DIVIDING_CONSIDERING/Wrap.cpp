...
#define SWIGTYPE_p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING swig_types[0]
...
SWIGV8_ClientData _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_clientData;


static SwigV8ReturnValue _wrap_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_M_V_C_E_D_C_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING *arg1 = (MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_M_V_C_E_D_C_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_M_V_C_E_D_C_f_gold" "', argument " "1"" of type '" "MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING *""'"); 
  }
  arg1 = reinterpret_cast< MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_M_V_C_E_D_C_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (int)(arg1)->M_V_C_E_D_C_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING.");
  result = (MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING *)new MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING * arg1 = (MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING = {"_p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING", "MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING *|p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING[] = {  {&_swigt__p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING, Type: p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING, Dtor: _wrap_delete_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING */
SWIGV8_FUNCTION_TEMPLATE _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class = SWIGV8_CreateClassTemplate("_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING");
SWIGV8_SET_CLASS_TEMPL(_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_clientData.class_templ, _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class);
_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_clientData.dtor = _wrap_delete_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING;
if (SWIGTYPE_p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING->clientdata == 0) {
  SWIGTYPE_p_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING->clientdata = &_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class, "M_V_C_E_D_C_f_gold", _wrap_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_M_V_C_E_D_C_f_gold);
  ...
  /* class instances */
  /* Class: MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING (_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING) */
SWIGV8_FUNCTION_TEMPLATE _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class_0 = SWIGV8_CreateClassTemplate("MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING");
_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class_0->SetCallHandler(_wrap_new_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING);
_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class_0->Inherit(_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_obj = _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_obj = _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING"), _exports_MAXIMUM_VALUE_CHOICE_EITHER_DIVIDING_CONSIDERING_obj));
