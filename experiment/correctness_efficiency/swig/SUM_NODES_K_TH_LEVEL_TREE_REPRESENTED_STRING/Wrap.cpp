...
#define SWIGTYPE_p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING swig_types[0]
...
SWIGV8_ClientData _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_clientData;


static SwigV8ReturnValue _wrap_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_S_N_K_T_L_T_R_S_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING *arg1 = (SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING *) 0 ;
  string arg2 ;
  int arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_S_N_K_T_L_T_R_S_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_S_N_K_T_L_T_R_S_f_gold" "', argument " "1"" of type '" "SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING *""'"); 
  }
  arg1 = reinterpret_cast< SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_S_N_K_T_L_T_R_S_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_S_N_K_T_L_T_R_S_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_S_N_K_T_L_T_R_S_f_gold" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (int)(arg1)->S_N_K_T_L_T_R_S_f_gold(arg2,arg3);
...
static SwigV8ReturnValue _wrap_new_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING.");
  result = (SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING *)new SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING * arg1 = (SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING = {"_p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING", "p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING|SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING[] = {  {&_swigt__p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING, Type: p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING, Dtor: _wrap_delete_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING */
SWIGV8_FUNCTION_TEMPLATE _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class = SWIGV8_CreateClassTemplate("_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING");
SWIGV8_SET_CLASS_TEMPL(_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_clientData.class_templ, _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class);
_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_clientData.dtor = _wrap_delete_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING;
if (SWIGTYPE_p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING->clientdata == 0) {
  SWIGTYPE_p_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING->clientdata = &_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class, "S_N_K_T_L_T_R_S_f_gold", _wrap_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_S_N_K_T_L_T_R_S_f_gold);
  ...
  /* class instances */
  /* Class: SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING (_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING) */
SWIGV8_FUNCTION_TEMPLATE _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class_0 = SWIGV8_CreateClassTemplate("SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING");
_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class_0->SetCallHandler(_wrap_new_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING);
_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class_0->Inherit(_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_obj = _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_obj = _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING"), _exports_SUM_NODES_K_TH_LEVEL_TREE_REPRESENTED_STRING_obj));
