...
#define SWIGTYPE_p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS swig_types[0]
...
SWIGV8_ClientData _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_clientData;


static SwigV8ReturnValue _wrap_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_W_T_O_S_R_0_C_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS *arg1 = (WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS *) 0 ;
  string arg2 ;
  string arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_W_T_O_S_R_0_C_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_W_T_O_S_R_0_C_f_gold" "', argument " "1"" of type '" "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS *""'"); 
  }
  arg1 = reinterpret_cast< WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_W_T_O_S_R_0_C_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_W_T_O_S_R_0_C_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_W_T_O_S_R_0_C_f_gold" "', argument " "3"" of type '" "string""'"); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_W_T_O_S_R_0_C_f_gold" "', argument " "3"" of type '" "string""'");
    } else {
      arg3 = *(reinterpret_cast< string * >(argp3));
    }
  }
  result = (int)(arg1)->W_T_O_S_R_0_C_f_gold(arg2,arg3);
...
static SwigV8ReturnValue _wrap_new_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS.");
  result = (WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS *)new WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS * arg1 = (WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS = {"_p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS", "WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS *|p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS[] = {  {&_swigt__p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS, Type: p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS, Dtor: _wrap_delete_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS */
SWIGV8_FUNCTION_TEMPLATE _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class = SWIGV8_CreateClassTemplate("_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS");
SWIGV8_SET_CLASS_TEMPL(_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_clientData.class_templ, _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class);
_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_clientData.dtor = _wrap_delete_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS;
if (SWIGTYPE_p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS->clientdata == 0) {
  SWIGTYPE_p_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS->clientdata = &_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class, "W_T_O_S_R_0_C_f_gold", _wrap_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_W_T_O_S_R_0_C_f_gold);
  ...
  /* class instances */
  /* Class: WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS (_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS) */
SWIGV8_FUNCTION_TEMPLATE _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class_0 = SWIGV8_CreateClassTemplate("WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS");
_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class_0->SetCallHandler(_wrap_new_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS);
_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class_0->Inherit(_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_obj = _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_obj = _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS"), _exports_WAYS_TRANSFORMING_ONE_STRING_REMOVING_0_CHARACTERS_obj));
