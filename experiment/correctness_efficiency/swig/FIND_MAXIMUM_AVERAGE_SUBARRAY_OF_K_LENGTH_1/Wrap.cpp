...
#define SWIGTYPE_p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 swig_types[0]
...
SWIGV8_ClientData _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_clientData;


static SwigV8ReturnValue _wrap_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_F_M_A_S_O_K_L_1_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 *arg1 = (FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 *) 0 ;
  int *arg2 ;
  int arg3 ;
  int arg4 ;
  void *argp1 = 0 ;
  ...
  if(args.Length() != 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_F_M_A_S_O_K_L_1_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_F_M_A_S_O_K_L_1_f_gold" "', argument " "1"" of type '" "FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 *""'"); 
  }
  arg1 = reinterpret_cast< FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 * >(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_F_M_A_S_O_K_L_1_f_gold" "', argument " "2"" of type '" "int []""'"); 
  } 
  arg2 = reinterpret_cast< int * >(argp2);
  ecode3 = SWIG_AsVal_int(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_F_M_A_S_O_K_L_1_f_gold" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  ecode4 = SWIG_AsVal_int(args[2], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_F_M_A_S_O_K_L_1_f_gold" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = static_cast< int >(val4);
  result = (int)(arg1)->F_M_A_S_O_K_L_1_f_gold(arg2,arg3,arg4);
...
static SwigV8ReturnValue _wrap_new_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1.");
  result = (FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 *)new FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 * arg1 = (FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 = {"_p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1", "p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1|FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_int = {"_p_int", "int *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1,
  &_swigt__p_char,
  &_swigt__p_int,
};

static swig_cast_info _swigc__p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1[] = {  {&_swigt__p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_int[] = {  {&_swigt__p_int, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1,
  _swigc__p_char,
  _swigc__p_int,
};
...
#endif
{
  ...
  /* Name: _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1, Type: p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1, Dtor: _wrap_delete_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 */
SWIGV8_FUNCTION_TEMPLATE _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class = SWIGV8_CreateClassTemplate("_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1");
SWIGV8_SET_CLASS_TEMPL(_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_clientData.class_templ, _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class);
_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_clientData.dtor = _wrap_delete_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1;
if (SWIGTYPE_p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1->clientdata == 0) {
  SWIGTYPE_p_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1->clientdata = &_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class, "F_M_A_S_O_K_L_1_f_gold", _wrap_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_F_M_A_S_O_K_L_1_f_gold);
  ...
  /* class instances */
  /* Class: FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1 (_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1) */
SWIGV8_FUNCTION_TEMPLATE _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class_0 = SWIGV8_CreateClassTemplate("FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1");
_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class_0->SetCallHandler(_wrap_new_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1);
_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class_0->Inherit(_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_obj = _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_obj = _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1"), _exports_FIND_MAXIMUM_AVERAGE_SUBARRAY_OF_K_LENGTH_1_obj));
