...
#define SWIGTYPE_p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES swig_types[0]
...
SWIGV8_ClientData _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_clientData;


static SwigV8ReturnValue _wrap_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_H_C_B_T_H_N_N_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES *arg1 = (HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_H_C_B_T_H_N_N_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_H_C_B_T_H_N_N_f_gold" "', argument " "1"" of type '" "HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES *""'"); 
  }
  arg1 = reinterpret_cast< HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_H_C_B_T_H_N_N_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (int)(arg1)->H_C_B_T_H_N_N_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES.");
  result = (HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES *)new HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES * arg1 = (HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES = {"_p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES", "p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES|HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES[] = {  {&_swigt__p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES, Type: p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES, Dtor: _wrap_delete_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES */
SWIGV8_FUNCTION_TEMPLATE _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class = SWIGV8_CreateClassTemplate("_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES");
SWIGV8_SET_CLASS_TEMPL(_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_clientData.class_templ, _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class);
_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_clientData.dtor = _wrap_delete_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES;
if (SWIGTYPE_p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES->clientdata == 0) {
  SWIGTYPE_p_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES->clientdata = &_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class, "H_C_B_T_H_N_N_f_gold", _wrap_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_H_C_B_T_H_N_N_f_gold);
  ...
  /* class instances */
  /* Class: HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES (_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES) */
SWIGV8_FUNCTION_TEMPLATE _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class_0 = SWIGV8_CreateClassTemplate("HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES");
_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class_0->SetCallHandler(_wrap_new_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES);
_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class_0->Inherit(_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_obj = _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_obj = _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES"), _exports_HEIGHT_COMPLETE_BINARY_TREE_HEAP_N_NODES_obj));
