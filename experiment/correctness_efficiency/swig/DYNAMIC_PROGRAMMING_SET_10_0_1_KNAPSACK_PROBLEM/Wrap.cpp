...
#define SWIGTYPE_p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM swig_types[0]
...
SWIGV8_ClientData _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_clientData;


static SwigV8ReturnValue _wrap_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_D_P_S_1_0_1_K_P_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM *arg1 = (DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM *) 0 ;
  int arg2 ;
  int *arg3 ;
  int *arg4 ;
  int arg5 ;
  ...
  if(args.Length() != 4) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_D_P_S_1_0_1_K_P_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_D_P_S_1_0_1_K_P_f_gold" "', argument " "1"" of type '" "DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM *""'"); 
  }
  arg1 = reinterpret_cast< DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_D_P_S_1_0_1_K_P_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  res3 = SWIG_ConvertPtr(args[1], &argp3,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_D_P_S_1_0_1_K_P_f_gold" "', argument " "3"" of type '" "int []""'"); 
  } 
  arg3 = reinterpret_cast< int * >(argp3);
  res4 = SWIG_ConvertPtr(args[2], &argp4,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_D_P_S_1_0_1_K_P_f_gold" "', argument " "4"" of type '" "int []""'"); 
  } 
  arg4 = reinterpret_cast< int * >(argp4);
  ecode5 = SWIG_AsVal_int(args[3], &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_D_P_S_1_0_1_K_P_f_gold" "', argument " "5"" of type '" "int""'");
  } 
  arg5 = static_cast< int >(val5);
  result = (int)(arg1)->D_P_S_1_0_1_K_P_f_gold(arg2,arg3,arg4,arg5);
...
static SwigV8ReturnValue _wrap_new_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM.");
  result = (DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM *)new DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM * arg1 = (DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM = {"_p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM", "DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM *|p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_int = {"_p_int", "int *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM,
  &_swigt__p_char,
  &_swigt__p_int,
};

static swig_cast_info _swigc__p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM[] = {  {&_swigt__p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_int[] = {  {&_swigt__p_int, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM,
  _swigc__p_char,
  _swigc__p_int,
};
...
#endif
{
  ...
  /* Name: _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM, Type: p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM, Dtor: _wrap_delete_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM */
SWIGV8_FUNCTION_TEMPLATE _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class = SWIGV8_CreateClassTemplate("_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM");
SWIGV8_SET_CLASS_TEMPL(_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_clientData.class_templ, _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class);
_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_clientData.dtor = _wrap_delete_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM;
if (SWIGTYPE_p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM->clientdata == 0) {
  SWIGTYPE_p_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM->clientdata = &_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class, "D_P_S_1_0_1_K_P_f_gold", _wrap_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_D_P_S_1_0_1_K_P_f_gold);
  ...
  /* class instances */
  /* Class: DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM (_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM) */
SWIGV8_FUNCTION_TEMPLATE _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class_0 = SWIGV8_CreateClassTemplate("DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM");
_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class_0->SetCallHandler(_wrap_new_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM);
_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class_0->Inherit(_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_obj = _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_obj = _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM"), _exports_DYNAMIC_PROGRAMMING_SET_10_0_1_KNAPSACK_PROBLEM_obj));
