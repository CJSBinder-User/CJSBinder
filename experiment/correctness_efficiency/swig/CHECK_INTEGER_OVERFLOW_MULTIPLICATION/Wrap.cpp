...
#define SWIGTYPE_p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION swig_types[0]
...
SWIGV8_ClientData _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_clientData;


static SwigV8ReturnValue _wrap_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_C_I_O_M_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  CHECK_INTEGER_OVERFLOW_MULTIPLICATION *arg1 = (CHECK_INTEGER_OVERFLOW_MULTIPLICATION *) 0 ;
  long long arg2 ;
  long long arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_C_I_O_M_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "CHECK_INTEGER_OVERFLOW_MULTIPLICATION_C_I_O_M_f_gold" "', argument " "1"" of type '" "CHECK_INTEGER_OVERFLOW_MULTIPLICATION *""'"); 
  }
  arg1 = reinterpret_cast< CHECK_INTEGER_OVERFLOW_MULTIPLICATION * >(argp1);
  ecode2 = SWIG_AsVal_long_SS_long(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "CHECK_INTEGER_OVERFLOW_MULTIPLICATION_C_I_O_M_f_gold" "', argument " "2"" of type '" "long long""'");
  } 
  arg2 = static_cast< long long >(val2);
  ecode3 = SWIG_AsVal_long_SS_long(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "CHECK_INTEGER_OVERFLOW_MULTIPLICATION_C_I_O_M_f_gold" "', argument " "3"" of type '" "long long""'");
  } 
  arg3 = static_cast< long long >(val3);
  result = (bool)(arg1)->C_I_O_M_f_gold(arg2,arg3);
...
static SwigV8ReturnValue _wrap_new_CHECK_INTEGER_OVERFLOW_MULTIPLICATION(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  CHECK_INTEGER_OVERFLOW_MULTIPLICATION *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_CHECK_INTEGER_OVERFLOW_MULTIPLICATION.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_CHECK_INTEGER_OVERFLOW_MULTIPLICATION.");
  result = (CHECK_INTEGER_OVERFLOW_MULTIPLICATION *)new CHECK_INTEGER_OVERFLOW_MULTIPLICATION();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_CHECK_INTEGER_OVERFLOW_MULTIPLICATION(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    CHECK_INTEGER_OVERFLOW_MULTIPLICATION * arg1 = (CHECK_INTEGER_OVERFLOW_MULTIPLICATION *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION = {"_p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION", "p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION|CHECK_INTEGER_OVERFLOW_MULTIPLICATION *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION[] = {  {&_swigt__p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION, Type: p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION, Dtor: _wrap_delete_CHECK_INTEGER_OVERFLOW_MULTIPLICATION */
SWIGV8_FUNCTION_TEMPLATE _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class = SWIGV8_CreateClassTemplate("_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION");
SWIGV8_SET_CLASS_TEMPL(_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_clientData.class_templ, _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class);
_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_clientData.dtor = _wrap_delete_CHECK_INTEGER_OVERFLOW_MULTIPLICATION;
if (SWIGTYPE_p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION->clientdata == 0) {
  SWIGTYPE_p_CHECK_INTEGER_OVERFLOW_MULTIPLICATION->clientdata = &_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class, "C_I_O_M_f_gold", _wrap_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_C_I_O_M_f_gold);
  ...
  /* class instances */
  /* Class: CHECK_INTEGER_OVERFLOW_MULTIPLICATION (_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION) */
SWIGV8_FUNCTION_TEMPLATE _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class_0 = SWIGV8_CreateClassTemplate("CHECK_INTEGER_OVERFLOW_MULTIPLICATION");
_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class_0->SetCallHandler(_wrap_new_CHECK_INTEGER_OVERFLOW_MULTIPLICATION);
_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class_0->Inherit(_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_obj = _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_obj = _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("CHECK_INTEGER_OVERFLOW_MULTIPLICATION"), _exports_CHECK_INTEGER_OVERFLOW_MULTIPLICATION_obj));
