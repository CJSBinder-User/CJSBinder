...
#define SWIGTYPE_p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION swig_types[0]
...
SWIGV8_ClientData _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_clientData;


static SwigV8ReturnValue _wrap_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_C_O_P_S_T_G_C_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION *arg1 = (COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION *) 0 ;
  int arg2 ;
  int arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_C_O_P_S_T_G_C_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_C_O_P_S_T_G_C_f_gold" "', argument " "1"" of type '" "COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION *""'"); 
  }
  arg1 = reinterpret_cast< COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_C_O_P_S_T_G_C_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_int(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_C_O_P_S_T_G_C_f_gold" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (int)(arg1)->C_O_P_S_T_G_C_f_gold(arg2,arg3);
...
static SwigV8ReturnValue _wrap_new_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION.");
  result = (COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION *)new COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION * arg1 = (COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION = {"_p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION", "COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION *|p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION[] = {  {&_swigt__p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION, Type: p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION, Dtor: _wrap_delete_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION */
SWIGV8_FUNCTION_TEMPLATE _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class = SWIGV8_CreateClassTemplate("_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION");
SWIGV8_SET_CLASS_TEMPL(_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_clientData.class_templ, _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class);
_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_clientData.dtor = _wrap_delete_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION;
if (SWIGTYPE_p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION->clientdata == 0) {
  SWIGTYPE_p_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION->clientdata = &_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class, "C_O_P_S_T_G_C_f_gold", _wrap_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_C_O_P_S_T_G_C_f_gold);
  ...
  /* class instances */
  /* Class: COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION (_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION) */
SWIGV8_FUNCTION_TEMPLATE _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class_0 = SWIGV8_CreateClassTemplate("COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION");
_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class_0->SetCallHandler(_wrap_new_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION);
_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class_0->Inherit(_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_obj = _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_obj = _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION"), _exports_COUNT_OF_PAIRS_SATISFYING_THE_GIVEN_CONDITION_obj));
