...
#define SWIGTYPE_p_DOUBLE_FACTORIAL swig_types[0]
...
SWIGV8_ClientData _exports_DOUBLE_FACTORIAL_clientData;


static SwigV8ReturnValue _wrap_DOUBLE_FACTORIAL_D_F_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  DOUBLE_FACTORIAL *arg1 = (DOUBLE_FACTORIAL *) 0 ;
  unsigned int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  unsigned int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_DOUBLE_FACTORIAL_D_F_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_DOUBLE_FACTORIAL, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DOUBLE_FACTORIAL_D_F_f_gold" "', argument " "1"" of type '" "DOUBLE_FACTORIAL *""'"); 
  }
  arg1 = reinterpret_cast< DOUBLE_FACTORIAL * >(argp1);
  ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DOUBLE_FACTORIAL_D_F_f_gold" "', argument " "2"" of type '" "unsigned int""'");
  } 
  arg2 = static_cast< unsigned int >(val2);
  result = (unsigned int)(arg1)->D_F_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_DOUBLE_FACTORIAL(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  DOUBLE_FACTORIAL *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_DOUBLE_FACTORIAL.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_DOUBLE_FACTORIAL.");
  result = (DOUBLE_FACTORIAL *)new DOUBLE_FACTORIAL();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_DOUBLE_FACTORIAL, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_DOUBLE_FACTORIAL(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    DOUBLE_FACTORIAL * arg1 = (DOUBLE_FACTORIAL *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_DOUBLE_FACTORIAL = {"_p_DOUBLE_FACTORIAL", "p_DOUBLE_FACTORIAL|DOUBLE_FACTORIAL *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_DOUBLE_FACTORIAL,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_DOUBLE_FACTORIAL[] = {  {&_swigt__p_DOUBLE_FACTORIAL, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_DOUBLE_FACTORIAL,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_DOUBLE_FACTORIAL, Type: p_DOUBLE_FACTORIAL, Dtor: _wrap_delete_DOUBLE_FACTORIAL */
SWIGV8_FUNCTION_TEMPLATE _exports_DOUBLE_FACTORIAL_class = SWIGV8_CreateClassTemplate("_exports_DOUBLE_FACTORIAL");
SWIGV8_SET_CLASS_TEMPL(_exports_DOUBLE_FACTORIAL_clientData.class_templ, _exports_DOUBLE_FACTORIAL_class);
_exports_DOUBLE_FACTORIAL_clientData.dtor = _wrap_delete_DOUBLE_FACTORIAL;
if (SWIGTYPE_p_DOUBLE_FACTORIAL->clientdata == 0) {
  SWIGTYPE_p_DOUBLE_FACTORIAL->clientdata = &_exports_DOUBLE_FACTORIAL_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_DOUBLE_FACTORIAL_class, "D_F_f_gold", _wrap_DOUBLE_FACTORIAL_D_F_f_gold);
  ...
  /* class instances */
  /* Class: DOUBLE_FACTORIAL (_exports_DOUBLE_FACTORIAL) */
SWIGV8_FUNCTION_TEMPLATE _exports_DOUBLE_FACTORIAL_class_0 = SWIGV8_CreateClassTemplate("DOUBLE_FACTORIAL");
_exports_DOUBLE_FACTORIAL_class_0->SetCallHandler(_wrap_new_DOUBLE_FACTORIAL);
_exports_DOUBLE_FACTORIAL_class_0->Inherit(_exports_DOUBLE_FACTORIAL_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_DOUBLE_FACTORIAL_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_DOUBLE_FACTORIAL_obj = _exports_DOUBLE_FACTORIAL_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_DOUBLE_FACTORIAL_obj = _exports_DOUBLE_FACTORIAL_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("DOUBLE_FACTORIAL"), _exports_DOUBLE_FACTORIAL_obj));
