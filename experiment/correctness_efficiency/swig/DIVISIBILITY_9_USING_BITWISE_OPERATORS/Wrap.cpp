...
#define SWIGTYPE_p_DIVISIBILITY_9_USING_BITWISE_OPERATORS swig_types[0]
...
SWIGV8_ClientData _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_clientData;


static SwigV8ReturnValue _wrap_DIVISIBILITY_9_USING_BITWISE_OPERATORS_D_9_U_B_O_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  DIVISIBILITY_9_USING_BITWISE_OPERATORS *arg1 = (DIVISIBILITY_9_USING_BITWISE_OPERATORS *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_DIVISIBILITY_9_USING_BITWISE_OPERATORS_D_9_U_B_O_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_DIVISIBILITY_9_USING_BITWISE_OPERATORS, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DIVISIBILITY_9_USING_BITWISE_OPERATORS_D_9_U_B_O_f_gold" "', argument " "1"" of type '" "DIVISIBILITY_9_USING_BITWISE_OPERATORS *""'"); 
  }
  arg1 = reinterpret_cast< DIVISIBILITY_9_USING_BITWISE_OPERATORS * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DIVISIBILITY_9_USING_BITWISE_OPERATORS_D_9_U_B_O_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (bool)(arg1)->D_9_U_B_O_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_DIVISIBILITY_9_USING_BITWISE_OPERATORS(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  DIVISIBILITY_9_USING_BITWISE_OPERATORS *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_DIVISIBILITY_9_USING_BITWISE_OPERATORS.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_DIVISIBILITY_9_USING_BITWISE_OPERATORS.");
  result = (DIVISIBILITY_9_USING_BITWISE_OPERATORS *)new DIVISIBILITY_9_USING_BITWISE_OPERATORS();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_DIVISIBILITY_9_USING_BITWISE_OPERATORS, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_DIVISIBILITY_9_USING_BITWISE_OPERATORS(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    DIVISIBILITY_9_USING_BITWISE_OPERATORS * arg1 = (DIVISIBILITY_9_USING_BITWISE_OPERATORS *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_DIVISIBILITY_9_USING_BITWISE_OPERATORS = {"_p_DIVISIBILITY_9_USING_BITWISE_OPERATORS", "DIVISIBILITY_9_USING_BITWISE_OPERATORS *|p_DIVISIBILITY_9_USING_BITWISE_OPERATORS", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_DIVISIBILITY_9_USING_BITWISE_OPERATORS,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_DIVISIBILITY_9_USING_BITWISE_OPERATORS[] = {  {&_swigt__p_DIVISIBILITY_9_USING_BITWISE_OPERATORS, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_DIVISIBILITY_9_USING_BITWISE_OPERATORS,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS, Type: p_DIVISIBILITY_9_USING_BITWISE_OPERATORS, Dtor: _wrap_delete_DIVISIBILITY_9_USING_BITWISE_OPERATORS */
SWIGV8_FUNCTION_TEMPLATE _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class = SWIGV8_CreateClassTemplate("_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS");
SWIGV8_SET_CLASS_TEMPL(_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_clientData.class_templ, _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class);
_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_clientData.dtor = _wrap_delete_DIVISIBILITY_9_USING_BITWISE_OPERATORS;
if (SWIGTYPE_p_DIVISIBILITY_9_USING_BITWISE_OPERATORS->clientdata == 0) {
  SWIGTYPE_p_DIVISIBILITY_9_USING_BITWISE_OPERATORS->clientdata = &_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class, "D_9_U_B_O_f_gold", _wrap_DIVISIBILITY_9_USING_BITWISE_OPERATORS_D_9_U_B_O_f_gold);
  ...
  /* class instances */
  /* Class: DIVISIBILITY_9_USING_BITWISE_OPERATORS (_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS) */
SWIGV8_FUNCTION_TEMPLATE _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class_0 = SWIGV8_CreateClassTemplate("DIVISIBILITY_9_USING_BITWISE_OPERATORS");
_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class_0->SetCallHandler(_wrap_new_DIVISIBILITY_9_USING_BITWISE_OPERATORS);
_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class_0->Inherit(_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_obj = _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_obj = _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("DIVISIBILITY_9_USING_BITWISE_OPERATORS"), _exports_DIVISIBILITY_9_USING_BITWISE_OPERATORS_obj));
