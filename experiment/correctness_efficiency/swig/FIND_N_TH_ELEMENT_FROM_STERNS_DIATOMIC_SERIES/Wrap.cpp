...
#define SWIGTYPE_p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES swig_types[0]
...
SWIGV8_ClientData _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_clientData;


static SwigV8ReturnValue _wrap_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_F_N_T_E_F_S_D_S_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES *arg1 = (FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_F_N_T_E_F_S_D_S_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_F_N_T_E_F_S_D_S_f_gold" "', argument " "1"" of type '" "FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES *""'"); 
  }
  arg1 = reinterpret_cast< FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_F_N_T_E_F_S_D_S_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (int)(arg1)->F_N_T_E_F_S_D_S_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES.");
  result = (FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES *)new FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES * arg1 = (FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES = {"_p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES", "FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES *|p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES[] = {  {&_swigt__p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES, Type: p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES, Dtor: _wrap_delete_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES */
SWIGV8_FUNCTION_TEMPLATE _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class = SWIGV8_CreateClassTemplate("_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES");
SWIGV8_SET_CLASS_TEMPL(_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_clientData.class_templ, _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class);
_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_clientData.dtor = _wrap_delete_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES;
if (SWIGTYPE_p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES->clientdata == 0) {
  SWIGTYPE_p_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES->clientdata = &_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class, "F_N_T_E_F_S_D_S_f_gold", _wrap_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_F_N_T_E_F_S_D_S_f_gold);
  ...
  /* class instances */
  /* Class: FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES (_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES) */
SWIGV8_FUNCTION_TEMPLATE _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class_0 = SWIGV8_CreateClassTemplate("FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES");
_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class_0->SetCallHandler(_wrap_new_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES);
_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class_0->Inherit(_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_obj = _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_obj = _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES"), _exports_FIND_N_TH_ELEMENT_FROM_STERNS_DIATOMIC_SERIES_obj));
