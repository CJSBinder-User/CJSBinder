...
#define SWIGTYPE_p_BIRTHDAY_PARADOX swig_types[0]
...
SWIGV8_ClientData _exports_BIRTHDAY_PARADOX_clientData;


static SwigV8ReturnValue _wrap_BIRTHDAY_PARADOX_B_P_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  BIRTHDAY_PARADOX *arg1 = (BIRTHDAY_PARADOX *) 0 ;
  double arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_BIRTHDAY_PARADOX_B_P_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_BIRTHDAY_PARADOX, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "BIRTHDAY_PARADOX_B_P_f_gold" "', argument " "1"" of type '" "BIRTHDAY_PARADOX *""'"); 
  }
  arg1 = reinterpret_cast< BIRTHDAY_PARADOX * >(argp1);
  ecode2 = SWIG_AsVal_double(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "BIRTHDAY_PARADOX_B_P_f_gold" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  result = (int)(arg1)->B_P_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_BIRTHDAY_PARADOX(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  BIRTHDAY_PARADOX *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_BIRTHDAY_PARADOX.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_BIRTHDAY_PARADOX.");
  result = (BIRTHDAY_PARADOX *)new BIRTHDAY_PARADOX();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_BIRTHDAY_PARADOX, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_BIRTHDAY_PARADOX(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    BIRTHDAY_PARADOX * arg1 = (BIRTHDAY_PARADOX *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_BIRTHDAY_PARADOX = {"_p_BIRTHDAY_PARADOX", "p_BIRTHDAY_PARADOX|BIRTHDAY_PARADOX *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_BIRTHDAY_PARADOX,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_BIRTHDAY_PARADOX[] = {  {&_swigt__p_BIRTHDAY_PARADOX, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_BIRTHDAY_PARADOX,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_BIRTHDAY_PARADOX, Type: p_BIRTHDAY_PARADOX, Dtor: _wrap_delete_BIRTHDAY_PARADOX */
SWIGV8_FUNCTION_TEMPLATE _exports_BIRTHDAY_PARADOX_class = SWIGV8_CreateClassTemplate("_exports_BIRTHDAY_PARADOX");
SWIGV8_SET_CLASS_TEMPL(_exports_BIRTHDAY_PARADOX_clientData.class_templ, _exports_BIRTHDAY_PARADOX_class);
_exports_BIRTHDAY_PARADOX_clientData.dtor = _wrap_delete_BIRTHDAY_PARADOX;
if (SWIGTYPE_p_BIRTHDAY_PARADOX->clientdata == 0) {
  SWIGTYPE_p_BIRTHDAY_PARADOX->clientdata = &_exports_BIRTHDAY_PARADOX_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_BIRTHDAY_PARADOX_class, "B_P_f_gold", _wrap_BIRTHDAY_PARADOX_B_P_f_gold);
  ...
  /* class instances */
  /* Class: BIRTHDAY_PARADOX (_exports_BIRTHDAY_PARADOX) */
SWIGV8_FUNCTION_TEMPLATE _exports_BIRTHDAY_PARADOX_class_0 = SWIGV8_CreateClassTemplate("BIRTHDAY_PARADOX");
_exports_BIRTHDAY_PARADOX_class_0->SetCallHandler(_wrap_new_BIRTHDAY_PARADOX);
_exports_BIRTHDAY_PARADOX_class_0->Inherit(_exports_BIRTHDAY_PARADOX_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_BIRTHDAY_PARADOX_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_BIRTHDAY_PARADOX_obj = _exports_BIRTHDAY_PARADOX_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_BIRTHDAY_PARADOX_obj = _exports_BIRTHDAY_PARADOX_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("BIRTHDAY_PARADOX"), _exports_BIRTHDAY_PARADOX_obj));
