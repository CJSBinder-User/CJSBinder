...
#define SWIGTYPE_p_TAIL_RECURSION swig_types[0]
...
SWIGV8_ClientData _exports_TAIL_RECURSION_clientData;


static SwigV8ReturnValue _wrap_TAIL_RECURSION_T_R_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  TAIL_RECURSION *arg1 = (TAIL_RECURSION *) 0 ;
  unsigned int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  unsigned int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_TAIL_RECURSION_T_R_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_TAIL_RECURSION, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TAIL_RECURSION_T_R_f_gold" "', argument " "1"" of type '" "TAIL_RECURSION *""'"); 
  }
  arg1 = reinterpret_cast< TAIL_RECURSION * >(argp1);
  ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "TAIL_RECURSION_T_R_f_gold" "', argument " "2"" of type '" "unsigned int""'");
  } 
  arg2 = static_cast< unsigned int >(val2);
  result = (unsigned int)(arg1)->T_R_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_TAIL_RECURSION(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  TAIL_RECURSION *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_TAIL_RECURSION.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_TAIL_RECURSION.");
  result = (TAIL_RECURSION *)new TAIL_RECURSION();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_TAIL_RECURSION, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_TAIL_RECURSION(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    TAIL_RECURSION * arg1 = (TAIL_RECURSION *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_TAIL_RECURSION = {"_p_TAIL_RECURSION", "p_TAIL_RECURSION|TAIL_RECURSION *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_TAIL_RECURSION,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_TAIL_RECURSION[] = {  {&_swigt__p_TAIL_RECURSION, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_TAIL_RECURSION,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_TAIL_RECURSION, Type: p_TAIL_RECURSION, Dtor: _wrap_delete_TAIL_RECURSION */
SWIGV8_FUNCTION_TEMPLATE _exports_TAIL_RECURSION_class = SWIGV8_CreateClassTemplate("_exports_TAIL_RECURSION");
SWIGV8_SET_CLASS_TEMPL(_exports_TAIL_RECURSION_clientData.class_templ, _exports_TAIL_RECURSION_class);
_exports_TAIL_RECURSION_clientData.dtor = _wrap_delete_TAIL_RECURSION;
if (SWIGTYPE_p_TAIL_RECURSION->clientdata == 0) {
  SWIGTYPE_p_TAIL_RECURSION->clientdata = &_exports_TAIL_RECURSION_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_TAIL_RECURSION_class, "T_R_f_gold", _wrap_TAIL_RECURSION_T_R_f_gold);
  ...
  /* class instances */
  /* Class: TAIL_RECURSION (_exports_TAIL_RECURSION) */
SWIGV8_FUNCTION_TEMPLATE _exports_TAIL_RECURSION_class_0 = SWIGV8_CreateClassTemplate("TAIL_RECURSION");
_exports_TAIL_RECURSION_class_0->SetCallHandler(_wrap_new_TAIL_RECURSION);
_exports_TAIL_RECURSION_class_0->Inherit(_exports_TAIL_RECURSION_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_TAIL_RECURSION_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_TAIL_RECURSION_obj = _exports_TAIL_RECURSION_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_TAIL_RECURSION_obj = _exports_TAIL_RECURSION_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("TAIL_RECURSION"), _exports_TAIL_RECURSION_obj));
