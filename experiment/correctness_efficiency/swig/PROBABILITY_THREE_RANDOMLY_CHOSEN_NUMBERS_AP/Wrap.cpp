...
#define SWIGTYPE_p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP swig_types[0]
...
SWIGV8_ClientData _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_clientData;


static SwigV8ReturnValue _wrap_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_P_T_R_C_N_A_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP *arg1 = (PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_P_T_R_C_N_A_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_P_T_R_C_N_A_f_gold" "', argument " "1"" of type '" "PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP *""'"); 
  }
  arg1 = reinterpret_cast< PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_P_T_R_C_N_A_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (double)(arg1)->P_T_R_C_N_A_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP.");
  result = (PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP *)new PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP * arg1 = (PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP = {"_p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP", "PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP *|p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP[] = {  {&_swigt__p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP, Type: p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP, Dtor: _wrap_delete_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP */
SWIGV8_FUNCTION_TEMPLATE _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class = SWIGV8_CreateClassTemplate("_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP");
SWIGV8_SET_CLASS_TEMPL(_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_clientData.class_templ, _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class);
_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_clientData.dtor = _wrap_delete_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP;
if (SWIGTYPE_p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP->clientdata == 0) {
  SWIGTYPE_p_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP->clientdata = &_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class, "P_T_R_C_N_A_f_gold", _wrap_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_P_T_R_C_N_A_f_gold);
  ...
  /* class instances */
  /* Class: PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP (_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP) */
SWIGV8_FUNCTION_TEMPLATE _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class_0 = SWIGV8_CreateClassTemplate("PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP");
_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class_0->SetCallHandler(_wrap_new_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP);
_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class_0->Inherit(_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_obj = _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_obj = _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP"), _exports_PROBABILITY_THREE_RANDOMLY_CHOSEN_NUMBERS_AP_obj));
