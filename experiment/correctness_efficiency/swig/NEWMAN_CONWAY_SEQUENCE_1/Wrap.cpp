...
#define SWIGTYPE_p_NEWMAN_CONWAY_SEQUENCE_1 swig_types[0]
...
SWIGV8_ClientData _exports_NEWMAN_CONWAY_SEQUENCE_1_clientData;


static SwigV8ReturnValue _wrap_NEWMAN_CONWAY_SEQUENCE_1_N_C_S_1_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  NEWMAN_CONWAY_SEQUENCE_1 *arg1 = (NEWMAN_CONWAY_SEQUENCE_1 *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_NEWMAN_CONWAY_SEQUENCE_1_N_C_S_1_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_NEWMAN_CONWAY_SEQUENCE_1, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "NEWMAN_CONWAY_SEQUENCE_1_N_C_S_1_f_gold" "', argument " "1"" of type '" "NEWMAN_CONWAY_SEQUENCE_1 *""'"); 
  }
  arg1 = reinterpret_cast< NEWMAN_CONWAY_SEQUENCE_1 * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "NEWMAN_CONWAY_SEQUENCE_1_N_C_S_1_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (int)(arg1)->N_C_S_1_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_NEWMAN_CONWAY_SEQUENCE_1(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  NEWMAN_CONWAY_SEQUENCE_1 *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_NEWMAN_CONWAY_SEQUENCE_1.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_NEWMAN_CONWAY_SEQUENCE_1.");
  result = (NEWMAN_CONWAY_SEQUENCE_1 *)new NEWMAN_CONWAY_SEQUENCE_1();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_NEWMAN_CONWAY_SEQUENCE_1, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_NEWMAN_CONWAY_SEQUENCE_1(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    NEWMAN_CONWAY_SEQUENCE_1 * arg1 = (NEWMAN_CONWAY_SEQUENCE_1 *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_NEWMAN_CONWAY_SEQUENCE_1 = {"_p_NEWMAN_CONWAY_SEQUENCE_1", "p_NEWMAN_CONWAY_SEQUENCE_1|NEWMAN_CONWAY_SEQUENCE_1 *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_NEWMAN_CONWAY_SEQUENCE_1,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_NEWMAN_CONWAY_SEQUENCE_1[] = {  {&_swigt__p_NEWMAN_CONWAY_SEQUENCE_1, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_NEWMAN_CONWAY_SEQUENCE_1,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_NEWMAN_CONWAY_SEQUENCE_1, Type: p_NEWMAN_CONWAY_SEQUENCE_1, Dtor: _wrap_delete_NEWMAN_CONWAY_SEQUENCE_1 */
SWIGV8_FUNCTION_TEMPLATE _exports_NEWMAN_CONWAY_SEQUENCE_1_class = SWIGV8_CreateClassTemplate("_exports_NEWMAN_CONWAY_SEQUENCE_1");
SWIGV8_SET_CLASS_TEMPL(_exports_NEWMAN_CONWAY_SEQUENCE_1_clientData.class_templ, _exports_NEWMAN_CONWAY_SEQUENCE_1_class);
_exports_NEWMAN_CONWAY_SEQUENCE_1_clientData.dtor = _wrap_delete_NEWMAN_CONWAY_SEQUENCE_1;
if (SWIGTYPE_p_NEWMAN_CONWAY_SEQUENCE_1->clientdata == 0) {
  SWIGTYPE_p_NEWMAN_CONWAY_SEQUENCE_1->clientdata = &_exports_NEWMAN_CONWAY_SEQUENCE_1_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_NEWMAN_CONWAY_SEQUENCE_1_class, "N_C_S_1_f_gold", _wrap_NEWMAN_CONWAY_SEQUENCE_1_N_C_S_1_f_gold);
  ...
  /* class instances */
  /* Class: NEWMAN_CONWAY_SEQUENCE_1 (_exports_NEWMAN_CONWAY_SEQUENCE_1) */
SWIGV8_FUNCTION_TEMPLATE _exports_NEWMAN_CONWAY_SEQUENCE_1_class_0 = SWIGV8_CreateClassTemplate("NEWMAN_CONWAY_SEQUENCE_1");
_exports_NEWMAN_CONWAY_SEQUENCE_1_class_0->SetCallHandler(_wrap_new_NEWMAN_CONWAY_SEQUENCE_1);
_exports_NEWMAN_CONWAY_SEQUENCE_1_class_0->Inherit(_exports_NEWMAN_CONWAY_SEQUENCE_1_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_NEWMAN_CONWAY_SEQUENCE_1_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_NEWMAN_CONWAY_SEQUENCE_1_obj = _exports_NEWMAN_CONWAY_SEQUENCE_1_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_NEWMAN_CONWAY_SEQUENCE_1_obj = _exports_NEWMAN_CONWAY_SEQUENCE_1_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("NEWMAN_CONWAY_SEQUENCE_1"), _exports_NEWMAN_CONWAY_SEQUENCE_1_obj));
