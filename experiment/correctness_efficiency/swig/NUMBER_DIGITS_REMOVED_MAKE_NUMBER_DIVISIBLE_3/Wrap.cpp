...
#define SWIGTYPE_p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 swig_types[0]
...
SWIGV8_ClientData _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_clientData;


static SwigV8ReturnValue _wrap_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_N_D_R_M_N_D_3_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 *arg1 = (NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 *) 0 ;
  string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_N_D_R_M_N_D_3_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_N_D_R_M_N_D_3_f_gold" "', argument " "1"" of type '" "NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 *""'"); 
  }
  arg1 = reinterpret_cast< NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_N_D_R_M_N_D_3_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_N_D_R_M_N_D_3_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
      arg2 = *(reinterpret_cast< string * >(argp2));
    }
  }
  result = (int)(arg1)->N_D_R_M_N_D_3_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3.");
  result = (NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 *)new NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 * arg1 = (NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 = {"_p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3", "NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 *|p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3[] = {  {&_swigt__p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3, Type: p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3, Dtor: _wrap_delete_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 */
SWIGV8_FUNCTION_TEMPLATE _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class = SWIGV8_CreateClassTemplate("_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3");
SWIGV8_SET_CLASS_TEMPL(_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_clientData.class_templ, _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class);
_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_clientData.dtor = _wrap_delete_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3;
if (SWIGTYPE_p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3->clientdata == 0) {
  SWIGTYPE_p_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3->clientdata = &_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class, "N_D_R_M_N_D_3_f_gold", _wrap_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_N_D_R_M_N_D_3_f_gold);
  ...
  /* class instances */
  /* Class: NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3 (_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3) */
SWIGV8_FUNCTION_TEMPLATE _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class_0 = SWIGV8_CreateClassTemplate("NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3");
_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class_0->SetCallHandler(_wrap_new_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3);
_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class_0->Inherit(_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_obj = _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_obj = _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3"), _exports_NUMBER_DIGITS_REMOVED_MAKE_NUMBER_DIVISIBLE_3_obj));
