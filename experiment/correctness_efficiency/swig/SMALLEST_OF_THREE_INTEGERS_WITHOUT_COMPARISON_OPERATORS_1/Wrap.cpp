...
#define SWIGTYPE_p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 swig_types[0]
...
SWIGV8_ClientData _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_clientData;


static SwigV8ReturnValue _wrap_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 *arg1 = (SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 *) 0 ;
  int arg2 ;
  int arg3 ;
  int arg4 ;
  void *argp1 = 0 ;
  ...
  if(args.Length() != 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold" "', argument " "1"" of type '" "SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 *""'"); 
  }
  arg1 = reinterpret_cast< SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_int(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  ecode4 = SWIG_AsVal_int(args[2], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = static_cast< int >(val4);
  result = (int)(arg1)->S_O_T_I_W_C_O_1_f_gold(arg2,arg3,arg4);
...
static SwigV8ReturnValue _wrap_new_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1.");
  result = (SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 *)new SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 * arg1 = (SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 = {"_p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1", "SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 *|p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1[] = {  {&_swigt__p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1, Type: p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1, Dtor: _wrap_delete_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 */
SWIGV8_FUNCTION_TEMPLATE _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class = SWIGV8_CreateClassTemplate("_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1");
SWIGV8_SET_CLASS_TEMPL(_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_clientData.class_templ, _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class);
_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_clientData.dtor = _wrap_delete_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1;
if (SWIGTYPE_p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1->clientdata == 0) {
  SWIGTYPE_p_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1->clientdata = &_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class, "S_O_T_I_W_C_O_1_f_gold", _wrap_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_S_O_T_I_W_C_O_1_f_gold);
  ...
  /* class instances */
  /* Class: SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1 (_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1) */
SWIGV8_FUNCTION_TEMPLATE _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class_0 = SWIGV8_CreateClassTemplate("SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1");
_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class_0->SetCallHandler(_wrap_new_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1);
_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class_0->Inherit(_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_obj = _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_obj = _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1"), _exports_SMALLEST_OF_THREE_INTEGERS_WITHOUT_COMPARISON_OPERATORS_1_obj));
