...
#define SWIGTYPE_p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES swig_types[0]
...
SWIGV8_ClientData _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_clientData;


static SwigV8ReturnValue _wrap_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_P_T_S_5_L_L_S_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES *arg1 = (PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_P_T_S_5_L_L_S_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_P_T_S_5_L_L_S_f_gold" "', argument " "1"" of type '" "PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES *""'"); 
  }
  arg1 = reinterpret_cast< PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_P_T_S_5_L_L_S_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (bool)(arg1)->P_T_S_5_L_L_S_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES.");
  result = (PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES *)new PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES * arg1 = (PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES = {"_p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES", "PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES *|p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES[] = {  {&_swigt__p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES, Type: p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES, Dtor: _wrap_delete_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES */
SWIGV8_FUNCTION_TEMPLATE _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class = SWIGV8_CreateClassTemplate("_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES");
SWIGV8_SET_CLASS_TEMPL(_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_clientData.class_templ, _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class);
_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_clientData.dtor = _wrap_delete_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES;
if (SWIGTYPE_p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES->clientdata == 0) {
  SWIGTYPE_p_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES->clientdata = &_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class, "P_T_S_5_L_L_S_f_gold", _wrap_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_P_T_S_5_L_L_S_f_gold);
  ...
  /* class instances */
  /* Class: PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES (_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES) */
SWIGV8_FUNCTION_TEMPLATE _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class_0 = SWIGV8_CreateClassTemplate("PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES");
_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class_0->SetCallHandler(_wrap_new_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES);
_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class_0->Inherit(_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_obj = _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_obj = _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES"), _exports_PRIMALITY_TEST_SET_5USING_LUCAS_LEHMER_SERIES_obj));
