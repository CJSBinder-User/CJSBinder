...
#define SWIGTYPE_p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY swig_types[0]
#define SWIGTYPE_p_char swig_types[1]
#define SWIGTYPE_p_vectorT_int_t swig_types[2]
...
SWIGV8_ClientData _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_clientData;


static SwigV8ReturnValue _wrap_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_M_A_S_P_A_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY *arg1 = (MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY *) 0 ;
  vector< int > *arg2 = 0 ;
  int arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_M_A_S_P_A_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_M_A_S_P_A_f_gold" "', argument " "1"" of type '" "MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY *""'"); 
  }
  arg1 = reinterpret_cast< MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY * >(argp1);
  res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_vectorT_int_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_M_A_S_P_A_f_gold" "', argument " "2"" of type '" "vector< int > &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_M_A_S_P_A_f_gold" "', argument " "2"" of type '" "vector< int > &""'"); 
  }
  arg2 = reinterpret_cast< vector< int > * >(argp2);
  ecode3 = SWIG_AsVal_int(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_M_A_S_P_A_f_gold" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (double)(arg1)->M_A_S_P_A_f_gold(*arg2,arg3);
...
static SwigV8ReturnValue _wrap_new_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY.");
  result = (MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY *)new MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY * arg1 = (MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY = {"_p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY", "MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY *|p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_vectorT_int_t = {"_p_vectorT_int_t", "vector< int > *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY,
  &_swigt__p_char,
  &_swigt__p_vectorT_int_t,
};

static swig_cast_info _swigc__p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY[] = {  {&_swigt__p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_vectorT_int_t[] = {  {&_swigt__p_vectorT_int_t, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY,
  _swigc__p_char,
...
#endif
{
  ...
  /* Name: _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY, Type: p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY, Dtor: _wrap_delete_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY */
SWIGV8_FUNCTION_TEMPLATE _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class = SWIGV8_CreateClassTemplate("_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY");
SWIGV8_SET_CLASS_TEMPL(_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_clientData.class_templ, _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class);
_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_clientData.dtor = _wrap_delete_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY;
if (SWIGTYPE_p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY->clientdata == 0) {
  SWIGTYPE_p_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY->clientdata = &_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class, "M_A_S_P_A_f_gold", _wrap_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_M_A_S_P_A_f_gold);
  ...
  /* class instances */
  /* Class: MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY (_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY) */
SWIGV8_FUNCTION_TEMPLATE _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class_0 = SWIGV8_CreateClassTemplate("MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY");
_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class_0->SetCallHandler(_wrap_new_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY);
_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class_0->Inherit(_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_obj = _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_obj = _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY"), _exports_MAXIMUM_AVERAGE_SUM_PARTITION_ARRAY_obj));
