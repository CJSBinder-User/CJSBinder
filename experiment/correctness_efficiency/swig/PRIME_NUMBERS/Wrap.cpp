...
#define SWIGTYPE_p_PRIME_NUMBERS swig_types[0]
...
SWIGV8_ClientData _exports_PRIME_NUMBERS_clientData;


static SwigV8ReturnValue _wrap_PRIME_NUMBERS_P_N_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  PRIME_NUMBERS *arg1 = (PRIME_NUMBERS *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PRIME_NUMBERS_P_N_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_PRIME_NUMBERS, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "PRIME_NUMBERS_P_N_f_gold" "', argument " "1"" of type '" "PRIME_NUMBERS *""'"); 
  }
  arg1 = reinterpret_cast< PRIME_NUMBERS * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "PRIME_NUMBERS_P_N_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (bool)(arg1)->P_N_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_PRIME_NUMBERS(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  PRIME_NUMBERS *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_PRIME_NUMBERS.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_PRIME_NUMBERS.");
  result = (PRIME_NUMBERS *)new PRIME_NUMBERS();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_PRIME_NUMBERS, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_PRIME_NUMBERS(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    PRIME_NUMBERS * arg1 = (PRIME_NUMBERS *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_PRIME_NUMBERS = {"_p_PRIME_NUMBERS", "PRIME_NUMBERS *|p_PRIME_NUMBERS", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_PRIME_NUMBERS,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_PRIME_NUMBERS[] = {  {&_swigt__p_PRIME_NUMBERS, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_PRIME_NUMBERS,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_PRIME_NUMBERS, Type: p_PRIME_NUMBERS, Dtor: _wrap_delete_PRIME_NUMBERS */
SWIGV8_FUNCTION_TEMPLATE _exports_PRIME_NUMBERS_class = SWIGV8_CreateClassTemplate("_exports_PRIME_NUMBERS");
SWIGV8_SET_CLASS_TEMPL(_exports_PRIME_NUMBERS_clientData.class_templ, _exports_PRIME_NUMBERS_class);
_exports_PRIME_NUMBERS_clientData.dtor = _wrap_delete_PRIME_NUMBERS;
if (SWIGTYPE_p_PRIME_NUMBERS->clientdata == 0) {
  SWIGTYPE_p_PRIME_NUMBERS->clientdata = &_exports_PRIME_NUMBERS_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_PRIME_NUMBERS_class, "P_N_f_gold", _wrap_PRIME_NUMBERS_P_N_f_gold);
  ...
  /* class instances */
  /* Class: PRIME_NUMBERS (_exports_PRIME_NUMBERS) */
SWIGV8_FUNCTION_TEMPLATE _exports_PRIME_NUMBERS_class_0 = SWIGV8_CreateClassTemplate("PRIME_NUMBERS");
_exports_PRIME_NUMBERS_class_0->SetCallHandler(_wrap_new_PRIME_NUMBERS);
_exports_PRIME_NUMBERS_class_0->Inherit(_exports_PRIME_NUMBERS_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_PRIME_NUMBERS_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_PRIME_NUMBERS_obj = _exports_PRIME_NUMBERS_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_PRIME_NUMBERS_obj = _exports_PRIME_NUMBERS_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("PRIME_NUMBERS"), _exports_PRIME_NUMBERS_obj));
