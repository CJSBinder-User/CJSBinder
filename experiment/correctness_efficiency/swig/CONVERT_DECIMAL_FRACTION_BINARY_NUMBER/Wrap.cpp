...
#define SWIGTYPE_p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER swig_types[0]
...
SWIGV8_ClientData _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_clientData;


static SwigV8ReturnValue _wrap_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_C_D_F_B_N_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  CONVERT_DECIMAL_FRACTION_BINARY_NUMBER *arg1 = (CONVERT_DECIMAL_FRACTION_BINARY_NUMBER *) 0 ;
  double arg2 ;
  int arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_C_D_F_B_N_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_C_D_F_B_N_f_gold" "', argument " "1"" of type '" "CONVERT_DECIMAL_FRACTION_BINARY_NUMBER *""'"); 
  }
  arg1 = reinterpret_cast< CONVERT_DECIMAL_FRACTION_BINARY_NUMBER * >(argp1);
  ecode2 = SWIG_AsVal_double(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_C_D_F_B_N_f_gold" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  ecode3 = SWIG_AsVal_int(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_C_D_F_B_N_f_gold" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (arg1)->C_D_F_B_N_f_gold(arg2,arg3);
...
static SwigV8ReturnValue _wrap_new_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  CONVERT_DECIMAL_FRACTION_BINARY_NUMBER *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER.");
  result = (CONVERT_DECIMAL_FRACTION_BINARY_NUMBER *)new CONVERT_DECIMAL_FRACTION_BINARY_NUMBER();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    CONVERT_DECIMAL_FRACTION_BINARY_NUMBER * arg1 = (CONVERT_DECIMAL_FRACTION_BINARY_NUMBER *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER = {"_p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER", "CONVERT_DECIMAL_FRACTION_BINARY_NUMBER *|p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER[] = {  {&_swigt__p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER, Type: p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER, Dtor: _wrap_delete_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER */
SWIGV8_FUNCTION_TEMPLATE _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class = SWIGV8_CreateClassTemplate("_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER");
SWIGV8_SET_CLASS_TEMPL(_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_clientData.class_templ, _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class);
_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_clientData.dtor = _wrap_delete_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER;
if (SWIGTYPE_p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER->clientdata == 0) {
  SWIGTYPE_p_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER->clientdata = &_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class, "C_D_F_B_N_f_gold", _wrap_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_C_D_F_B_N_f_gold);
  ...
  /* class instances */
  /* Class: CONVERT_DECIMAL_FRACTION_BINARY_NUMBER (_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER) */
SWIGV8_FUNCTION_TEMPLATE _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class_0 = SWIGV8_CreateClassTemplate("CONVERT_DECIMAL_FRACTION_BINARY_NUMBER");
_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class_0->SetCallHandler(_wrap_new_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER);
_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class_0->Inherit(_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_obj = _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_obj = _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("CONVERT_DECIMAL_FRACTION_BINARY_NUMBER"), _exports_CONVERT_DECIMAL_FRACTION_BINARY_NUMBER_obj));
