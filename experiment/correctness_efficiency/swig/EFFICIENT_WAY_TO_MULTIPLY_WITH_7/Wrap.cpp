...
#define SWIGTYPE_p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7 swig_types[0]
...
SWIGV8_ClientData _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_clientData;


static SwigV8ReturnValue _wrap_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_E_W_T_M_W_7_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  EFFICIENT_WAY_TO_MULTIPLY_WITH_7 *arg1 = (EFFICIENT_WAY_TO_MULTIPLY_WITH_7 *) 0 ;
  long arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  long val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_E_W_T_M_W_7_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "EFFICIENT_WAY_TO_MULTIPLY_WITH_7_E_W_T_M_W_7_f_gold" "', argument " "1"" of type '" "EFFICIENT_WAY_TO_MULTIPLY_WITH_7 *""'"); 
  }
  arg1 = reinterpret_cast< EFFICIENT_WAY_TO_MULTIPLY_WITH_7 * >(argp1);
  ecode2 = SWIG_AsVal_long(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "EFFICIENT_WAY_TO_MULTIPLY_WITH_7_E_W_T_M_W_7_f_gold" "', argument " "2"" of type '" "long""'");
  } 
  arg2 = static_cast< long >(val2);
  result = (long)(arg1)->E_W_T_M_W_7_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_EFFICIENT_WAY_TO_MULTIPLY_WITH_7(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  EFFICIENT_WAY_TO_MULTIPLY_WITH_7 *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_EFFICIENT_WAY_TO_MULTIPLY_WITH_7.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_EFFICIENT_WAY_TO_MULTIPLY_WITH_7.");
  result = (EFFICIENT_WAY_TO_MULTIPLY_WITH_7 *)new EFFICIENT_WAY_TO_MULTIPLY_WITH_7();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_EFFICIENT_WAY_TO_MULTIPLY_WITH_7(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    EFFICIENT_WAY_TO_MULTIPLY_WITH_7 * arg1 = (EFFICIENT_WAY_TO_MULTIPLY_WITH_7 *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7 = {"_p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7", "EFFICIENT_WAY_TO_MULTIPLY_WITH_7 *|p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7[] = {  {&_swigt__p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7, Type: p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7, Dtor: _wrap_delete_EFFICIENT_WAY_TO_MULTIPLY_WITH_7 */
SWIGV8_FUNCTION_TEMPLATE _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class = SWIGV8_CreateClassTemplate("_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7");
SWIGV8_SET_CLASS_TEMPL(_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_clientData.class_templ, _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class);
_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_clientData.dtor = _wrap_delete_EFFICIENT_WAY_TO_MULTIPLY_WITH_7;
if (SWIGTYPE_p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7->clientdata == 0) {
  SWIGTYPE_p_EFFICIENT_WAY_TO_MULTIPLY_WITH_7->clientdata = &_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class, "E_W_T_M_W_7_f_gold", _wrap_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_E_W_T_M_W_7_f_gold);
  ...
  /* class instances */
  /* Class: EFFICIENT_WAY_TO_MULTIPLY_WITH_7 (_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7) */
SWIGV8_FUNCTION_TEMPLATE _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class_0 = SWIGV8_CreateClassTemplate("EFFICIENT_WAY_TO_MULTIPLY_WITH_7");
_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class_0->SetCallHandler(_wrap_new_EFFICIENT_WAY_TO_MULTIPLY_WITH_7);
_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class_0->Inherit(_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_obj = _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_obj = _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("EFFICIENT_WAY_TO_MULTIPLY_WITH_7"), _exports_EFFICIENT_WAY_TO_MULTIPLY_WITH_7_obj));
