...
#define SWIGTYPE_p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS swig_types[0]
...
SWIGV8_ClientData _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_clientData;


static SwigV8ReturnValue _wrap_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS *arg1 = (CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS *) 0 ;
  string arg2 ;
  string arg3 ;
  int arg4 ;
  void *argp1 = 0 ;
  ...
  if(args.Length() != 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold" "', argument " "1"" of type '" "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS *""'"); 
  }
  arg1 = reinterpret_cast< CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold" "', argument " "3"" of type '" "string""'"); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold" "', argument " "3"" of type '" "string""'");
    } else {
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = static_cast< int >(val4);
  result = (bool)(arg1)->C_O_S_U_A_D_L_O_f_gold(arg2,arg3,arg4);
...
static SwigV8ReturnValue _wrap_new_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS.");
  result = (CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS *)new CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS * arg1 = (CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS = {"_p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS", "CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS *|p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS[] = {  {&_swigt__p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS, Type: p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS, Dtor: _wrap_delete_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS */
SWIGV8_FUNCTION_TEMPLATE _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class = SWIGV8_CreateClassTemplate("_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS");
SWIGV8_SET_CLASS_TEMPL(_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_clientData.class_templ, _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class);
_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_clientData.dtor = _wrap_delete_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS;
if (SWIGTYPE_p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS->clientdata == 0) {
  SWIGTYPE_p_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS->clientdata = &_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class, "C_O_S_U_A_D_L_O_f_gold", _wrap_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_C_O_S_U_A_D_L_O_f_gold);
  ...
  /* class instances */
  /* Class: CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS (_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS) */
SWIGV8_FUNCTION_TEMPLATE _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class_0 = SWIGV8_CreateClassTemplate("CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS");
_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class_0->SetCallHandler(_wrap_new_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS);
_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class_0->Inherit(_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_obj = _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_obj = _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS"), _exports_CONVERTING_ONE_STRING_USING_APPEND_DELETE_LAST_OPERATIONS_obj));
