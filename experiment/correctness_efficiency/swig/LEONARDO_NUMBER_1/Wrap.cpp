...
#define SWIGTYPE_p_LEONARDO_NUMBER_1 swig_types[0]
...
SWIGV8_ClientData _exports_LEONARDO_NUMBER_1_clientData;


static SwigV8ReturnValue _wrap_LEONARDO_NUMBER_1_L_N_1_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  LEONARDO_NUMBER_1 *arg1 = (LEONARDO_NUMBER_1 *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_LEONARDO_NUMBER_1_L_N_1_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_LEONARDO_NUMBER_1, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "LEONARDO_NUMBER_1_L_N_1_f_gold" "', argument " "1"" of type '" "LEONARDO_NUMBER_1 *""'"); 
  }
  arg1 = reinterpret_cast< LEONARDO_NUMBER_1 * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "LEONARDO_NUMBER_1_L_N_1_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (int)(arg1)->L_N_1_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_LEONARDO_NUMBER_1(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  LEONARDO_NUMBER_1 *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_LEONARDO_NUMBER_1.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_LEONARDO_NUMBER_1.");
  result = (LEONARDO_NUMBER_1 *)new LEONARDO_NUMBER_1();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_LEONARDO_NUMBER_1, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_LEONARDO_NUMBER_1(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    LEONARDO_NUMBER_1 * arg1 = (LEONARDO_NUMBER_1 *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_LEONARDO_NUMBER_1 = {"_p_LEONARDO_NUMBER_1", "LEONARDO_NUMBER_1 *|p_LEONARDO_NUMBER_1", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_LEONARDO_NUMBER_1,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_LEONARDO_NUMBER_1[] = {  {&_swigt__p_LEONARDO_NUMBER_1, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_LEONARDO_NUMBER_1,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_LEONARDO_NUMBER_1, Type: p_LEONARDO_NUMBER_1, Dtor: _wrap_delete_LEONARDO_NUMBER_1 */
SWIGV8_FUNCTION_TEMPLATE _exports_LEONARDO_NUMBER_1_class = SWIGV8_CreateClassTemplate("_exports_LEONARDO_NUMBER_1");
SWIGV8_SET_CLASS_TEMPL(_exports_LEONARDO_NUMBER_1_clientData.class_templ, _exports_LEONARDO_NUMBER_1_class);
_exports_LEONARDO_NUMBER_1_clientData.dtor = _wrap_delete_LEONARDO_NUMBER_1;
if (SWIGTYPE_p_LEONARDO_NUMBER_1->clientdata == 0) {
  SWIGTYPE_p_LEONARDO_NUMBER_1->clientdata = &_exports_LEONARDO_NUMBER_1_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_LEONARDO_NUMBER_1_class, "L_N_1_f_gold", _wrap_LEONARDO_NUMBER_1_L_N_1_f_gold);
  ...
  /* class instances */
  /* Class: LEONARDO_NUMBER_1 (_exports_LEONARDO_NUMBER_1) */
SWIGV8_FUNCTION_TEMPLATE _exports_LEONARDO_NUMBER_1_class_0 = SWIGV8_CreateClassTemplate("LEONARDO_NUMBER_1");
_exports_LEONARDO_NUMBER_1_class_0->SetCallHandler(_wrap_new_LEONARDO_NUMBER_1);
_exports_LEONARDO_NUMBER_1_class_0->Inherit(_exports_LEONARDO_NUMBER_1_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_LEONARDO_NUMBER_1_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_LEONARDO_NUMBER_1_obj = _exports_LEONARDO_NUMBER_1_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_LEONARDO_NUMBER_1_obj = _exports_LEONARDO_NUMBER_1_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("LEONARDO_NUMBER_1"), _exports_LEONARDO_NUMBER_1_obj));
