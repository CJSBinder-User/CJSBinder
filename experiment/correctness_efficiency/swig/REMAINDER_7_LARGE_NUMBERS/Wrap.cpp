...
#define SWIGTYPE_p_REMAINDER_7_LARGE_NUMBERS swig_types[0]
...
SWIGV8_ClientData _exports_REMAINDER_7_LARGE_NUMBERS_clientData;


static SwigV8ReturnValue _wrap_REMAINDER_7_LARGE_NUMBERS_R_7_L_N_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  REMAINDER_7_LARGE_NUMBERS *arg1 = (REMAINDER_7_LARGE_NUMBERS *) 0 ;
  string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_REMAINDER_7_LARGE_NUMBERS_R_7_L_N_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_REMAINDER_7_LARGE_NUMBERS, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "REMAINDER_7_LARGE_NUMBERS_R_7_L_N_f_gold" "', argument " "1"" of type '" "REMAINDER_7_LARGE_NUMBERS *""'"); 
  }
  arg1 = reinterpret_cast< REMAINDER_7_LARGE_NUMBERS * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "REMAINDER_7_LARGE_NUMBERS_R_7_L_N_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "REMAINDER_7_LARGE_NUMBERS_R_7_L_N_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
      arg2 = *(reinterpret_cast< string * >(argp2));
    }
  }
  result = (int)(arg1)->R_7_L_N_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_REMAINDER_7_LARGE_NUMBERS(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  REMAINDER_7_LARGE_NUMBERS *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_REMAINDER_7_LARGE_NUMBERS.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_REMAINDER_7_LARGE_NUMBERS.");
  result = (REMAINDER_7_LARGE_NUMBERS *)new REMAINDER_7_LARGE_NUMBERS();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_REMAINDER_7_LARGE_NUMBERS, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_REMAINDER_7_LARGE_NUMBERS(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    REMAINDER_7_LARGE_NUMBERS * arg1 = (REMAINDER_7_LARGE_NUMBERS *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_REMAINDER_7_LARGE_NUMBERS = {"_p_REMAINDER_7_LARGE_NUMBERS", "REMAINDER_7_LARGE_NUMBERS *|p_REMAINDER_7_LARGE_NUMBERS", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_REMAINDER_7_LARGE_NUMBERS,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_REMAINDER_7_LARGE_NUMBERS[] = {  {&_swigt__p_REMAINDER_7_LARGE_NUMBERS, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_REMAINDER_7_LARGE_NUMBERS,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_REMAINDER_7_LARGE_NUMBERS, Type: p_REMAINDER_7_LARGE_NUMBERS, Dtor: _wrap_delete_REMAINDER_7_LARGE_NUMBERS */
SWIGV8_FUNCTION_TEMPLATE _exports_REMAINDER_7_LARGE_NUMBERS_class = SWIGV8_CreateClassTemplate("_exports_REMAINDER_7_LARGE_NUMBERS");
SWIGV8_SET_CLASS_TEMPL(_exports_REMAINDER_7_LARGE_NUMBERS_clientData.class_templ, _exports_REMAINDER_7_LARGE_NUMBERS_class);
_exports_REMAINDER_7_LARGE_NUMBERS_clientData.dtor = _wrap_delete_REMAINDER_7_LARGE_NUMBERS;
if (SWIGTYPE_p_REMAINDER_7_LARGE_NUMBERS->clientdata == 0) {
  SWIGTYPE_p_REMAINDER_7_LARGE_NUMBERS->clientdata = &_exports_REMAINDER_7_LARGE_NUMBERS_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_REMAINDER_7_LARGE_NUMBERS_class, "R_7_L_N_f_gold", _wrap_REMAINDER_7_LARGE_NUMBERS_R_7_L_N_f_gold);
  ...
  /* class instances */
  /* Class: REMAINDER_7_LARGE_NUMBERS (_exports_REMAINDER_7_LARGE_NUMBERS) */
SWIGV8_FUNCTION_TEMPLATE _exports_REMAINDER_7_LARGE_NUMBERS_class_0 = SWIGV8_CreateClassTemplate("REMAINDER_7_LARGE_NUMBERS");
_exports_REMAINDER_7_LARGE_NUMBERS_class_0->SetCallHandler(_wrap_new_REMAINDER_7_LARGE_NUMBERS);
_exports_REMAINDER_7_LARGE_NUMBERS_class_0->Inherit(_exports_REMAINDER_7_LARGE_NUMBERS_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_REMAINDER_7_LARGE_NUMBERS_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_REMAINDER_7_LARGE_NUMBERS_obj = _exports_REMAINDER_7_LARGE_NUMBERS_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_REMAINDER_7_LARGE_NUMBERS_obj = _exports_REMAINDER_7_LARGE_NUMBERS_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("REMAINDER_7_LARGE_NUMBERS"), _exports_REMAINDER_7_LARGE_NUMBERS_obj));
