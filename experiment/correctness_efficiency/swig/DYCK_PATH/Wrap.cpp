...
#define SWIGTYPE_p_DYCK_PATH swig_types[0]
...
SWIGV8_ClientData _exports_DYCK_PATH_clientData;


static SwigV8ReturnValue _wrap_DYCK_PATH_D_P_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  DYCK_PATH *arg1 = (DYCK_PATH *) 0 ;
  unsigned int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  unsigned int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_DYCK_PATH_D_P_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_DYCK_PATH, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DYCK_PATH_D_P_f_gold" "', argument " "1"" of type '" "DYCK_PATH *""'"); 
  }
  arg1 = reinterpret_cast< DYCK_PATH * >(argp1);
  ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DYCK_PATH_D_P_f_gold" "', argument " "2"" of type '" "unsigned int""'");
  } 
  arg2 = static_cast< unsigned int >(val2);
  result = (int)(arg1)->D_P_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_DYCK_PATH(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  DYCK_PATH *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_DYCK_PATH.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_DYCK_PATH.");
  result = (DYCK_PATH *)new DYCK_PATH();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_DYCK_PATH, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_DYCK_PATH(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    DYCK_PATH * arg1 = (DYCK_PATH *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_DYCK_PATH = {"_p_DYCK_PATH", "p_DYCK_PATH|DYCK_PATH *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_DYCK_PATH[] = {  {&_swigt__p_DYCK_PATH, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  /* Name: _exports_DYCK_PATH, Type: p_DYCK_PATH, Dtor: _wrap_delete_DYCK_PATH */
SWIGV8_FUNCTION_TEMPLATE _exports_DYCK_PATH_class = SWIGV8_CreateClassTemplate("_exports_DYCK_PATH");
SWIGV8_SET_CLASS_TEMPL(_exports_DYCK_PATH_clientData.class_templ, _exports_DYCK_PATH_class);
_exports_DYCK_PATH_clientData.dtor = _wrap_delete_DYCK_PATH;
if (SWIGTYPE_p_DYCK_PATH->clientdata == 0) {
  SWIGTYPE_p_DYCK_PATH->clientdata = &_exports_DYCK_PATH_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_DYCK_PATH_class, "D_P_f_gold", _wrap_DYCK_PATH_D_P_f_gold);
  ...
  /* class instances */
  /* Class: DYCK_PATH (_exports_DYCK_PATH) */
SWIGV8_FUNCTION_TEMPLATE _exports_DYCK_PATH_class_0 = SWIGV8_CreateClassTemplate("DYCK_PATH");
_exports_DYCK_PATH_class_0->SetCallHandler(_wrap_new_DYCK_PATH);
_exports_DYCK_PATH_class_0->Inherit(_exports_DYCK_PATH_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_DYCK_PATH_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_DYCK_PATH_obj = _exports_DYCK_PATH_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_DYCK_PATH_obj = _exports_DYCK_PATH_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("DYCK_PATH"), _exports_DYCK_PATH_obj));
