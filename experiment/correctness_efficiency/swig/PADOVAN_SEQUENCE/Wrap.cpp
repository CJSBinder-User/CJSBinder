...
#define SWIGTYPE_p_PADOVAN_SEQUENCE swig_types[0]
...
SWIGV8_ClientData _exports_PADOVAN_SEQUENCE_clientData;


static SwigV8ReturnValue _wrap_PADOVAN_SEQUENCE_P_S_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  PADOVAN_SEQUENCE *arg1 = (PADOVAN_SEQUENCE *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PADOVAN_SEQUENCE_P_S_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_PADOVAN_SEQUENCE, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "PADOVAN_SEQUENCE_P_S_f_gold" "', argument " "1"" of type '" "PADOVAN_SEQUENCE *""'"); 
  }
  arg1 = reinterpret_cast< PADOVAN_SEQUENCE * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "PADOVAN_SEQUENCE_P_S_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (int)(arg1)->P_S_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_PADOVAN_SEQUENCE(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  PADOVAN_SEQUENCE *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_PADOVAN_SEQUENCE.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_PADOVAN_SEQUENCE.");
  result = (PADOVAN_SEQUENCE *)new PADOVAN_SEQUENCE();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_PADOVAN_SEQUENCE, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_PADOVAN_SEQUENCE(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    PADOVAN_SEQUENCE * arg1 = (PADOVAN_SEQUENCE *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_PADOVAN_SEQUENCE = {"_p_PADOVAN_SEQUENCE", "p_PADOVAN_SEQUENCE|PADOVAN_SEQUENCE *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_PADOVAN_SEQUENCE,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_PADOVAN_SEQUENCE[] = {  {&_swigt__p_PADOVAN_SEQUENCE, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_PADOVAN_SEQUENCE,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_PADOVAN_SEQUENCE, Type: p_PADOVAN_SEQUENCE, Dtor: _wrap_delete_PADOVAN_SEQUENCE */
SWIGV8_FUNCTION_TEMPLATE _exports_PADOVAN_SEQUENCE_class = SWIGV8_CreateClassTemplate("_exports_PADOVAN_SEQUENCE");
SWIGV8_SET_CLASS_TEMPL(_exports_PADOVAN_SEQUENCE_clientData.class_templ, _exports_PADOVAN_SEQUENCE_class);
_exports_PADOVAN_SEQUENCE_clientData.dtor = _wrap_delete_PADOVAN_SEQUENCE;
if (SWIGTYPE_p_PADOVAN_SEQUENCE->clientdata == 0) {
  SWIGTYPE_p_PADOVAN_SEQUENCE->clientdata = &_exports_PADOVAN_SEQUENCE_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_PADOVAN_SEQUENCE_class, "P_S_f_gold", _wrap_PADOVAN_SEQUENCE_P_S_f_gold);
  ...
  /* class instances */
  /* Class: PADOVAN_SEQUENCE (_exports_PADOVAN_SEQUENCE) */
SWIGV8_FUNCTION_TEMPLATE _exports_PADOVAN_SEQUENCE_class_0 = SWIGV8_CreateClassTemplate("PADOVAN_SEQUENCE");
_exports_PADOVAN_SEQUENCE_class_0->SetCallHandler(_wrap_new_PADOVAN_SEQUENCE);
_exports_PADOVAN_SEQUENCE_class_0->Inherit(_exports_PADOVAN_SEQUENCE_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_PADOVAN_SEQUENCE_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_PADOVAN_SEQUENCE_obj = _exports_PADOVAN_SEQUENCE_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_PADOVAN_SEQUENCE_obj = _exports_PADOVAN_SEQUENCE_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("PADOVAN_SEQUENCE"), _exports_PADOVAN_SEQUENCE_obj));
