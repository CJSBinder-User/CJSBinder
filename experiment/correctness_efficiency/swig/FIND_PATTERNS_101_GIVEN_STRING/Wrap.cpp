...
#define SWIGTYPE_p_FIND_PATTERNS_101_GIVEN_STRING swig_types[0]
...
SWIGV8_ClientData _exports_FIND_PATTERNS_101_GIVEN_STRING_clientData;


static SwigV8ReturnValue _wrap_FIND_PATTERNS_101_GIVEN_STRING_F_P_1_G_S_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  FIND_PATTERNS_101_GIVEN_STRING *arg1 = (FIND_PATTERNS_101_GIVEN_STRING *) 0 ;
  string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_FIND_PATTERNS_101_GIVEN_STRING_F_P_1_G_S_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_FIND_PATTERNS_101_GIVEN_STRING, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "FIND_PATTERNS_101_GIVEN_STRING_F_P_1_G_S_f_gold" "', argument " "1"" of type '" "FIND_PATTERNS_101_GIVEN_STRING *""'"); 
  }
  arg1 = reinterpret_cast< FIND_PATTERNS_101_GIVEN_STRING * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "FIND_PATTERNS_101_GIVEN_STRING_F_P_1_G_S_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "FIND_PATTERNS_101_GIVEN_STRING_F_P_1_G_S_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
      arg2 = *(reinterpret_cast< string * >(argp2));
    }
  }
  result = (int)(arg1)->F_P_1_G_S_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_FIND_PATTERNS_101_GIVEN_STRING(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  FIND_PATTERNS_101_GIVEN_STRING *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_FIND_PATTERNS_101_GIVEN_STRING.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_FIND_PATTERNS_101_GIVEN_STRING.");
  result = (FIND_PATTERNS_101_GIVEN_STRING *)new FIND_PATTERNS_101_GIVEN_STRING();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_FIND_PATTERNS_101_GIVEN_STRING, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_FIND_PATTERNS_101_GIVEN_STRING(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    FIND_PATTERNS_101_GIVEN_STRING * arg1 = (FIND_PATTERNS_101_GIVEN_STRING *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_FIND_PATTERNS_101_GIVEN_STRING = {"_p_FIND_PATTERNS_101_GIVEN_STRING", "FIND_PATTERNS_101_GIVEN_STRING *|p_FIND_PATTERNS_101_GIVEN_STRING", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_FIND_PATTERNS_101_GIVEN_STRING,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_FIND_PATTERNS_101_GIVEN_STRING[] = {  {&_swigt__p_FIND_PATTERNS_101_GIVEN_STRING, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_FIND_PATTERNS_101_GIVEN_STRING,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_FIND_PATTERNS_101_GIVEN_STRING, Type: p_FIND_PATTERNS_101_GIVEN_STRING, Dtor: _wrap_delete_FIND_PATTERNS_101_GIVEN_STRING */
SWIGV8_FUNCTION_TEMPLATE _exports_FIND_PATTERNS_101_GIVEN_STRING_class = SWIGV8_CreateClassTemplate("_exports_FIND_PATTERNS_101_GIVEN_STRING");
SWIGV8_SET_CLASS_TEMPL(_exports_FIND_PATTERNS_101_GIVEN_STRING_clientData.class_templ, _exports_FIND_PATTERNS_101_GIVEN_STRING_class);
_exports_FIND_PATTERNS_101_GIVEN_STRING_clientData.dtor = _wrap_delete_FIND_PATTERNS_101_GIVEN_STRING;
if (SWIGTYPE_p_FIND_PATTERNS_101_GIVEN_STRING->clientdata == 0) {
  SWIGTYPE_p_FIND_PATTERNS_101_GIVEN_STRING->clientdata = &_exports_FIND_PATTERNS_101_GIVEN_STRING_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_FIND_PATTERNS_101_GIVEN_STRING_class, "F_P_1_G_S_f_gold", _wrap_FIND_PATTERNS_101_GIVEN_STRING_F_P_1_G_S_f_gold);
  ...
  /* class instances */
  /* Class: FIND_PATTERNS_101_GIVEN_STRING (_exports_FIND_PATTERNS_101_GIVEN_STRING) */
SWIGV8_FUNCTION_TEMPLATE _exports_FIND_PATTERNS_101_GIVEN_STRING_class_0 = SWIGV8_CreateClassTemplate("FIND_PATTERNS_101_GIVEN_STRING");
_exports_FIND_PATTERNS_101_GIVEN_STRING_class_0->SetCallHandler(_wrap_new_FIND_PATTERNS_101_GIVEN_STRING);
_exports_FIND_PATTERNS_101_GIVEN_STRING_class_0->Inherit(_exports_FIND_PATTERNS_101_GIVEN_STRING_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_FIND_PATTERNS_101_GIVEN_STRING_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_FIND_PATTERNS_101_GIVEN_STRING_obj = _exports_FIND_PATTERNS_101_GIVEN_STRING_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_FIND_PATTERNS_101_GIVEN_STRING_obj = _exports_FIND_PATTERNS_101_GIVEN_STRING_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("FIND_PATTERNS_101_GIVEN_STRING"), _exports_FIND_PATTERNS_101_GIVEN_STRING_obj));
