...
#define SWIGTYPE_p_SWAP_TWO_NIBBLES_BYTE swig_types[0]
...
SWIGV8_ClientData _exports_SWAP_TWO_NIBBLES_BYTE_clientData;


static SwigV8ReturnValue _wrap_SWAP_TWO_NIBBLES_BYTE_S_T_N_B_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  SWAP_TWO_NIBBLES_BYTE *arg1 = (SWAP_TWO_NIBBLES_BYTE *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_SWAP_TWO_NIBBLES_BYTE_S_T_N_B_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_SWAP_TWO_NIBBLES_BYTE, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SWAP_TWO_NIBBLES_BYTE_S_T_N_B_f_gold" "', argument " "1"" of type '" "SWAP_TWO_NIBBLES_BYTE *""'"); 
  }
  arg1 = reinterpret_cast< SWAP_TWO_NIBBLES_BYTE * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "SWAP_TWO_NIBBLES_BYTE_S_T_N_B_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (int)(arg1)->S_T_N_B_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_SWAP_TWO_NIBBLES_BYTE(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  SWAP_TWO_NIBBLES_BYTE *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_SWAP_TWO_NIBBLES_BYTE.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_SWAP_TWO_NIBBLES_BYTE.");
  result = (SWAP_TWO_NIBBLES_BYTE *)new SWAP_TWO_NIBBLES_BYTE();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_SWAP_TWO_NIBBLES_BYTE, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_SWAP_TWO_NIBBLES_BYTE(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    SWAP_TWO_NIBBLES_BYTE * arg1 = (SWAP_TWO_NIBBLES_BYTE *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_SWAP_TWO_NIBBLES_BYTE = {"_p_SWAP_TWO_NIBBLES_BYTE", "SWAP_TWO_NIBBLES_BYTE *|p_SWAP_TWO_NIBBLES_BYTE", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_SWAP_TWO_NIBBLES_BYTE,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_SWAP_TWO_NIBBLES_BYTE[] = {  {&_swigt__p_SWAP_TWO_NIBBLES_BYTE, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_SWAP_TWO_NIBBLES_BYTE,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_SWAP_TWO_NIBBLES_BYTE, Type: p_SWAP_TWO_NIBBLES_BYTE, Dtor: _wrap_delete_SWAP_TWO_NIBBLES_BYTE */
SWIGV8_FUNCTION_TEMPLATE _exports_SWAP_TWO_NIBBLES_BYTE_class = SWIGV8_CreateClassTemplate("_exports_SWAP_TWO_NIBBLES_BYTE");
SWIGV8_SET_CLASS_TEMPL(_exports_SWAP_TWO_NIBBLES_BYTE_clientData.class_templ, _exports_SWAP_TWO_NIBBLES_BYTE_class);
_exports_SWAP_TWO_NIBBLES_BYTE_clientData.dtor = _wrap_delete_SWAP_TWO_NIBBLES_BYTE;
if (SWIGTYPE_p_SWAP_TWO_NIBBLES_BYTE->clientdata == 0) {
  SWIGTYPE_p_SWAP_TWO_NIBBLES_BYTE->clientdata = &_exports_SWAP_TWO_NIBBLES_BYTE_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_SWAP_TWO_NIBBLES_BYTE_class, "S_T_N_B_f_gold", _wrap_SWAP_TWO_NIBBLES_BYTE_S_T_N_B_f_gold);
  ...
  /* class instances */
  /* Class: SWAP_TWO_NIBBLES_BYTE (_exports_SWAP_TWO_NIBBLES_BYTE) */
SWIGV8_FUNCTION_TEMPLATE _exports_SWAP_TWO_NIBBLES_BYTE_class_0 = SWIGV8_CreateClassTemplate("SWAP_TWO_NIBBLES_BYTE");
_exports_SWAP_TWO_NIBBLES_BYTE_class_0->SetCallHandler(_wrap_new_SWAP_TWO_NIBBLES_BYTE);
_exports_SWAP_TWO_NIBBLES_BYTE_class_0->Inherit(_exports_SWAP_TWO_NIBBLES_BYTE_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_SWAP_TWO_NIBBLES_BYTE_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_SWAP_TWO_NIBBLES_BYTE_obj = _exports_SWAP_TWO_NIBBLES_BYTE_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_SWAP_TWO_NIBBLES_BYTE_obj = _exports_SWAP_TWO_NIBBLES_BYTE_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("SWAP_TWO_NIBBLES_BYTE"), _exports_SWAP_TWO_NIBBLES_BYTE_obj));
