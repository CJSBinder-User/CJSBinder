...
#define SWIGTYPE_p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET swig_types[0]
...
SWIGV8_ClientData _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_clientData;


static SwigV8ReturnValue _wrap_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_B_N_N_O_W_T_P_A_S_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET *arg1 = (BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_B_N_N_O_W_T_P_A_S_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_B_N_N_O_W_T_P_A_S_f_gold" "', argument " "1"" of type '" "BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET *""'"); 
  }
  arg1 = reinterpret_cast< BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET * >(argp1);
  ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_B_N_N_O_W_T_P_A_S_f_gold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  result = (int)(arg1)->B_N_N_O_W_T_P_A_S_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET.");
  result = (BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET *)new BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET * arg1 = (BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET = {"_p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET", "p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET|BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET[] = {  {&_swigt__p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET, Type: p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET, Dtor: _wrap_delete_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET */
SWIGV8_FUNCTION_TEMPLATE _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class = SWIGV8_CreateClassTemplate("_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET");
SWIGV8_SET_CLASS_TEMPL(_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_clientData.class_templ, _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class);
_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_clientData.dtor = _wrap_delete_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET;
if (SWIGTYPE_p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET->clientdata == 0) {
  SWIGTYPE_p_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET->clientdata = &_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class, "B_N_N_O_W_T_P_A_S_f_gold", _wrap_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_B_N_N_O_W_T_P_A_S_f_gold);
  ...
  /* class instances */
  /* Class: BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET (_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET) */
SWIGV8_FUNCTION_TEMPLATE _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class_0 = SWIGV8_CreateClassTemplate("BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET");
_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class_0->SetCallHandler(_wrap_new_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET);
_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class_0->Inherit(_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_obj = _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_obj = _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET"), _exports_BELL_NUMBERS_NUMBER_OF_WAYS_TO_PARTITION_A_SET_obj));
