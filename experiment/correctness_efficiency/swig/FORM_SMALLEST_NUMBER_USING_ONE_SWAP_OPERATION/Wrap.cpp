...
#define SWIGTYPE_p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION swig_types[0]
...
SWIGV8_ClientData _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_clientData;


static SwigV8ReturnValue _wrap_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_F_S_N_U_O_S_O_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION *arg1 = (FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION *) 0 ;
  string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_F_S_N_U_O_S_O_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_F_S_N_U_O_S_O_f_gold" "', argument " "1"" of type '" "FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION *""'"); 
  }
  arg1 = reinterpret_cast< FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_F_S_N_U_O_S_O_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_F_S_N_U_O_S_O_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
      arg2 = *(reinterpret_cast< string * >(argp2));
    }
  }
  result = (arg1)->F_S_N_U_O_S_O_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION.");
  result = (FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION *)new FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION * arg1 = (FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION = {"_p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION", "FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION *|p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION[] = {  {&_swigt__p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION, Type: p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION, Dtor: _wrap_delete_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION */
SWIGV8_FUNCTION_TEMPLATE _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class = SWIGV8_CreateClassTemplate("_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION");
SWIGV8_SET_CLASS_TEMPL(_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_clientData.class_templ, _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class);
_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_clientData.dtor = _wrap_delete_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION;
if (SWIGTYPE_p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION->clientdata == 0) {
  SWIGTYPE_p_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION->clientdata = &_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class, "F_S_N_U_O_S_O_f_gold", _wrap_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_F_S_N_U_O_S_O_f_gold);
  ...
  /* class instances */
  /* Class: FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION (_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION) */
SWIGV8_FUNCTION_TEMPLATE _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class_0 = SWIGV8_CreateClassTemplate("FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION");
_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class_0->SetCallHandler(_wrap_new_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION);
_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class_0->Inherit(_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_obj = _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_obj = _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION"), _exports_FORM_SMALLEST_NUMBER_USING_ONE_SWAP_OPERATION_obj));
