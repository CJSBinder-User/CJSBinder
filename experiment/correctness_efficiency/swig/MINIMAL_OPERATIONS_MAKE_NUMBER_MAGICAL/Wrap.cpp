...
#define SWIGTYPE_p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL swig_types[0]
...
SWIGV8_ClientData _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_clientData;


static SwigV8ReturnValue _wrap_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_M_O_M_N_M_f_gold(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL *arg1 = (MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL *) 0 ;
  string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_M_O_M_N_M_f_gold.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_M_O_M_N_M_f_gold" "', argument " "1"" of type '" "MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL *""'"); 
  }
  arg1 = reinterpret_cast< MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL * >(argp1);
  {
    res2 = SWIG_ConvertPtr(args[0], &argp2, SWIGTYPE_p_string,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_M_O_M_N_M_f_gold" "', argument " "2"" of type '" "string""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_M_O_M_N_M_f_gold" "', argument " "2"" of type '" "string""'");
    } else {
      arg2 = *(reinterpret_cast< string * >(argp2));
    }
  }
  result = (int)(arg1)->M_O_M_N_M_f_gold(arg2);
...
static SwigV8ReturnValue _wrap_new_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL.");
  result = (MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL *)new MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL * arg1 = (MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL = {"_p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL", "MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL *|p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_string = {"_p_string", "string *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL,
  &_swigt__p_char,
  &_swigt__p_string,
};

static swig_cast_info _swigc__p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL[] = {  {&_swigt__p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_string[] = {  {&_swigt__p_string, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL,
  _swigc__p_char,
  _swigc__p_string,
};
...
#endif
{
  ...
  /* Name: _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL, Type: p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL, Dtor: _wrap_delete_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL */
SWIGV8_FUNCTION_TEMPLATE _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class = SWIGV8_CreateClassTemplate("_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL");
SWIGV8_SET_CLASS_TEMPL(_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_clientData.class_templ, _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class);
_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_clientData.dtor = _wrap_delete_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL;
if (SWIGTYPE_p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL->clientdata == 0) {
  SWIGTYPE_p_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL->clientdata = &_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class, "M_O_M_N_M_f_gold", _wrap_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_M_O_M_N_M_f_gold);
  ...
  /* class instances */
  /* Class: MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL (_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL) */
SWIGV8_FUNCTION_TEMPLATE _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class_0 = SWIGV8_CreateClassTemplate("MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL");
_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class_0->SetCallHandler(_wrap_new_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL);
_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class_0->Inherit(_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_obj = _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_obj = _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL"), _exports_MINIMAL_OPERATIONS_MAKE_NUMBER_MAGICAL_obj));
